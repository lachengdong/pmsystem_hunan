 ...
 */
        ...
        CKEDITOR.plugins.add('tdforms', {
            ...
            lang: 'en,zh,zh-cn',
            icons: 'tdcheckbox,tdhiddenfield,tdradio,tdselect,tdtextarea,tdtextfield,cdxdtpicker,suseranddept,listview,countersign,jsEditor,cssEditor,signature,writesign,dimensionalcode,macro,tcount,fileupload', // %REMOVE_LINE_CORE%
            onLoad: function() {
