...
CKEDITOR.dialog.add( 'countersign', function( editor ) {
    return {
        ...
        onOk: function() {
            ...
            + '"field_attr":' + '{' + '"title":' + '"' + field_name + '",' +'"signheight":' + '"' + signheight + '",' + '"handwrite":' + '"' + handwrite + '",' + '"addseal":' + '"' + addseal + '",' +'"parase":' + '"' + parase + '",' +'"left":' + '"' + left + '",' + '"top":'+'"'+top+'",' + '"class":' + '"' + field_type + '",' + '"template":' + '"' + template + '"' +'}}';
            if ( isInsertMode ) {
