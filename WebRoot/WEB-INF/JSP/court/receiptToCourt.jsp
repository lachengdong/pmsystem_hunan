...
<body onload="init('${menuid}');">
    ...
    <div id="datagrid" class="mini-datagrid" style="width:100%;height:100%;" allowResize="false"  sizeList="[10,20,30,50,100]"
       url="<%=path%>/courtJoint/getBackReplenishList.action" onrowdblclick="chooseOne" 
      ...
      function zipFaSong(){
    	  ...
    	  if(picibianhao==""){
           ...
           if (confirm("请确定好要操作的按键类型、批次和文书类别？")) {
			...
			var crimid = row.ZUIFANBIANHAO;
			flowdraftids.push(flowdraftid); 
			crimids.push(crimid); 
          	 }
			$.ajax({
		         url: "<%=path%>/pmisws/zipFaSong.action?flowdraftids="+flowdraftids+"&casetype="+casetype,
		         data: {curyear:curyear,picibianhao:picibianhao,stage:stage},
		         type: "POST",
		         dataType:"json",
		         async:false,
		         success: function (text){
