...
<html>
	<head>
		...
		<title>数据库方案addSwapSchemeColumns.jsp</title>
		...
		<script type="text/javascript">
			...
			function dosubmit()
			{
				...
				for(var cc=0;cc<thelist.length;cc++)
				{
					...
					//if("--请选择--"==fromcolumnsorg.options[fromcolumnsorg.selectedIndex].text)
					//{
					//	columsdata.fromcolumns='';
					//}else{
					//	columsdata.fromcolumns=fromcolumnsorg.options[fromcolumnsorg.selectedIndex].text;
					//}
					...
					<table id="columnsList" cellspacing="0"
							...
							<s:iterator id="toColumnsList" value="#request.toColumnsList"
								...
								<tr onmouseover="e=this.style.backgroundColor; this.style.backgroundColor='LightSeaGreen'"
									...
									<td align="center">
										<input type="text" name="tocolumnspoint" id="tocolumnspoint<s:property value='#index' />" size="2" value="<s:property value='#toColumnsList.dcdtocolumnspoint'/>" />
									</td>
									...
									<td>
										<input type="checkbox" id="ispk<s:property value='#index' />" name="ispk"/>
									</td>
									<td>
									<s:select name="pkgenerator" id="pkgenerator%{#index}"  list="#{'auto':'自动生成'}" headerKey="-1" headerValue="--请选择--" listKey="key" listValue="value" /></td>
									<td align="center">
									...
									<td align="center">
											<input type="text" name="fromcolumnsscribe" id="fromcolumnsscribe<s:property value='#index' />" size="15"/>
									</td>
									<td align="center">
											<input type="text" name="fromcloumnstype"  id="fromcloumnstype<s:property value='#index' />" size="15"/>
									</td>
									<td align="center">
										<input type="text" name="fromcolumnssize" id="fromcolumnssize<s:property value='#index' />" size="4"/>
									</td>
									<td align="center">
										<input type="text" name="fromcolumnspoint" id="fromcolumnspoint<s:property value='#index' />" size="4"/>
									</td>
								</tr>
							</s:iterator>
						</table>
