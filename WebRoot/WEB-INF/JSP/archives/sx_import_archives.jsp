...
<body  onload="init('1600_001_001_01');">
		...
		<div size="30px;" showCollapseButton="false" >
			<div class="mini-toolbar" style="padding: 2px;border-top:0; ">                
			   	<span style="vertical-align:middle;">
			   		...
			   		<a class="mini-button" iconCls="icon-node" onclick="watch()" plain="true">档案类别</a>
			   </span>
			        ...
			        <div class="mini-splitter" vertical="true" style="width:100%;height:100%;border: 0;">
					    <div  showCollapseButton="true" size="28%" style="width: 100%;">
					       	<div style="padding-left: 6px;">
					       		<div id = "textarea1" style="color:#cc3300">命名规则:<br />文件命名一定要和档案类别名称一致,可参考档案类别！
					       			<br />..\[罪犯编号]\[文件命名] [排序号].JPG
					     			<br/>例 如:..\6118886688\减刑裁定书 0001.JPG
					     			<br/>例 如:..\6118886688\奖扣分审批表 0001.JPG
	...
	function watch(){
		var url="flow/archCodeManagement.page?1=1&action=check";
		mini.open({
                url: url,
                showMaxButton: true,
             	allowResize: false, 
                title: "档案类型", width: 900, height: 500,
                onload: function () {
                },
