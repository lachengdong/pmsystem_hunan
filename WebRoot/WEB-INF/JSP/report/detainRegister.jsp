	    	...
	    	<div class="mini-toolbar" style="padding:2px;border-top:0;border-left:0;border-right:0;">
				...
				<a class="mini-button" id="saved" iconCls="icon-save" plain="true" onclick="save('save');">存盘</a> 
	    		 -->
	    	  	...
	    	  	<c:if test="${querybutton=='1'}">
	    	  		<a class="mini-button" id="dakai" iconCls="icon-search" plain="true" onclick="queryCondition()">查询条件</a>
	    	  	</c:if>
	    	  	<span class="separator"></span> 
    ...
    <script type="text/javascript">
        ...
        function myonload(){
      	...
      	function queryCondition() {
	      	var selecturl = "queryConditionPage.action?1=1";
	      	vRet = window.showModalDialog(selecturl,"","edge: Raised; center: Yes; help: Yes; resizable: Yes; status: No;dialogHeight:300px;dialogWidth:500px");
	      	if(vRet) {
	      		window.location.href="detainRegister.action?1=1&menuid=10194&querybutton=1&querycondition=" + vRet;
	      	}                                                                
      	}
    </script>
 </body>
