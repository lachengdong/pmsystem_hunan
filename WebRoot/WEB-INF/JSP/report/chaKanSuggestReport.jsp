...
<body onload="myonload();">
	...
	<input id="aipdata" value="${aipdata}" type="hidden"/>
	...
	<div style="width:100%;height:100%;">
		...
		<td style="width:100%;">
			...
			<a class="mini-button" style="display:black;" id="gb"  iconCls="icon-close" plain="true" onclick="close();">关闭</a>
    ...
    <script type="text/javascript">
		...
		object.ShowScrollBarButton = 1;
       	mini.parse();
       	//10096监狱减刑案件查看，10269省局减刑案件查看
       	if('${menuid}'!='10096' && '${menuid}'!='10269'){
        	$("#gb").hide();
        	$("#span1").hide();	
        }
        //标准方法接口定义
        ...
        function myonload(){
        	...
        	var aipdata = $("#aipdata").val();
        	if(aipdata){
        		document.all.HWPostil1.LoadFileBase64(aipdata);
        	}else if(reportdate){
	        	//alert(reportdate);
				...
				document.all.HWPostil1.WaitConverting(8000);
