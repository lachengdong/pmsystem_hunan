...
<body>
	...
	<div class="mini-layout" style="width:100%;height:100%">
		<div title="north" region="north" class="header" height="78"
		...
		<div title="south" region="south" showSplit="false" showHeader="false"
			...
			<div style="line-height: 28px;text-align: left;padding-left:2px; ">
				...
				当前用户：<%=user.getName()%>&nbsp;(<%=user.getUserid()%>
				,
				<%=orgNameStr%>)<span style="padding-left:20px;"></span> 在线人数：
    	...
    	-->
				...
				<div>
					<div align="center">
						<b id="noticeTitle"> <%=tbuserNotice.getTitle()%>
						</b><br />
					</div>
		...
		<div showHeader="false" region="west" showSplitIcon="true" width="210"
			maxWidth="250" minWidth="100" style="border: 0px;">
			<!--OutlookMenu-->
			<div id="leftTree" class="mini-outlooktree" url="menutree.json"
				onnodeclick="onNodeSelect" textField="name" idField="resid"
				parentField="presid" expandOnLoad="false" expandOnNodeClick="true">
			</div>
		</div>
		<div title="center" region="center"
			...
			<div showCollapseButton="false"
				...
				<div id="mainTabs" class="mini-tabs" contextMenu="#tabsMenu"
					ontabload="mianbanload" activeIndex="0"
					style="width:100%;height:100%;border: 0px;" plain="false">
					<div name="first" title="我的桌面" url="<%=path%>/desktop.action"
