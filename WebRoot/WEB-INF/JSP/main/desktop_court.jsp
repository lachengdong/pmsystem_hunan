	 ...
	 <div class="mini-splitter" style="width:100%;height:100%;border: 0px;">
		<div size="75%" showCollapseButton="false" style="padding:0px;border: 0px;">
			...
			<div class="mini-fit" id="daibanshixiang"  style="width:100%;height:100%;">
		        ...
		        url="<%=path%>/flow/getapprovelist.json?1=1"  idField="" multiSelect="true"  allowAlternating="true"  virtualScroll="true"
		        showLoading="true" >
					<div property="columns">
						<div type="indexcolumn" width="10" headerAlign="center" align="center" allowSort="true">序号</div>
						<div field="applyname" width="25" headerAlign="center" align="center" allowSort="true">所属人</div>        
						<div field="startsummry" width="60" headerAlign="center" align="center" allowSort="true">摘要</div>
						<!-- 
						<div field="endsummry" width="30" headerAlign="center" align="center" allowSort="true">结束摘要</div>   
						 -->
						<div field="commenttext" width="30" headerAlign="center" align="center" allowSort="true">上次审批意见</div>   
						<div field="opname" width="25" headerAlign="center" align="center" allowSort="true">提交人</div>
...
<script type="text/javascript" >
   ...
   function onActionRenderer(e) {
       ...
       var name="";
       var s = "";
   	   var button1 = ' <a class="Edit_Button" href="javascript:shenpi()" >审批</a>';
	...
	function openwin(){
        ...
        if (row) {
           ...
           if(flowdefid == 'other_zfjyjxjssp'){
               ...
               var url= "<%=path%>/toProvinceOutPrisonTabs.action?1=1&tempid=ZFABWJYSPB&id="+id+"&menuid="+menuid+"&closetype=0&flowdefid="+flowdefid;
           }else{
        	   url="<%=path%>/flow/approveview.action?1=1&approve=yes"+"&flowid="+flowid+"&flowdefid="+flowdefid+"&shenptype=1";
           }
      	   var win=mini.open({
               url: url,
               showMaxButton: true,
