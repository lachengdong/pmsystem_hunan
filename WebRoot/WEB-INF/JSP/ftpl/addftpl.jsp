...
<script src="<%=path%>/scripts/jquery-1.6.2.min.js"
...
<body>
			...
			<div style="padding:5px;">
				...
				<table style="width:100%;">
					<tr>
						...
						<td style="width:60px;"><input id="tempid" name="tempid"
							class="mini-textbox" required="true"
							onvalidation="onEnglishAndNumberValidation" /></td>
						<td style="width:60px;">表单名称：</td>
						<td style="width:60px;"><input id="tempname" name="tempname"
					...
					<tr>
						...
						<td><input id="type" name="type" class="mini-combobox"
							data="Types" value="3" required="true" /></td>
					</tr>
					<tr>
						<td>通用类型：</td>
						<td colspan="3"><input id="rbl" class="mini-radiobuttonlist"
							repeatItems="0" repeatLayout="table" repeatDirection="vertical"
							onvalueChanged="onEnglishAndNumberValidation" textField="text"
							valueField="id" value="1" data="Radiodata" /></td>
					</tr>
				</table>
			</div>
		</fieldset>
	...
	<script type="text/javascript">
		...
		function saveAipContent(data) {
			...
			var url = '${path}/templet/addreportmanage.action?1=1';
			$.ajax({
				url : url,
				data : {
					resid : '1',
		...
		function onEnglishAndNumberValidation(e) {
			...
			var url = '${path}/templet/isexisttempid.json?1=1';
			$.ajax({
				url : url,
				data : {
					resid : '1',
