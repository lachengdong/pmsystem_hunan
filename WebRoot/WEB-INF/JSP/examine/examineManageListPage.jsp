...
<body onload="init('12550');">
    <div class="mini-toolbar"  style="padding:2px;border-bottom: 0px;">
    	 <jsp:include page="/WEB-INF/JSP/form/buttoncontrol.jsp"></jsp:include>
         <table >
            <tr>
               <td style="width:100%;">
               	   <a class="mini-button"  id="12550" plain="true" onclick="chooseAll();">批量处理</a>
               </td>
    ...
    <div class="mini-fit">
	    <div id="datagrid" allowMoveColumn="false" onrowdblclick="rowdblclickfunction" style="width:100%;height:100%;" class="mini-datagrid"  allowResize="false"  allowSortColumn="true"
	    	url="getCrimSuggestionList.action"  idField="" multiSelect="true" allowAlternating="true" sizeList="[10,20,50,100]" pageSize="20"  showLoading="true">
    ...
    <script type="text/javascript">
        ...
        function chooseOne(menuid){
          	...
          	if (row){
        		var url = "toExamineDocPage.action?1=1&menuid=12550&resid=12498&doctype=jailcommute&flowdraftid="+row.flowdraftid+"&crimid="+row.crimid+"&flowdefid=other_zfjyjxjssp";
	   		...
	   		if (rows.length > 0) {
                if (confirm("确定批量处理选中记录？")) {
                    ...
                    grid.loading("操作中，请稍后......");
                   	var url = "toExamineDocPage.action?1=1&menuid=12550&resid=12498&doctype=jailcommute&id="+id+"&flowdefid=other_zfjyjxjssp";
					window.location.href=url;
                }
            } else {
