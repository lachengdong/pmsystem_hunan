...
<body>
             ...
             <tr>
                ...
                <td style="white-space:nowrap;">
                	...
                	<input class="mini-combobox" style="width:80px;" url="getCriminalPrisonData.json" id="prison" name="prison" emptyText="监舍"
                		nullItemText="--全部--"  valueField="prison" textField="prison" value="${prison}" showNullItem="true" 
                		allowInput="false" onValueChanged="search();"/>
	...
	<div class="mini-fit" >
	    <div id="datagrid1" class="mini-datagrid"  style="width:100%;height:100%;" allowResize="false"  sizeList="[10,20,50,100]" pageSize="20"
	        ...
	        multiSelect="true" multiSelect="true"  allowAlternating="true"  virtualScroll="true">
...
<script type="text/javascript">
    ...
    function onOk(){
    	...
    	if(rows){
    		...
    		var url = "<%=path%>/editSaveSupervisionZuYuan.json?1=1";
        	$.ajax({
                url: url,
                data: {fid:fid, groupid:groupid, groupnum:groupnum, svtype:svtype, svduty:svduty, crimids:crimids},
                type: 'POST',
                dataType:'text',
                async:false,
