...
<body>
    ...
    <div class="mini-fit">
        <ul id="tree1" class="mini-tree" style="width:100%;height:100%;" showTreeIcon="true" 
            resultAsTree="false" url="<%=path %>/resource/ajax/list.json?1=1" textField="name"
             idField="resid" parentField="presid" contextMenu="#treeMenu" onnodedblclick="onNodeDblClick">
		</ul>
    </div>                
	    ...
	    function search() {
	        ...
	        if(key == ""){
	            ...
	            tree.filter(function (node) {
	                var text = node.sunickname ? node.sunickname.toLowerCase() : "";
