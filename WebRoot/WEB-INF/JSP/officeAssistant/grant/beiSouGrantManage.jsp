    ...
    <div class="mini-fit" id="div_two">
      <div class="mini-fit">
	    <div  id="datagrid" allowMoveColumn="false" style="width:100%;height:100%;" class="mini-datagrid" sizeList="[10,20,50,100]" pageSize="20" 
	    	url="<%=path %>/grant/ajax/beiSouList.json?1=1"  allowResize="true" idField="id" allowCellEdit="true" allowCellSelect="true" multiSelect="true" editNextOnEnterKey="true"  editNextRowCell="true">
	        <div property="columns">
        		<div type="checkcolumn" width="10"></div> 
		        <div field="opid" width="20px"  headerAlign="center" allowSort="true" align="center" >授权用户</div>
                <%--<div field="username" width="20px" headerAlign="center" allowSort="true" align="center" >被授权人</div>--%>
