...
<body onload="init('13767');">
    <div class="mini-toolbar"  style="padding:0px;border-bottom: 0px;">
    <jsp:include page="/WEB-INF/JSP/form/buttoncontrol.jsp"></jsp:include>
        <table >
             <tr>
                <td style="width:100%;">
				       <a class="mini-button" style="display:none;" id="13786" iconCls="" plain="true" onclick="chooseAll('13784');">批量处理</a>
                </td>
    ...
    <div class="mini-fit" id="div_two">
        <div id="datagrid1" class="mini-datagrid" style="width:100%;height:100%;" allowResize="false" sizeList="[10,20,50,100]" pageSize="20"
        	 url="<%=path%>/jubao/getCrimidList.json?1=1" idField="spid" multiSelect="true" allowAlternating="true" virtualScroll="false" 
    ...
    <script type="text/javascript">
        ...
        //如果idnumber存在表示已经处理,duty=-1表示审批未通过,显示处理。
         ...
         function onActionRenderer(e) {
	        var s = ' <a class="Edit_Button"  href="javascript:chooseOne(13784);" >处理</a>';
            return s;
        }
        ...
        function chooseOne(menuid) {
        	...
        	if(row){
        		var url = "<%=path%>/jubao/chuliShenQing.json?1=1&crimid="+row.crimid+"&menuid="+menuid+"&name="+row.name;
	     	...
	     	if(rows.length>0){
	     		if (confirm("确定操作 选中记录？")) {
                    ...
                    var idname = idnames.join(',');
                   	url += "&crimid="+id+"&menuid="+menuid+"&name="+idname;
                    self.location.href=url;
                }
	     	}else{
	     		alert("请至少选择一条记录！");
