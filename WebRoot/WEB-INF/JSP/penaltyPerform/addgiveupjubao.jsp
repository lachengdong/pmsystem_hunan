...
<body onload="init('${menuid}');">
	...
	<div size="38px;" showCollapseButton="false">
		...
		<td style="width:100%;">
	    	...
	    	<a class="mini-button" style="display:none;" id="13788" iconCls="icon-save" plain="true" onclick="savedata();">存盘</a>
	    ...
	    <td style="white-space:nowrap;">
	    	<a class="mini-button"   style="display:none;" id="1111" iconCls="icon-gk_help" tooltip="帮助" plain="true"  onclick="chakanshuoming('${menuid }')"></a>&nbsp;
	    </td>
	  	</tr>
	  	</table>
	  	</div>
	...
	<div showCollapseButton="false">
  	...
  	<input id="tempid" class="mini-hidden" value="${tempid}" />
	<input id="operator" class="mini-hidden" value="${operator}"/>
	<input id="docid" class="mini-hidden" value="${docid}" />
    ...
    <script type="text/javascript">
        ...
        function savedata() {
       		...
       		var operator = mini.get("operator").getValue();//保存或更新
       		var tempid = mini.get("tempid").getValue();//模版id
       		var docid = mini.get("docid").getValue();
       		var crimid = mini.get("crimid").getValue();
        	if(operator == "new"){//新增
	            $.ajax({
	                url: "<%=path%>/jubao/saveBailBook.json?1=1",
