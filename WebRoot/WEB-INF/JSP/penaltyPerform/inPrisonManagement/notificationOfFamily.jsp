...
<body onload="init('${menuid}');">
	...
	<div size="38px;" showCollapseButton="false">
		...
		<td style="width:100%;">
	    	...
	    	<a class="mini-button" style="display:none;" id="11025" iconCls="icon-save" plain="true" onclick="doSubmitFlow('11025','save','doc_tzjssp','ZFRJTZS');">存盘</a>
	    	<a class="mini-button" style="display:none;" id="10884" iconCls="icon-downgrade" plain="true" onclick="doSubmitFlow('10884','yes','doc_tzjssp','ZFRJTZS');">提交</a>
	    	<a class="mini-button" style="display:none;" id="10885" iconCls="icon-downgrade" plain="true" onclick="operationOpprove('10885','yes','');">同意</a>
	    	<a class="mini-button" style="display:none;" id="10886" iconCls="icon-upgrade" plain="true" onclick="operationOpprove('10886','no','');">拒绝</a>
	    	<a class="mini-button" style="display:none;" id="11411" iconCls="icon-download" plain="true" onclick="saveNext();">下一个</a>
    ...
    <script type="text/javascript">
     ...
     //手动关闭
     function onCanle(){
     	url = "<%=path%>/notificationOfFamily/toNotificationOfFamily.page?1=1&flowdefid="+flowdefid;
     	self.location.href=url;
     }
    </script>
</body>
