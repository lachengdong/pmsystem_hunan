...
<body onload="init('${menuid}');">
	...
	<div size="38px;" showCollapseButton="false">
		...
		<td style="width:100%;">
	    	...
	    	<a class="mini-button" style="display:none;" id="11151" iconCls="icon-save" plain="true" onclick="doSubmitFlow('11151','save','other_zfstjcsp','SJGL_ZFSTJCB');">存盘</a>
	    	<a class="mini-button" style="display:none;" id="10903" iconCls="icon-downgrade" plain="true" onclick="doSubmitFlow('10903','yes','other_zfstjcsp','SJGL_ZFSTJCB');">提交</a>
	    	<a class="mini-button" style="display:none;" id="10904" iconCls="icon-downgrade" plain="true" onclick="operationOpprove('10904','yes','text31_alertdate11');">同意</a>
	    	<a class="mini-button" style="display:none;" id="10905" iconCls="icon-upgrade" plain="true" onclick="operationOpprove('10905','no','text31_alertdate11');">拒绝</a>
			<a class="mini-button" style="display:none;" id="11418" iconCls="icon-download" plain="true" onclick="saveNext();">下一个</a>
    ...
    <script type="text/javascript">
		...
		//获取字符串，去除第一个Id,跳转到新的表单保存页面继续保存，全部执行完毕，index为-1，跳转到罪犯选择页面
        function saveNext (){
            ...
            if(index>0){
            	...
            	var url= "<%=path%>/Examination/examinationBodyAdd.page?1=1&id="+id+"&tempid="+tempid+"&menuid="+${menuid}+"&flowdefid="+flowdefid;
       ...
       function SetData(data) {
        ...
        //关闭返回到罪犯处理页面
        function onCanle(){
        	url = "<%=path%>/Examination/examinationBody.page?1=1"+"&flowdefid="+flowdefid;
        	self.location.href=url;
        }
    </script>
</body>
