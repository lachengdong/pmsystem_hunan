...
<body onload="init('${menuid}');">
	...
	<div size="38px;" showCollapseButton="false">
		...
		<td style="width:100%;">
	    	...
	    	<a class="mini-button" style="display:none;" id="11098" iconCls="icon-save" plain="true" onclick="doSubmitFlow('11098','save','other_zftzdjsp','SJ_CRIMINALCHARACTER');">存盘</a>
	    	<a class="mini-button" style="display:none;" id="11383" iconCls="icon-downgrade" plain="true" onclick="doSubmitFlow('11383','yes','other_zftzdjsp','SJ_CRIMINALCHARACTER');">提交</a>
	    	<a class="mini-button" style="display:none;" id="11100" iconCls="icon-downgrade" plain="true" onclick="operationOpprove('11100','yes');">同意</a>
	    	<a class="mini-button" style="display:none;" id="11099" iconCls="icon-downgrade" plain="true" onclick="operationOpprove('11099','no');">拒绝</a>
		    <a class="mini-button" style="display:none;" id="11419" iconCls="icon-download" plain="true" onclick="saveNext();">下一个</a>
  ...
  <script type="text/javascript">
      ...
      function saveNext(){
        ...
        if(index>0){
            ...
            var url = "<%=path%>/registerFeature/registerFeatureAdd.page?1=1&id="+id+"&menuid="+menuid+"&flowdefid="+flowdefid;
     ...
     //返回到罪犯处理页面
     function onCancel(){  
       url = "<%=path%>/registerFeature/registerFeatureChoose.page?1=1"+"&flowdefid="+flowdefid;
       self.location.href=url;          
     }
  </script>
</body>
