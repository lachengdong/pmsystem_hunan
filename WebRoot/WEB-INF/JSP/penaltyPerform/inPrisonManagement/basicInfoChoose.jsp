...
<body onload="init('${menuid}');">
             ...
             <tr>
                <td style="width:100%;">
                	...
                	-->
                	 ...
                	 <a class="mini-button" style="display:none;" id="11107" iconCls="" plain="true" onclick="chooseAll('11107');">批量处理</a><!-- 监狱 -->
                	 <a class="mini-button" style="display:none;" id="900349" iconCls="" plain="true" onclick="chooseReview('900349')">批量重审</a><!-- 监狱 -->
    ...
    <script type="text/javascript">
        ...
        var grid = mini.get("datagrid1");
        	...
        	//grid.showColumn("jyaction");
        	mini.get("tempid").setValue("SDXF_BASE_RJDJB");
           	...
           	if(rows.length > 0){
				   ...
				   if(ids.length == '0'){//所选中的数据都是审批中的
				   		...
				   		if (confirm(allProcessing)) {
				   			var id = ids.join(',');
                   			var url = "<%=path%>/basicInfo/basicInformation.page?1=1&id="+id+"&menuid="+menuid+"&tempid="+tempid+"&fathermenuid=${menuid}"+"&flowdefid=${flowdefid}";
                   			self.location.href=url;
				   		}
				   }
