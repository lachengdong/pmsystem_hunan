...
<body>
       ...
       <input id="bh" name="bh" value="${bh}" class="mini-hidden" />
               ...
               <tr>
	                <td style="width:100%;">
	                    ...
	                    <a class="mini-button" iconCls="icon-save" onclick="saveData()" plain="true">存盘</a>   
	                     <span style="padding-left:40px;">罪犯编号：${bh }</span>
    ...
    <div class="mini-fit">
	    <div id="datagrid" class="mini-datagrid" style="width:100%;height:100%;" idField="id" pageSize="10" allowCellEdit="true" allowCellSelect="true" multiSelect="true" editNextOnEnterKey="true" editNextRowCell="true">
            ...
            <div type="comboboxcolumn" autoShowPopup="true" name="jclb" field="jclb" width="40" allowSort="true"  align="center" headerAlign="center">奖惩类别
                <input property="editor" class="mini-combobox" style="width:100%;" data="Genders" />                
            </div>  
             <div name="pzrq" field="pzrq" width="40" allowSort="true">批准日期
               <input property="editor" class="mini-textbox" style="width:100%;" />
            </div> 
<!--             <div field="JCYY" width="60" headerAlign="center" allowSort="true">奖惩原因-->
<!--                <input property="editor" class="mini-textarea" style="width:200px;" minHeight="50"/>-->
<!--            </div>  -->
<!--            <div name="JFDX"  field="JFDX" headerAlign="center" allowSort="true" width="100" >奖分兑现-->
<!--                <input property="editor" class="mini-textbox" style="width:100%;" />-->
<!--            </div>-->
...
<script type="text/javascript">
 ...
 //var Genders2 = [{ id: 1, text: '本人' }, { id: 2, text: '家属'}, { id: 3, text: '其他'}];
	...
	var bh = mini.get("bh").getValue();
	var url = "ajaxGetYZJCDetailList.action?bh="+bh;
	grid.setUrl(url);
	grid.load();
    ...
    function saveData() {
		...
		var url = "saveYZJCDetail.action?bh=${bh}&name=${name}";
        grid.loading("保存中...");
        $.ajax({
            url: encodeURI(url),
            data: { data: json },
