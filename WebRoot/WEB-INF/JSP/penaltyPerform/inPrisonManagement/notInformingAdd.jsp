...
<body  onload="init('${menuid}');">
	...
	<div size="38px;" showCollapseButton="false">
		...
		<td style="width:100%;">
	    	...
	    	<a class="mini-button" style="display:none;" id="11085" iconCls="icon-save" plain="true" onclick="savedata('11085','save');">存盘</a>
	    	<a class="mini-button" style="display:none;" id="11091" iconCls="icon-save" plain="true" onclick="savedata('11085','save');">存盘</a>
	    	<a class="mini-button" style="display:none;" id="11122" iconCls="icon-downgrade" plain="true" onclick="savedata('11123','yes');">提交</a>
	    	<a class="mini-button" style="display:none;" id="11123" iconCls="icon-downgrade" plain="true" onclick="savedata('11123','yes');">提交</a>
	    	<a class="mini-button" style="display:none;" id="11093" iconCls="icon-downgrade" plain="true" onclick="operationOpprove('11093','yes');">同意</a>
	    	<a class="mini-button" style="display:none;" id="11092" iconCls="icon-upgrade" plain="true" onclick="operationOpprove('11092','no');">拒绝</a>
    ...
    <script type="text/javascript">
        ...
        function savedata(menuid,type){
			...
			if(!applyname) {
				...
				doSubmitFlow(menuid,type,'doc_zfbysjtzsp','SJGL_ZFBYSJTZS');
			}
        }
        //数据保存成功关闭窗口
        function saveNext(){
