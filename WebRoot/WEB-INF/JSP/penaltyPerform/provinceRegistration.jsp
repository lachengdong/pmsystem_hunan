...
<body onload="init('${menuid}');">
    ...
    <jsp:include page="/WEB-INF/JSP/form/buttoncontrol.jsp"></jsp:include>
        <table >
           <tr>
            <td style="width:100%;">
            	 <a class="mini-button" style="display:none;" id="505083" iconCls="icon-add" plain="true" onclick="add('505083')">新增</a>
       			 <a class="mini-button" style="display:none;" id="505082" iconCls="icon-download" plain="true" onclick="saveNext();">下一个</a>
    ...
    <div class="mini-fit">
	    <div id="datagrid" allowMoveColumn="false" onrowdblclick="rowdblclickfunction" style="width:100%;height:100%;" class="mini-datagrid"  allowResize="false" 
	    		url="ajaxGetProvinceJHZSspList.action?1=1&crimid=${crimid}"  idField="" multiSelect="true" allowAlternating="true" sizeList="[10,20,50,100]" pageSize="20"  showLoading="true">
