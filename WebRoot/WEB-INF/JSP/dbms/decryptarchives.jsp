...
<body  onload="init('1600_001_001_01');">
		...
		<div size="30px;" showCollapseButton="false" >
			<div class="mini-toolbar" style="padding: 2px;border-top:0; ">                
			   	<span style="vertical-align:middle;">
			   		<a class="mini-button" style="display:none;" id="10880" iconCls="icon-folderopen" plain="true" onclick="getFolder();">文件选择</a>
			   		<a class="mini-button" style="display:none;" id="10881" iconCls="icon-addfolder" plain="true" onclick="piliangjiemi('${applyids}');">批量解密</a>
			   		<a class="mini-button" iconCls="icon-node" plain="true" onclick="back();">继续解密</a>
			        ...
			        <div class="mini-splitter" vertical="true" style="width:100%;height:100%;border: 0;">
					    <div  showCollapseButton="true" size="28%" style="width: 100%;">
					       	<div style="padding-left: 6px;">
					       		<div id = "textarea1" style="color:#cc3300">档案解密时，如果关闭本页面，再次解密时，将在已经解密的基础上继续解密。
					       		</div>
					       		<div id = "textarea"></div>
	...
	function back(){
		var url = "<%=path%>/dbms/toDbmsTabPage.action?1=1";
