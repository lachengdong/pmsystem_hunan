...
<body>
        ...
        <div class="mini-toolbar" style="border-bottom:0px;padding:0px;">
            <table style="width:100%;">
                <tr>
                    <td style="width:100%;">
                       <span id="applydiv">
                           <a class="mini-button" iconCls="icon-ok"  plain="true" onclick="addArchives();">批量解密</a>
                       </span>                    
                    </td>
                    <td style="white-space:nowrap;">
                    	 <input id="nodeid" class="mini-combobox" valueField="snodeid" textField="text3"  emptyText="进程过滤" showNullItem="true" onvaluechanged="changed"
			            	nullItemText="--全部--" url="<%=path%>/jxjs/ajaxGetProcess.json?flowdefid=other_zfjyjxjssp" style="width:150px;" valueField="snodeid" textField="text3" />
    ...
    <div class="mini-fit">
	    <div id="datagrid1" allowMoveColumn="false" allowCellEdit="true" style="width:100%;height:100%;" class="mini-datagrid"   
	        url="<%=path%>/getBWCaseDataInfo.action?1=1&flowdefid=other_zfjyjxjssp" 
		     idField="" allowCellEdit="true" allowCellSelect="true" multiSelect="true" editNextOnEnterKey="true"  onshowrowdetail="onShowRowDetail"
		      allowAlternating="true"  sizeList="[10,20,50,100,500,800]" pageSize="20">
	    ...
	    <div id="detailGrid_Form" style="display:none;">
	        ...
	        style="width:100%;height:260px;" url="<%=path%>/jxjs/selectFlowForScar.json?1=1&flowdefid=other_jyjxjslasp">
	            <div property="columns">
		...
		function addArchives(){
	            ...
	            if (rows.length > 0) {
                    ...
                    for (var i = 0, l = rows.length; i < l; i++) {
                        var r = rows[i];
                        applyids.push(r.crimid);
                    }
                    var applyid = applyids.join(',');
					var url = '<%=path%>/dbms/todecryptarchives.action?1=1&applyids='+applyids;
