...
<body onload="init('${menuid}');">
       ...
       <jsp:include page="/WEB-INF/JSP/form/buttoncontrol.jsp"></jsp:include>
            <table >
               <tr>
                <td style="width:100%;">
            	 	<a class="mini-button" iconCls="icon-add" plain="true" id="13707_01_01" onclick="add('13707_01_01');">新增</a>
...
<!--	       		<div type="checkcolumn" width="15px"></div>-->
    ...
    <script type="text/javascript"> 
        ...
        function add(menuid){
	 		...
	 		mini.open({
	 	        url: "zhuanXiangJiangFenAdd.action?1=1&tempid=KHJC_ZFZXJF_JQ&crimid="+crimid+"&name="+name,
	 	        showMaxButton: true,
	 	        allowResize: false,
		...
		//返回到罪犯处理页面
     function onCancel(){  
        url = "khjcCriminalChoosePage.action?1=1";
        self.location.href=url;          
     }
</script>
</body>
