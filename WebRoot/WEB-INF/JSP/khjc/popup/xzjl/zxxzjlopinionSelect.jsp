...
<div style="padding-left:11px;padding-bottom:5px;padding-right:11px;">
		...
		<hi>请选择：</hi>
		<input id="codeselect" class="mini-combobox" url="ajaxCodeShuJuForPublicListPage.action?sctid=ZXJLLB" 
    ...
    <script type="text/javascript">
	    ...
	    function onOk(){
        	...
        	if(setduixiandate && objvalue){
        		var fjqSuggest = '　　根据该犯的现实表现和计分考核得分，依据《山东省罪犯计分考核奖罚规定》第二十六条的规定，经分监区警察集体评议，建议给予该犯';
