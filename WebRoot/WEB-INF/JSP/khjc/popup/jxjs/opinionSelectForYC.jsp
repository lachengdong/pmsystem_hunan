...
<!-- 由开发人员编写开始 -->
     <div style="padding-left:11px;padding-bottom:5px;padding-right:11px;">
		...
		<div id="paramdata">
			...
			<input id="popup_text6" name="popup_text6" class="mini-hidden" value=""/>
	...
	var jqSuggest =  '　　经监区长办公会审核，同意提请';
	var ksSuggest =  '　　经主任办公会审查，同意提请';
	var pshSuggest =  '　　经监狱减刑假释评审委员会评审，同意提请';
	var jySuggest =  '　　经监狱长办公会研究，同意提请';
	var Suggest3 = '';
	var Suggest4 = '';
	var text5 = '';
	var text6 = '';
    ...
    function onOk(e) {
        ...
        if(s1value =='1'){
        	...
        	if((s2value+s3value+s4value) > 0){
        		if(s2value == '9995'){
        			opion += "将罪犯"+crimname+"死刑，缓期二年执行的刑罚减为无期徒刑";
        			realopin="减为无期徒刑";
        			Suggest3=jySuggest;
        			Suggest4="";
        			text3="监\n狱\n意\n见";
					...
					if(s2value > 10){
						opion += "将罪犯"+crimname+"的无期徒刑的刑罚减为有期徒刑";
						realopin="减为有期徒刑";
						Suggest3=jySuggest;
						Suggest4="";
	        			text3="监\n狱\n意\n见";
						...
						opion += "对罪犯"+crimname+"减去有期徒刑";
						realopin="减去有期徒刑";
						Suggest3=pshSuggest;
	        			Suggest4=jySuggest+opion+"。";
	        			text3="监狱\n减刑\n假释\n评审\n委员\n会意\n见";
	        			text4="监\n狱\n意\n见";
					}
					opion += s2text+s3text+s4text;
					realopin+=s2text+s3text+s4text;
        		}
        	}else{
        		alert("请选择减刑幅度！");
        		return false;
        ...
        mini.get("popup_text1").setValue(jqSuggest+opion+"。");
        mini.get("popup_text2").setValue(ksSuggest+opion+"。");
        mini.get("popup_text3").setValue(Suggest3+opion+"。");
        mini.get("popup_text4").setValue(Suggest4);
        mini.get("popup_text5").setValue(text3);
        mini.get("popup_text6").setValue(text4);
        ...
        mini.get("fenjianquopinion").setValue(realopin);
        mini.get("jianquopinion").setValue(realopin);
        mini.get("keshiopinion").setValue(realopin);
        mini.get("jianyuopinion").setValue(realopin);
        mini.get("shengjuopinion").setValue(realopin);
        CloseWindow("ok");
    }
