...
<!-- 由开发人员编写开始 -->
     <div style="padding-left:11px;padding-bottom:5px;padding-right:11px;">
		...
		<hi>请选择：</hi>
		<input id="codeselect" class="mini-combobox" url="ajaxCodeShuJu.action?sctid=GKZXJFLX" 
			textField="name" valueField="codeid" allowInput="false"   onvaluechanged="onvaluechanged();"
	 	/>
     </div>
