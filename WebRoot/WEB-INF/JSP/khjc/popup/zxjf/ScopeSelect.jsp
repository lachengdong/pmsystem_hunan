...
<!-- 由开发人员编写开始 -->
     <div style="padding-left:11px;padding-bottom:5px;padding-right:11px;">
		...
		连续12月专项分<input id="sumjiangfen" class="mini-textbox"  enabled="false"/><br />
		连续12月累积分<input id="sumleijifen" class="mini-textbox" enabled="false" />
     </div>
    	...
    	function searchScoreByCrimid(date,crimid){
    		if(date && crimid){
    			$.ajax({
                    ...
                    data: {crimid:crimid,date:date,type:"monthtype"},
                    type: "post",
