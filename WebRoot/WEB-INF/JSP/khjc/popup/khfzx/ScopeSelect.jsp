...
<!-- 由开发人员编写开始 -->
     <div style="padding-left:11px;padding-bottom:5px;padding-right:11px;">
		...
		<div id="paramdata">
			...
			<input id="popup_scope1" name="popup_scope" class="mini-hidden" value=""/>
			<input id="popup_scope2" name="popup_scope" class="mini-hidden" value=""/>
    ...
    <script type="text/javascript">
	    ...
	    function onOk(){
	    	...
	    	mini.get("popup_scope1").setValue(scope);
	    	mini.get("popup_scope2").setValue(scope);
	    	
	    	mini.get("popup_text1").setValue("　　经审查，情况属实，建议予以注销"+Chinese(scope)+"分。");
	    	mini.get("popup_text2").setValue("　　经审核，建议予以注销"+Chinese(scope)+"分。");
	    	mini.get("popup_text3").setValue("　　同意注销"+Chinese(scope)+"分。");
	        CloseWindow("ok");
	    }
