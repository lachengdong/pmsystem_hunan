...
<body onload="init('${menuid}')">
     <div class="mini-toolbar"  style="padding:2px;border-bottom: 0px;">
         <jsp:include page="/WEB-INF/JSP/form/buttoncontrol.jsp"></jsp:include>
          <table >
             <tr>
                <td style="width:100%;">
				    <a class="mini-button" style="display:none;" id="600854" class="mini-button" iconCls="icon-add" plain="true" onclick="add('600854');">新增</a>
				    <a class="mini-button" style="display:none;" id="600899" iconCls="icon-download" plain="true" onclick="saveNext();">下一个</a>
    ...
    <div class="mini-fit">
	    <div id="datagrid" allowMoveColumn="false" onrowdblclick="rowdblclickfunction" style="width:100%;height:100%;" class="mini-datagrid" sizeList="[10,20,50,100]" pageSize="20"
	     	 allowAlternating="true" showLoading="true" allowResize="false" url="rewardApprovalList.action?1=1&tempid=TKH_REWARDSPB&crimid=${crimid }" multiSelect="true" >
    ...
    <script type="text/javascript">
		...
		function onActionRenderer(e) {
	        ...
	        var s = '';
        	if(record.flowid){
        		s += ' <a class="Edit_Button"  href="javascript:xiugai(\'600859\');" >查看</a>';
        	}else{
        		s += ' <a class="Edit_Button"  href="javascript:xiugai(\'600843\');" >修改</a>';
        	}
            return s;
        } 
         function xiugai(menuid) {
	    	...
	    	mini.open({
                url: "toRewardApproval.action?1=1&flowdraftid="+row.flowdraftid+"&menuid="+menuid+"&applyid="+row.applyid,
                showMaxButton: true,
             	allowResize: false, 
                title: "奖励审批表", width: 900, height: 500,
                onload: function () {
        ...
        function add(menuid) {
	        ...
	        var url= "rewardApprovalAdd.action?crimid="+crimid+"&tempid=TKH_REWARDSPB&menuid="+menuid;
	    	mini.open({
	    	url:encodeURI(url),
	        showMaxButton: true,
	        allowResize: false,
    ...
    //手动关闭
    function close(){
    	url = "rewardApprovalChoose.action?1=1&menuid=${menuid}";
    	self.location.href=url;
    }
    //快速查询
    function search() {
