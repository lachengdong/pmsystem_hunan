     ...
     <div class="mini-toolbar"  style="padding:2px;border-bottom: 0px;">
         <jsp:include page="/WEB-INF/JSP/form/buttoncontrol.jsp"></jsp:include>
          <table >
             <tr>
                <td style="width:100%;">
<%--                第<input id="combo1" class="mini-combobox" style="width:80px;" textField="text" valueField="id" emptyText="请选择..."--%>
<%--    			url="" value="cn"  required="true" allowInput="true" showNullItem="true" nullItemText="请选择..."/>次&nbsp;&nbsp;&nbsp;&nbsp;--%>
				    <a class="mini-button" style="display:none;" id="10083_01" class="mini-button" iconCls="icon-add" plain="true" onclick="add('10083_01');">新增</a>
				    <a class="mini-button" style="display:none;" id="11448" iconCls="icon-download" plain="true" onclick="saveNext();">下一个</a>
    ...
    <div class="mini-fit">
	    <div id="datagrid" allowMoveColumn="false" onrowdblclick="rowdblclickfunction" style="width:100%;height:100%;" class="mini-datagrid" sizeList="[10,20,50,100]" pageSize="20"
	     	 allowAlternating="true" showLoading="true" allowResize="false" url="conditionDiagnoseBookList.action?1=1&tempid=JWZX_ZFBQZDS&crimid=${crimid }" multiSelect="true" >
    ...
    <script type="text/javascript">
		...
		function onActionRenderer(e) {
	        ...
	        var s = '';
        	if(record.flowid){
        		s += ' <a class="Edit_Button"  href="javascript:xiugai(\'10083_04\');" >查看</a>';
        	}else{
        		s += ' <a class="Edit_Button"  href="javascript:xiugai(\'10083_05\');" >修改</a>';
        	}
            return s;
        } 
         function xiugai(menuid) {
	    	...
	    	mini.open({
                url: "toConditionDiagnoseBook.action?1=1&flowdraftid="+row.flowdraftid+"&menuid="+menuid+"&applyid="+row.applyid,
                showMaxButton: true,
             	allowResize: false, 
                title: "病情诊断", width: 900, height: 500,
                onload: function () {
        ...
        function add(menuid) {
	        ...
	        var url= "conditionDiagnoseBookAdd.action?crimid="+crimid+"&tempid=JWZX_ZFBQZDS"+"&menuid="+menuid;
	    	mini.open({
	    	url:encodeURI(url),
	        showMaxButton: true,
	        allowResize: false,
    ...
    function saveNext (){
        ...
        var url= "conditionDiagnoseBook.action?1=1&id="+id+"&menuid=${menuid}&idname="+idname;
        if(index>0){
    ...
    //手动关闭
    function close(){
    	url = "conditionDiagnoseBookChoose.action?1=1&menuid=${menuid}";
    	self.location.href=url;
    }
    //快速查询
    function search() {
