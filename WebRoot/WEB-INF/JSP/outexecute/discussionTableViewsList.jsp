...
<body onload="init('${menuid}');">
     <div class="mini-toolbar"  style="padding:2px;border-bottom: 0px;">
         <jsp:include page="/WEB-INF/JSP/form/buttoncontrol.jsp"></jsp:include>
          <table >
             <tr>
                <td style="width:100%;">
           			 <a class="mini-button" style="display:none;" id="13771" iconCls="icon-add" plain="true" onclick="add('13771')">新增</a>
           			 <a class="mini-button" style="display:none;" id="13774" iconCls="icon-download" plain="true" onclick="saveNext();">下一个</a>
     ...
     <div class="mini-fit">
	    <div id="datagrid" allowMoveColumn="false" onrowdblclick="rowdblclickfunction" style="width:100%;height:100%;" class="mini-datagrid"  allowResize="false" 
	    	url="ajaxGetDiscussionList.action?1=1&crimid=${crimid}"  idField="" multiSelect="true" allowAlternating="true" sizeList="[10,20,50,100]" pageSize="20"  showLoading="true">
    ...
    <script type="text/javascript">
       ...
       function xiugai(menuid) {
			...
			if(row){
		    	mini.open({
	                url: "toDiscussionTableViewsAddPage.action?1=1&flowdraftid="+row.flowdraftid+"&menuid="+menuid+"&crimid="+row.applyid,
	                showMaxButton: true,
	             	allowResize: false, 
	                title: "讨论意见表", width: 900, height: 500,
	                onload: function () {
       	...
       	function add(menuid){
	        ...
	        var name = mini.get("name").getValue();
	  		mini.open({
	  	        url: "toDiscussionTableViewsAddPage.action?1=1&crimid="+crimid+"&tempid=JWZX_TLYJB"+"&menuid="+menuid,
	  	        showMaxButton: true,
	  	        allowResize: false,
	  	        title: "讨论意见表", width: 900, height: 500,
	  	        onload: function () {
	    ...
	    function saveNext (){
	        ...
	        var url= "discussionTableViews.action?1=1&id="+id+"&menuid=${menuid}&idname="+idname;
	        if(index>0){
	    ...
	    //手动关闭
	    function close(){
	    	url = "discussionTableViewsChoose.action?1=1";
	    	self.location.href=url;
	    }
    </script>
</body>
