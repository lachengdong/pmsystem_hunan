...
<body onload="init('${menuid}');">
       ...
       <jsp:include page="/WEB-INF/JSP/form/buttoncontrol.jsp"></jsp:include>
            <table >
               <tr>
                <td style="width:100%;">
            	 	<a class="mini-button" iconCls="icon-add" plain="true" style="display:none;" id="10145_01_01" onclick="add('10145_01_01');">新增</a>
           			<a class="mini-button" iconCls="icon-download" plain="true" style="display:none;" id="12859" onclick="saveNext()">下一个</a>
    ...
    <div class="mini-fit">
	    ...
	    url="getCriminalInvestigationAssessmentLetterByCrimid.action?1=1&crimid=${crimid}&tempid=JWZX_DCPGWTH"  idField="" multiSelect="true" allowAlternating="true" showLoading="true">
...
<!--	       		<div type="checkcolumn" width="15px"></div>-->
    ...
    <script type="text/javascript"> 
        ...
        function add(menuid){
	 		...
	 		mini.open({
	 	        url: "criminalInvestigationAssessmentLetterAdd.action?1=1&tempid=JWZX_DCPGWTH&crimid="+crimid+"&menuid="+menuid+"&name="+name,
	 	        showMaxButton: true,
	 	        allowResize: false,
        ...
        function shanchu(){
		 ...
		 function saveNext (){
	        ...
	        var url= "criminalInvestigationAssessmentLetterList.action?1=1&id="+id+"&menuid=${menuid}&idname="+idname;
	        if(index>0){
		...
		//返回到罪犯处理页面
     function onCancel(){  
        url = "criminalInvestigationAssessmentLetter.action?1=1";
        self.location.href=url;          
     }
</script>
</body>
