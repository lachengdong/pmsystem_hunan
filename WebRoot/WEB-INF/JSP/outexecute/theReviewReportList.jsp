...
<body onload="init('${menuid}');">
	<div class="mini-toolbar" style="padding: 2px; border-bottom: 0px;">
		...
		<table>
			<tr>
				<td style="width: 100%;">
					<a class="mini-button" iconCls="icon-add" plain="true" style="display: none;" id="12653" onclick="add('12653');">新增</a>
	...
	<div class="mini-fit">
		<div id="datagrid" allowMoveColumn="false" onrowdblclick="rowdblclickfunction" style="width: 100%; height: 100%;" class="mini-datagrid" sizeList="[10,20,50,100]" pageSize="20" 
			allowAlternating="true" showLoading="true" allowResize="false" url="getTheReviewReportList.action?1=1&tempid=SJ_JWZX_SCBG" multiSelect="true">
	...
	<script type="text/javascript"> 
	 	...
	 	function add(menuid){
	 		...
	 		mini.open({
	 	        url: "toTheReviewReportAdd.action?1=1&tempid=SJ_JWZX_SCBG&menuid="+menuid,
	 	        showMaxButton: true,
	 	        allowResize: false,
