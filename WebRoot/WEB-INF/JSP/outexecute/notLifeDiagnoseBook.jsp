...
<body onload="init('${menuid }')">
     <div class="mini-toolbar"  style="padding:2px;border-bottom: 0px;">
      <jsp:include page="/WEB-INF/JSP/form/buttoncontrol.jsp"></jsp:include>
          <table >
             <tr>
                <td style="width:100%;">
                	<a class="mini-button" style="display:none;" id="10175_01" class="mini-button" iconCls="icon-add" plain="true" onclick="add('10175_01')">新增</a>
					<a class="mini-button" style="display:none;" id="10175_03" iconCls="icon-download" plain="true" onclick="saveNext();">下一个</a>
    ...
    <div class="mini-fit">
	    <div id="datagrid" allowMoveColumn="false" onrowdblclick="rowdblclickfunction" style="width:100%;height:100%;" class="mini-datagrid" sizeList="[10,20,50,100]" pageSize="20"
	     	 allowAlternating="true" showLoading="true" allowResize="false" url="notLifeDiagnoseBookChooseCrim.action?1=1&tempid=JWZX_ZFBQZDS&crimid=${crimid }" multiSelect="true" >
    ...
    <script type="text/javascript">
		...
		function onActionRenderer(e) {
	        ...
	        var s = '';
        	if(record.flowid){
        		s += ' <a class="Edit_Button"  href="javascript:xiugai(\'10175_04\');" >查看</a>';
        	}else{
        		s += ' <a class="Edit_Button"  href="javascript:xiugai(\'10175_05\');" >修改</a>';
        	}
            return s;
        } 
        function search() {
        ...
        function add(menuid) {
	        ...
	        var url ="notLifeDiagnoseBookAdd.action?crimid="+crimid+"&tempid=JWZX_ZFSHBNZLJBS"+"&name="+name+"&menuid="+menuid 
	    	mini.open({
		        url:  encodeURI(url),
		        showMaxButton: true,
		        allowResize: false,
		        title: "生活不能自理鉴定", width: 900, height: 500,
		        onload: function () {
        ...
        function xiugai(menuid) {
	    	...
	    	mini.open({
                url: "toNotLifeDiagnoseBook.action?1=1&flowdraftid="+row.flowdraftid+"&menuid="+menuid+"&applyid="+row.applyid,
                showMaxButton: true,
             	allowResize: false, 
                title: "生活不能自理鉴定", width: 900, height: 500,
                onload: function () {
        ...
        function saveNext (){
            ...
            var url= "notLifeDiagnoseBook.action?1=1&id="+id+"&menuid=${menuid}&idname="+idname;
            if(index>0){
        ...
        //手动关闭
        function close(){
        	url = "notLifeDiagnoseBookChoose.action?1=1";
        	self.location.href=url;
        }
