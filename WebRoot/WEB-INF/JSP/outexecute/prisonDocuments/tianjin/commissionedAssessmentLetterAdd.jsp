...
<div  id="form1" class="mini-splitter"  vertical="true" style="width:100%;height:100%;border:0px;">
	<div size="38px;" showCollapseButton="false">
		...
		<td style="width:100%;">
			...
			<a class="mini-button" style="display:none;" id="12361" iconCls="icon-save" plain="true" onclick="savedata();">保存</a>
    ...
    <script type="text/javascript">
        ...
        function savedata() {
        	...
        	if(operator == "new"){//新增
	            $.ajax({
	                url: "<%=path%>/tjCommissionedAssessmentLetter/saveCommissionedAssessmentLetter.json?1=1",
