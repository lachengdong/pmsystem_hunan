...
<head>
	<title>原厅局级以上职务犯罪罪犯减刑、假释 暂予监外执行情况登记表（获取罪犯信息）</title>
...
<body onload="init('${menuid}');">
    <div class="mini-toolbar"  style="padding:0px;border-bottom: 0px;">
        ...
        <table >
             <tr>
                <td style="width:100%;">
					<a class="mini-button" style="display:none;" id="14068" plain="true" onclick="chooseAll(14067);">批量处理</a>
                </td>
    ...
    <div class="mini-fit" id="div_two">
        <div id="datagrid1" class="mini-datagrid" style="width:100%;height:100%;" allowResize="false" sizeList="[10,20,50,100]" pageSize="20"
        	 url="TheDutyCriminalRegistrationFormList.action?1=1" idField="spid" multiSelect="true" allowAlternating="true" virtualScroll="false" 
        	 showLoading="false" onbeforeload="myloading" onload="myunmask">
              ...
              <div field="familyaddress" width="180" headerAlign="center" align="left"  allowSort="true">家庭住址</div>
    ...
    <script type="text/javascript">
        ...
        function chooseOne(menuid) {
        	...
        	if(row){
        		var url = "DutyCriminalRegistrationFormList.action?1=1&menuid="+menuid+"&crimid="+row.crimid+"&tempid=SH_ZYJWZXQKDJB";
        ...
        function chooseAll(menuid){
            ...
            if (rows.length > 0) {
                if (confirm("确定操作 选中记录？")) {
                    ...
                    var url = "DutyCriminalRegistrationFormList.action?1=1&menuid="+menuid+"&id="+id+"&idname="+idname+"&tempid=SH_ZYJWZXQKDJB";
                    self.location.href=url;
                }
            } else {
