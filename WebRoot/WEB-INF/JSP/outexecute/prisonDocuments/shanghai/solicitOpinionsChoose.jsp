...
<body onload="init('12445');">
    <div class="mini-toolbar"  style="padding:2px;border-bottom: 0px;">
    	<jsp:include page="/WEB-INF/JSP/form/buttoncontrol.jsp"></jsp:include>
    	<input id="tempid" name="tempid" class="mini-hidden" value="BWJYZQYJS"/>
        <table >
             <tr>
                <td style="width:100%;">
                <a class="mini-button" style="display:none" id="13727" plain="true" onclick="chooseAll('12446')" >批量处理</a>
                </td>
                <td style="white-space:nowrap;"> 
                   ...
                   <a class="mini-button" plain="true" iconCls="icon-help" onclick="chakanshuoming('12445')"></a>
                 </td>
             </tr>
        </table>
    </div>
    <div class="mini-fit">
	    <div id="datagrid" allowMoveColumn="false" style="width:100%;height:100%;" class="mini-datagrid" url="<%=path%>/shSolicitOpinions/getSolicitOpinionsChoose.json?1=1" 
