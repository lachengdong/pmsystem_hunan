...
<body onload="init('12307');">
        ...
        <table >
             <tr>
                ...
                <td style="white-space:nowrap;"> 
                   ...
                   <a class="mini-button" plain="true" iconCls="icon-help" onclick="chakanshuoming('12307')"></a>
                 </td>
             </tr>
        </table>
    </div>
    <div class="mini-fit" id="div_two">
        <div id="datagrid1" class="mini-datagrid" style="width:100%;height:100%;" allowResize="false" sizeList="[10,20,50,100]" pageSize="20"
        	 url="<%=path%>/prisonDocuments/shanghai/getCriminalsExtendedMedicalParoleIdentificationChoose.json?1=1" idField="spid" multiSelect="true" allowAlternating="true" virtualScroll="false" 
    ...
    <script type="text/javascript">
        ...
        function onDateRenderer(e) {
         ...
         function onActionRenderer(e) {
	        var record = e.record;
	        var s = '';
        		s += ' <a class="Edit_Button"  href="javascript:chooseOne(\'12345\');" >处理</a>';
            return s;
        }
        //根据罪犯编号跳转到释放证明书表单页面
        function chooseOne(menuid) {
        	var row = grid.getSelected();
        	var url = "<%=path%>/prisonDocuments/shanghai/toCriminalsExtendedMedicalParoleIdentificationListPage.page?1=1&crimid="+row.crimid+"&menuid="+menuid;
