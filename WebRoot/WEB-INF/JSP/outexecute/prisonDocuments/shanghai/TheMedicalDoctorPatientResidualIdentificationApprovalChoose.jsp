...
<body onload="init('12368');">
    ...
    <div class="mini-fit" id="div_two">
        <div id="datagrid1" class="mini-datagrid" style="width:100%;height:100%;" allowResize="false" sizeList="[10,20,50,100]" pageSize="20"
        	 url="TheMedicalDoctorPatientResidualIdentificationApprovalList.action?1=1" idField="spid" multiSelect="true" allowAlternating="true" virtualScroll="false" 
    ...
    <script type="text/javascript">
        ...
        function chooseOne(menuid) {
        	...
        	if(row){
        		var url = "criminalsExtendedMedicalParoleIdentification.action?1=1&menuid="+menuid+"&crimid="+row.crimid+"&tempid=SH_ZFBWJYBCJDB";
