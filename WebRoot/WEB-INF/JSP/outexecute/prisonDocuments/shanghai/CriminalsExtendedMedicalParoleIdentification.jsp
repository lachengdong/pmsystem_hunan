...
<!--		<input name="orgid" id="orgid" class="mini-hidden" value="${orgname1}"/>-->
    		<a class="mini-button" style="display:none;" id="12348" iconCls="icon-save" plain="true" onclick="savedata()">存盘</a>
    		<a class="mini-button" style="display:none;" id="12399" iconCls="icon-save" plain="true" onclick="savedata()">存盘</a>
