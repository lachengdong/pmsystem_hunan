...
<body onload="init('${menuid}');">
	...
	<div size="38px;" showCollapseButton="false">
		...
		<td style="width:100%;">
    		...
    		<a class="mini-button" style="display:none;" id="12376" iconCls="icon-save" plain="true" onclick="doSubmitFlow('12376','save','other_slzfrdsp','SH_ZFBWJYBCJDB');">存盘</a>
...
<!--    	<a class="mini-button" style="display:none;" id="10901" iconCls="icon-upgrade" plain="true" onclick="operationOpprove('10901','no','');">拒绝</a>-->
    ...
    <script type="text/javascript">
      ...
      //手动关闭
        function Close(){
        	window.location.href="TheMedicalDoctorPatientResidualIdentificationApprovalChoose.action?1=1";
