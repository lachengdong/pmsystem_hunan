...
<body onload="init('${menuid}');">
	...
	<div size="38px;" showCollapseButton="false">
		...
		<td style="width:100%;">
			...
			<input id="operator" name="operator" class="mini-hidden" value="${operator}"/>
			<input id="crimid" name="crimid" class="mini-hidden" value="${crimid}"/>
<!--		<input id="crimid" name="crimid" class="mini-hidden" value="${applyname}"/>-->
<!--		<input id="crimid" name="crimid" class="mini-hidden" value="${applyid}"/>-->
...
<!--		<input name="orgid" id="orgid" class="mini-hidden" value="${orgname1}"/>-->
    		<a class="mini-button" style="display:none;" id="12397" iconCls="icon-save" plain="true" onclick="savedata()">存盘</a>
    		<a class="mini-button" style="display:none;" id="12398" iconCls="icon-save" plain="true" onclick="savedata()">存盘</a>
<!--    	<a class="mini-button" style="display:none;" id="11415" iconCls="icon-download" plain="true" onclick="saveNext();">下一个</a>-->
<!--    	<a class="mini-button" style="display:none;" id="10900" iconCls="icon-downgrade" plain="true" onclick="tijiao()">提交</a>-->
<!--    	<a class="mini-button" style="display:none;" id="10902" iconCls="icon-downgrade" plain="true" onclick="operationOpprove('10902','yes','');">同意</a>-->
<!--    	<a class="mini-button" style="display:none;" id="10901" iconCls="icon-upgrade" plain="true" onclick="operationOpprove('10901','no','');">拒绝</a>-->
    		<a class="mini-button" style="" id="" iconCls="icon-close" plain="true" onclick="close();">关闭</a>
	    	<span class="separator"></span> 
    ...
    <script type="text/javascript">
        mini.parse();
          function savedata() {
       		...
       		var url="<%=path%>/prisonDocuments/shanghai/saveCriminalsExtendedMedicalParoleIdentification.action?1=1";
	            $.ajax({
	                url:encodeURI(encodeURI(url)),
	                data: {tempid:tempid,docid:docid,crimid:crimid,operator:operator,content:content},
	                type: "post",
