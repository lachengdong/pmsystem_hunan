...
<body onload="init('${menuid }')">
	...
	<div size="38px;" showCollapseButton="false">
		...
		<td style="width:100%;">
	    	...
	    	<a class="mini-button" id="14074"  style="display:none;" iconCls="icon-save" plain="true" onclick="savedata();">存盘</a>
	    	<a class="mini-button" id="14075"   style="display:none;" iconCls="icon-download"   plain="true" onclick="saveNext();">下一个</a>
    ...
    <script type="text/javascript">
        ...
        function savedata() {
         ...
         function saveNext(){
            ...
            var url = "TheTeamDiscussionListNew.action?1=1&id="+id+"&menuid="+menuid+"&tempid=SH_JWZXJTTLB";
            if(index>0){
         ...
         //跳转到选择罪犯页面
 	   function onCancel(){
	    	var url = "TeamDiscussionList.action?1=1&id="+id+"&menuid=14071";
			self.location.href=url;
       }
		//标准方法接口定义
