...
<body onload="init('12435');">
    <div class="mini-toolbar"  style="padding:0px;border-bottom: 0px;">
	    <jsp:include page="/WEB-INF/JSP/form/buttoncontrol.jsp"></jsp:include>
        <table >
             <tr>
                <td style="width:100%;">
                	<a class="mini-button" style="display:none;" id="13729" iconCls="" plain="true" onclick="chooseAll(12436);">批量处理</a>
                </td>
    ...
    <div class="mini-fit" id="div_two">
        <div id="datagrid1" class="mini-datagrid" style="width:100%;height:100%;" allowResize="false" sizeList="[10,20,50,100]" pageSize="20"
        	 url="ApprovalFormCriminalRewardPunishmentList.action?1=1" idField="spid" multiSelect="true" allowAlternating="true" virtualScroll="false" 
          ...
          <div property="columns">
              ...
              <div field="identity" width="60" headerAlign="center" align="center" allowSort="true" >审核状态</div>          
     ...
     var s = '';
    	if(record.idnumber && record.duty != '-1' ){
    		if(record.duty=='0' || record.accent=='1'){
    			s += ' <a class="Edit_Button"  href="javascript:chooseOne(12436);" >修改</a>';
    		}else {
    			s += ' <a class="Edit_Button"  href="javascript:chooseOne(12504);" >查看</a>';
    		}
    	}else{
    		s += ' <a class="Edit_Button"  href="javascript:chooseOne(12436);" >处理</a>';
    	} 
        return s;
    }
    //批量处理
    ...
    function chooseOne(menuid) {
      	...
      	if(row){
      		var url = "ApprovalFormCriminalRewardPunishmentation.action?1=1&menuid="+menuid+"&crimid="+row.crimid+"&tempid=SH_ZFJLCFSPB";
      		if(row.idnumber && row.duty != '-1')url += "&idnumber="+row.idnumber;
		self.location.href=url;
      	}else{
