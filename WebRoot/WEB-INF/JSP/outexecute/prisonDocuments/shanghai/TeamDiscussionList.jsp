...
<head>
	<title>暂予监外执行集体讨论表（获取罪犯列表）</title>
...
<body onload="init('${menuid}');">
    <div class="mini-toolbar"  style="padding:0px;border-bottom: 0px;">
        ...
        <table >
             <tr>
                <td style="width:100%;">
					<a class="mini-button" style="display:none;" id="14073" plain="true" onclick="chooseAll(14072);">批量处理</a>
                </td>
    ...
    <div class="mini-fit" id="div_two">
        <div id="datagrid1" class="mini-datagrid" style="width:100%;height:100%;" allowResize="false" sizeList="[10,20,50,100]" pageSize="20"
        	 url="TheTeamDiscussionList.action?1=1" idField="spid" multiSelect="true" allowAlternating="true" virtualScroll="false" 
        	 showLoading="false" onbeforeload="myloading" onload="myunmask">
              ...
              <div field="familyaddress" width="170" headerAlign="center" align="left"  allowSort="true">家庭住址</div>
    ...
    <script type="text/javascript">
        ...
        function chooseOne(menuid) {
        	...
        	if(row){
        		var url = "TheTeamDiscussionListNew.action?1=1&menuid="+menuid+"&crimid="+row.crimid+"&tempid=SH_JWZXJTTLB";
        ...
        function chooseAll(menuid){
            ...
            if (rows.length > 0) {
                if (confirm("确定操作 选中记录？")) {
                    ...
                    var url = "TheTeamDiscussionListNew.action?1=1&menuid="+menuid+"&id="+id+"&idname="+idname+"&tempid=SH_JWZXJTTLB";
                    self.location.href=url;
                }
            } else {
