...
<body onload="init('${menuid}');">
	...
	<div size="38px;" showCollapseButton="false">
		...
		<td style="width:100%;">
			...
			<a class="mini-button"  iconCls="icon-save" plain="true" style="display:none;" id="11076" onclick="doSubmitFlow('11076','save','doc_zfrzhzpglbsp','ZFGZBXZHPGB');">存盘</a>
			<a class="mini-button"  iconCls="icon-downgrade" plain="true" style="display:none;" id="900029" onclick="doSubmitFlow('900029','yes','doc_zfrzhzpglbsp','ZFGZBXZHPGB');">提交</a>
	    	<a class="mini-button"  iconCls="icon-downgrade" plain="true" style="display:none;" id="900027"  onclick="operationOpprove('900027','yes','');">同意</a>
	    	<a class="mini-button"  iconCls="icon-upgrade" plain="true" style="display:none;" id="900028" onclick="operationOpprove('900028','no','');">拒绝</a>
    ...
    <script type="text/javascript">
        ...
        function saveNext (){
            ...
            var url = "TheCriminalComprehensiveEvaluationTable.action?1=1&id="+id+"&menuid="+menuid+"&tempid=ZFGZBXZHPGB";
            if(index>0){
        ...
        function onCanle(){
        	url = "CriminalComprehensiveEvaluationTable.action?1=1&id="+id+"&menuid=900022";
        	self.location.href=url;
        }
    </script>
</body>
