...
<body onload="init('12389');">
    <div class="mini-toolbar"  style="padding:0px;border-bottom: 0px;">
	    <jsp:include page="/WEB-INF/JSP/form/buttoncontrol.jsp"></jsp:include>
        <table >
             <tr>
                <td style="width:100%;">
                 <a class="mini-button" style="display:none;" id="13709" iconCls="" plain="true" onclick="chooseAll('12390')">批量处理</a>
                </td>
                <td style="white-space:nowrap;"> 
                   ...
                   <a class="mini-button" plain="true" iconCls="icon-help" onclick="chakanshuoming('12389')"></a>
                 </td>
             </tr>
        </table>
    </div>
    <div class="mini-fit" id="div_two">
        <div id="datagrid1" class="mini-datagrid" style="width:100%;height:100%;" allowResize="false" sizeList="[10,20,50,100]" pageSize="20"
        	 url="<%=path%>/prisonDocuments/shanghai/getProlongedMedicalParoleApplicationChoose.json?1=1" idField="spid" multiSelect="true" allowAlternating="true" virtualScroll="false" 
          ...
          <div property="columns">
              ...
              <div field="accent" width="80" headerAlign="center" align="center"  allowSort="true">所在监区</div>
    ...
    <script type="text/javascript">
        ...
        var grid = mini.get("datagrid1");
         ...
         function onActionRenderer(e) {
	        var record = e.record;
	        var s = '';
        		s += ' <a class="Edit_Button"  href="javascript:chooseOne(\'12390\');" >处理</a>';
            return s;
        }
        //根据罪犯编号跳转到释放证明书表单页面
        function chooseOne(menuid) {
        	var row = grid.getSelected();
        	var url = "<%=path%>/prisonDocuments/shanghai/toProlongedMedicalParoleApplicationListPage.page?1=1&crimid="+row.crimid+"&name="+row.name+"&menuid="+menuid;
        ...
        function chooseAll(menuid){
            ...
            if (rows.length > 0) {
                if (confirm("确定操作 选中记录？")) {
                    ...
                    var url = "<%=path%>/prisonDocuments/shanghai/toProlongedMedicalParoleApplicationListPage.page?1=1&id="+id+"&menuid="+menuid+"&idname="+idname;
                    self.location.href=url;
                }
            } else {
                alert( "请至少选中一条记录！");
