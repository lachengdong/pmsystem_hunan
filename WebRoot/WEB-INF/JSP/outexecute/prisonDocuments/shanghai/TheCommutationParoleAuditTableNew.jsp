...
<!--		<input name="orgid" id="orgid" class="mini-hidden" value="${orgname1}"/>-->
    		<a class="mini-button" id="12419" iconCls="icon-save" plain="true" onclick="doSubmitFlow('12419','save','other_slzfrdsp','SH_ZFJXJSSHB');">存盘</a>
...
<!--    	<a class="mini-button" style="display:none;" id="10901" iconCls="icon-upgrade" plain="true" onclick="operationOpprove('10901','no','');">拒绝</a>-->
    ...
    <script type="text/javascript">
      ...
      //手动关闭
        function Close(){
        	window.location.href="TheCommutationParoleAuditTableChoose.action?1=1";
