...
<body >
    ...
    <div class="mini-fit">
	    <div id="datagrid" allowMoveColumn="false" onrowdblclick="rowdblclickfunction" style="width:100%;height:100%;" class="mini-datagrid"  allowResize="false" 
	    	 url="jwzxchushiExamineList.json?1=1" idField="" multiSelect="true" allowAlternating="true" sizeList="[10,20,50,100]" pageSize="20"  showLoading="true">
    ...
    <script type="text/javascript">
	    ...
	    function banan(){
            ...
            if (row) {
                var win = mini.open({
                    url: "tojwzxchushiExamine.action?1=1&crimid="+row.crimid+"&tempid="+tempid,
                    showMaxButton: true,
             	    allowResize: false, 
	    ...
	    function jianyishu(){
	    	...
	    	if(row){
	    		var win = mini.open({
	    			url: "tojwzxchushiExaminejianyishu.action?1=1&crimid="+row.crimid,
	    			showMaxButton: true,
	    			allowResize: false,
