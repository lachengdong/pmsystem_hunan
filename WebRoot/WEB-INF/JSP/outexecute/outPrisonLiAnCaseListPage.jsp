    ...
    <div id="div_one" class="s">
        <div class="mini-toolbar" style="padding:0px;border-bottom:0;">
   		...
   		<div class="mini-fit" id="div_two">
			...
			pageSize="20"  url="getJailOutPrisonLiAnData.action?1=1&flowdefid=${flowdefid}&status=${status}"    multiSelect="true"  >
    ...
    <script type="text/javascript">
       ...
       var provincecode = mini.get('provincecode').getValue();
        function onActionRenderer(e) {
			...
			var s = "";
			s += " <a class=\"Edit_Button\" id=\"10953\" href=\"javascript:commuteLiAn('2');\" >立案</a>&nbsp;&nbsp;";
        ...
        function commuteLiAn(commutetype){
			...
			if(row){
				...
				if(confirm(mess)){
					...
					$.ajax({
				         url: "<%=path%>/baoWaiJailLiAn.action", 
