...
<body onload="init('${menuid}');">
	<div class="mini-toolbar" style="padding: 2px; border-bottom: 0px;">
		...
		<table>
			<tr>
				<td style="width: 100%;">
					<a class="mini-button" iconCls="icon-add" plain="true" style="display: none;" id="11987" onclick="add('11987');">新增</a>
<!--					<a class="mini-button" iconCls="icon-remove" plain="true" style="display: none;" id="11994" onclick="shanchu();">批量删除</a>-->
					<a class="mini-button" iconCls="icon-download" plain="true" style="display:none;" id="12869" onclick="saveNext()">下一个</a>
	...
	<div class="mini-fit">
		<div id="datagrid" allowMoveColumn="false" onrowdblclick="rowdblclickfunction" style="width: 100%; height: 100%;" class="mini-datagrid" sizeList="[10,20,50,100]" pageSize="20" 
			allowAlternating="true" showLoading="true" allowResize="false" url="getjailReviewOfficeList.action?1=1&tempid=SZ_BWJY_CSSCBG&crimid=${crimid}" multiSelect="true">
	...
	<script type="text/javascript"> 
	 	...
	 	function add(menuid){
	 		...
	 		mini.open({
	 	        url: "tojailReviewOfficeAdd.action?1=1&tempid=SZ_BWJY_CSSCBG&menuid="+menuid+"&crimid="+crimid,
	 	        showMaxButton: true,
	 	        allowResize: false,
	 	        title: "审查报告(报处室)", width: 900, height: 500,
	 	        onload: function () {
		...
		function saveNext (){
	        ...
	        var url= "tojailReviewOfficeList.action?1=1&id="+id+"&menuid=${menuid}&idname="+idname;
	        if(index>0){
		...
		function onCancel(){
			var url = "jailReviewOfficeList.action?1=1&menuid=10292";
			self.location.href=url;
		}
	</script>
</body>
