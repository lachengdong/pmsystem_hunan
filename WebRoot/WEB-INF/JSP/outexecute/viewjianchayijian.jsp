...
<body onload="init('${menuid}');">
	...
	<div size="38px;" showCollapseButton="false">
		...
		<td style="width:100%;">
	    	...
	    	<a class="mini-button"  iconCls="icon-save" plain="true" style="display:none;" id="11988" onclick="savedata();">存盘</a>
	    	<a class="mini-button"  style="display:none;" iconCls="icon-save" plain="true"  id="11990" onclick="savedata();">存盘</a>		
