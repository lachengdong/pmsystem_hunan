...
<body onload="init('${menuid}');">
       ...
       <jsp:include page="/WEB-INF/JSP/form/buttoncontrol.jsp"></jsp:include>
            <table >
               <tr>
                <td style="width:100%;">
            	 	<a class="mini-button" iconCls="icon-add" plain="true" style="display:none;" id="1000054" onclick="add('1000054');">新增</a>
           			<a class="mini-button" iconCls="icon-download" plain="true" style="display:none;" id="1000055" onclick="saveNext()">下一个</a>
    ...
    <div class="mini-fit">
	    ...
	    url="getQBSListByCrimid.action?1=1&crimid=${crimid}&tempid=ZYJWZXQBS"  idField="" multiSelect="true" allowAlternating="true" showLoading="true">
...
<!--	       		<div type="checkcolumn" width="15px"></div>-->
    ...
    <script type="text/javascript"> 
        ...
        function add(menuid){
	 		...
	 		mini.open({
	 	        url: "toQBSAdd.action?1=1&tempid=ZYJWZXQBS&crimid="+crimid+"&menuid="+menuid+"&name="+name,
	 	        showMaxButton: true,
	 	        allowResize: false,
		...
		function chakan(menuid) {
			...
			var crimid = mini.get("crimid").getValue();
	    	mini.open({
                url: "QBSLook.action?1=1&docid="+row.docid+"&crimid="+crimid+"&menuid="+menuid,
                showMaxButton: true,
             	allowResize: false, 
        ...
        function shanchu(){
            ...
            if (rows.length > 0) {
                if (confirm("确定删除选中记录？")) {
                    ...
                    $.ajax({
                        url: "QBSDelete.action?1=1&docid="+id,
                        type: "post",
		 ...
		 function saveNext (){
	        ...
	        var url= "toQBSDocList.action?1=1&id="+id+"&menuid=${menuid}&idname="+idname;
	        if(index>0){
