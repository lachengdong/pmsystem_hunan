...
<body onload="previewSuggestDoc();">
    ...
    <div class="mini-toolbar" style="padding:2px;border-top:0;border-left:0;border-right:0;"> 
    	<table >
               <tr>
                <td style="width:100%;">
            建议书：<select onchange="previewSuggestDoc()" id="wenshu">
			  ...
			  <td style="white-space:nowrap;">
			  	<a class="mini-button"  id="12177" style="display:none;" plain="true" iconCls="icon-save"  onclick="saveBigData()">存盘</a>
			  	<a class="mini-button"  id="12178" style="display:none;" plain="true" iconCls="icon-save"  onclick="submitBigData()">提交</a>
			  </td>
		</tr>
		</table>
     </div>
    ...
    <script type="text/javascript">
        ...
        function previewSuggestDoc(){
        	...
        	if(crimid){
	           var url="toSingleSuggestDocumentPage.action?crimid="+crimid+"&tempid="+tempid+"&flowdraftid="+flowdraftid;
