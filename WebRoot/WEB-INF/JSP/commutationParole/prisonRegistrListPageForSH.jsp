...
<body> 
    <div class="mini-toolbar" style="padding:0px;border-bottom:0;">
        ...
        <table style="width:100%;">
          ...
          <!--   <a class="mini-button" iconCls="icon-user"  plain="true" onclick="jfkh()">狱内奖惩</a> -->
	...
	<!--        <div field="age" width="40" headerAlign="center" align="center"  allowSort="true">年龄</div>-->
	            ...
	            <!--  
	            <div field="refid" width="75" headerAlign="center" align="center"  allowSort="true" width="0px;">减刑方案ID</div>
	            <div field="jspunid" width="75" headerAlign="center" align="center"  allowSort="true" width="0px;">假释方案ID</div>
	            -->
    ...
    <script type="text/javascript">
        ...
        function onActionRenderer(e){
		    ...
		    if(provincecode=='1200'){
		    	//狱内奖惩是天津的功能，其他省份如果需要，把省份编码加上即可
			    s += '<a class="Edit_Button" id="12258" href="javascript:jfkh()" >狱内奖惩</a>&nbsp;';
		    }
						...
						success:function(text){
							if(text == 0){
			   					$.ajax({
			   				         ...
			   				         flowdefid:flowdefid,tempid:tempid,applyid:applyid,applyname:applyname, curyear:curyear,batch:batch,shortname:shortname,casetype:casetype},
			   				         type: "POST",
			   				         dataType:"json",
			   				         async:false,
			   				         success: function (text){
						...
						success:function(text){
							if(text == 0){
			                     $.ajax({
			 				         ...
			 				         flowdefid:flowdefid,tempid:tempid,dataStr:dataStr,batch:batch,shortname:shortname,casetype:casetype,repeatCaseNum:repeatCaseNum},
			 				         type: "POST",
			 				         dataType:"json",
			 				         async:false,
			 				         cache: false,
