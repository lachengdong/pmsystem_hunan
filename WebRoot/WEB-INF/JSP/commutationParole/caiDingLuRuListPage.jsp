...
<body onload="init('${menuid}');">
    ...
    <div class="mini-fit" id="div_two">
        <div id="datagrid" allowMoveColumn="false" style="width:100%;height:100%;" 
	    	class="mini-datagrid"  allowResize="false" url="getCaiDingList.json?1=1&batchid="+${batchid}   
	        ...
	        <div property="columns">
	    		...
	    		<div field="crimid" headerAlign="center"  align="center" allowSort="true" width="50px">罪犯编号</div>
	    		<div field="category" headerAlign="center"  align="center" allowSort="true" renderer="onActionBianDongType" width="40px">变动类别</div>
	    		<div field="courtname" headerAlign="center"  align="center" allowSort="true" width="45px">法院地址</div>
	    		<div field="courttitle" headerAlign="center"  align="center" allowSort="true" width="45px">法院名称</div>
	   			<div field="courtyear" headerAlign="center" align="center" allowSort="true" width="85px;">裁定年份</div>
	   			<div field="courtshort" headerAlign="center" align="center" allowSort="true" width="60px;">裁定字</div>
	    		<div field="courtsn" headerAlign="center"  align="center" allowSort="true" width="60px">裁定字号</div>
	    		<div field="courtsanction" headerAlign="center"  align="center" allowSort="true" width="40px">裁定时间</div>
	    		<div field="courtchange" headerAlign="center"  align="center" allowSort="true" width="35px">变动刑期</div>
                <div field="sentence" headerAlign="center"  align="center" allowSort="true" width="45px">变后刑期</div>
                <div field="courtchangefrom" headerAlign="center"  align="center" allowSort="true" width="45px">变后起日</div>
	    		<div field="courtchangeto" headerAlign="center"  align="center" allowSort="true" width="0px">变后止日</div>
	    		<div field="courtarea" headerAlign="center"  color="red" align="center" allowSort="true" renderer="onActionExamineType" width="40px">法院区属</div>
	   			<div name="losepower" headerAlign="center" align="center"  width="60px" renderer="onActionRenderer">剥权</div>
	   			
	   			<div name="awardend" headerAlign="center" align="center"  width="60px" >考核止日</div>
	   			<div name="exectime" headerAlign="center" align="center"  width="60px" >剥权</div>
	   			<div name="uuid" headerAlign="center" align="center"  width="60px" >主键</div>
	   			
	   			<div name="courtname_code" headerAlign="center" align="center"  width="60px" >区域code</div>
	   			<div name="courttitle_code" headerAlign="center" align="center"  width="60px" >名称code</div>
	   			<div name="losepower" headerAlign="center" align="center"  width="60px" >剥权</div>
