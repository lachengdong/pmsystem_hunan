	...
	<body onload="init('10266');">
		...
		<div class="mini-fit" id="div_two">
			<div id="datagrid1" class="mini-datagrid"
				...
				<div property="columns">
					...
					<div id="action" width="40" headerAlign="center" align="center"
        ...
        function onActionRenderer(e) {
	        ...
	        /*	if(record.idnumber ){
	       		...
	       		else s += ' <a class="Edit_Button"  href="javascript:chooseOne(1026602);" >处理</a>';
	       	} 
	       	*/
       ...
       function chooseOne(menuid) {
	       	...
	       	if(row){
	       		var url = "<%=path%>/threeOfCrimAffirm/toThreeOfCrimAffirmPage.page?1=1&menuid="+menuid+"&crimid="+row.crimid+"&flowdefid=${flowdefid}"+"&lastnodeid="+row.duty;
        	...
        	var rows = grid.getSelecteds();
           	if(rows.length > 0){
                   ...
                   for (var i = 0, l = rows.length; i < l; i++) {
                       var r = rows[i];
                       if(r.idnumber){
                       		if(nodeids != r.duty && r.orgcontact == '2'){
                       			continue;
                       		}else{
				   ...
				   if(ids.length == '0'){//所选中的数据都是审批中的
						   ...
						   var id = ids.join(',');
		                   var url= "<%=path%>/threeOfCrimAffirm/toThreeOfCrimAffirmPage.page?1=1&menuid="+menuid+"&id="+id
		                   +"&flowdefid=${flowdefid}";
		                   self.location.href=url;
				   		}
				   }
