...
<body onload="init('${menuid}');">
	...
	<div size="38px;" showCollapseButton="false">
		...
		<td style="width:100%;">
	    	...
	    	<a class="mini-button" style="display:none;" id="12129" iconCls="icon-save" plain="true" onclick="doSubmitFlow('12129','save','other_bjshzfrdsp','BJSHZFRDSPB');">存盘</a>
	    	<a class="mini-button" style="display:none;" id="12130" iconCls="icon-downgrade" plain="true" onclick="doSubmitFlow('12130','yes','other_bjshzfrdsp','BJSHZFRDSPB');">提交</a>
	    	<a class="mini-button" style="display:none;" id="12134" iconCls="icon-downgrade" plain="true" onclick="operationOpprove('12134','yes','fjqyj');">同意</a>
	    	<a class="mini-button" style="display:none;" id="12135" iconCls="icon-downgrade" plain="true" onclick="operationOpprove('12135','yes','jqshyj');">同意</a>
	    	<a class="mini-button" style="display:none;" id="12136" iconCls="icon-downgrade" class="mini-hidden" plain="true" onclick="operationOpprove('12136','yes','xfzxkyj');">同意</a>
	    	<a class="mini-button" style="display:none;" id="12137" iconCls="icon-downgrade" class="mini-hidden" plain="true" onclick="operationOpprove('12137','yes','jyldyj');">同意</a>
	    	<a class="mini-button" style="display:none;" id="12138" iconCls="icon-upgrade" plain="true" onclick="operationOpprove('12138','no','fjqyj');">拒绝</a>
	    	<a class="mini-button" style="display:none;" id="12139" iconCls="icon-upgrade" plain="true" onclick="operationOpprove('12139','no','jqshyj');">拒绝</a>
	    	<a class="mini-button" style="display:none;" id="12140" iconCls="icon-upgrade" plain="true" onclick="operationOpprove('12140','no','xfzxkyj');">拒绝</a>
	    	<a class="mini-button" style="display:none;" id="12141" iconCls="icon-upgrade" plain="true" onclick="operationOpprove('12141','no','jyldyj');">拒绝</a>
	    	<a class="mini-button" style="display:none;" id="12131" iconCls="icon-undo" plain="true" onclick="operationOpprove('12131','back','xfzxkyj');">退回</a>
	    	<a class="mini-button" style="display:none;" id="12500" iconCls="icon-undo" plain="true" onclick="operationOpprove('12500','back','jqshyj');">退回</a>
	    	<a class="mini-button" style="display:none;" id="12133" iconCls="icon-undo" plain="true" onclick="operationOpprove('12133','back','jyldyj');">退回</a>
	    	<a class="mini-button" style="display:none;" id="12142" iconCls="icon-download" plain="true" onclick="saveNext();">下一个</a>
    ...
    <script type="text/javascript">
    	mini.parse();
	     ...
	     function saveNext(){           
	         ...
	         var url= "toThreemakeExaminationAndApprovalPage.action?1=1&id="+id+"&menuid="+menuid;
	         if(index>0){
	     ...
	     //手动关闭
	     function onCanle(){
	     	var url ="toThreemakeExaminationAndApprovalChoose.action?1=1";
	     	self.location.href=url;
	     }
    </script>
</body>
