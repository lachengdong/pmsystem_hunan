...
<body onload="init('12125');">  
    <div class="mini-toolbar"  style="padding:0px;border-bottom: 0px;">
    	<jsp:include page="/WEB-INF/JSP/form/buttoncontrol.jsp"></jsp:include>
        <table>
             <tr>
                <td style="width:100%;">
                	<a class="mini-button" style="display:none;" id="12127" iconCls="" plain="true" onclick="chooseAll('12128');">批量处理</a>
                </td>
    ...
    <div class="mini-fit" >
        <div id="datagrid1" class="mini-datagrid" style="width:100%;height:100%;" allowResize="false"  sizeList="[10,20,50,100]" pageSize="20"
           multiSelect="true"  url="getThreemakeExaminationAndApprovalList.action?1=1" >
    ...
    <script type="text/javascript">
         ...
         function onActionRenderer(e) {
        	...
        	if(record.idnumber && record.duty != '-1' ){
        		if(record.duty=='0' || record.accent=='1'){
        			s += ' <a class="Edit_Button"  href="javascript:chooseOne(12128);" >修改</a>';
        		}else {
        			s += ' <a class="Edit_Button"  href="javascript:chooseOne(12502);" >查看</a>';
        		}
        	}else{
        		s += ' <a class="Edit_Button"  href="javascript:chooseOne(12128);" >处理</a>';
        	} 
            return s;
        }
        ...
        function chooseOne(menuid) {
        	...
        	if(row){
        		var url = "toThreemakeExaminationAndApprovalPage.action?1=1&crimid="+row.crimid+"&menuid="+menuid;
        	...
        	var rows = grid.getSelecteds();
           	if(rows.length > 0){
				   ...
				   if(ids.length == '0'){//所选中的数据都是审批中的
						   ...
						   var id = ids.join(',');
		                   var url= "toThreemakeExaminationAndApprovalPage.action?1=1&menuid="+menuid+"&id="+id;
		                   self.location.href=url;
				   		}
				   }
           	}else {
