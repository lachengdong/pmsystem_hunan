...
<body onload="init('${menuid}');">
	...
	<div size="38px;" showCollapseButton="false">
		...
		<td style="width:100%;">
	    	...
	    	<a class="mini-button" style="display:none;" id="11904" iconCls="icon-save" plain="true" onclick="doSubmitFlow('11904','save','other_slzfrdsp','JXJS_LBCSHB');">存盘</a>
	    	<a class="mini-button" style="display:none;" id="11905" iconCls="icon-downgrade" plain="true" onclick="doSubmitFlow('11905','yes','other_slzfrdsp','JXJS_LBCSHB');">提交</a>
    ...
    <script type="text/javascript">
        ...
        //手动关闭
        function onCanle(){
        	url ="<%=path%>/threeOfCrimAffirm/oldBingChanShenPiBiao.page?1=1";
        	self.location.href=url;
        }
    </script>
</body>
