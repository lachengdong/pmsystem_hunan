	...
	<jsp:include page="/WEB-INF/JSP/form/buttoncontrol.jsp"></jsp:include>
		<table>
			<tr>
				<td style="width: 100%;">
					${topstr}
					<!--  <a class="mini-button"  style="display: none;" id="18578"  iconCls="icon-save" onclick="SaveData('18578');" plain="true" >存盘</a>
					<a class="mini-button"  style="display: none;" id="18579"  iconCls="icon-downgrade" onclick="SaveData('18579');" plain="true" >提交</a>
					<a class="mini-button"  style="display: none;" id="18583"  iconCls="icon-undo" onclick="back('18583')" plain="true" >退回</a>-->
	...
	<div style="padding-left: 15px; padding-bottom: 5px;">
		<table style="table-layout: fixed;">
			<tr style="height: 10px;">
				...
				<td >
					<!--  <select id="caichantype" name="caichantype" style="width:250px" >
						<option value="fajin">罚金</option>
						<option value="moshou">没收财产</option>
						<option value="minpei">民事赔偿</option>
						<option value="zangkuan">赃款</option>
					</select>	-->
					<input id="caichantype" class="mini-treeselect" emptyText="请选择..." showNullItem="true" nullItemText="请选择..." value="${caichantype }" required="true"
			         textField="text" valueField="id" name="caichantype" showFolderCheckBox="false"  showClose="true" popupWidth="200" data="[{id:'fajin',text:'罚金'},{id:'moshou',text:'没收财产'},{id:'minpei',text:'民事赔偿'},{id:'zangkuan',text:'追缴赃款'}]"/>
				</td>
