...
<body onload="SetData();">
    ...
    <script type="text/javascript">
        ...
        function saveBigData() {
           ...
           $.ajax({
	                 url: "<%=path%>/saveSuggestion_nx.action?1=1",
	                 type: "post",
	                 data:{bigdata:data.annexcontent, crimid:crimid, flowdraftid:flowdraftid, flowid:flowid, tempid:tempid,otherid:otherid},
	                 success: function (text) {
	                 	var obj = eval(text);
						if(obj != '0'){
							alert("操作成功！");
							mini.get("otherid").setValue(obj);
						}else{
							alert("操作失败！");
						}
	                }
		...
		function preview(){
	        ...
	        var otherid = mini.get("otherid").getValue();
	        //menuid为用于查询方案的id
        	var url = "toPreviewSuggestReport.action?1=1&menuid="+menuid+"&flowdraftid="+flowdraftid+"&tempid="+tempid+"&crimid="+crimid+"&nowpunishmenttype="+nowpunishmenttype+"&aid="+aid+"&otherid="+otherid+"&flowdefid="+flowdefid;
