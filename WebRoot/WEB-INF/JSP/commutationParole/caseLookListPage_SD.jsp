...
<body>
            ...
            <table style="width:100%;">
                <tr>
                    ...
                    <td style="white-space:nowrap;">
			            ...
			            <input id="key" class="mini-textbox" emptyText="罪犯编号、姓名、拼音首字母"  id="key" onenter="onKeyEnter"  enabled="true"/>
    ...
    <div class="mini-fit">
	    <div id="datagrid1" allowMoveColumn="false" allowCellEdit="true" style="width:100%;height:100%;" class="mini-datagrid"   
	        ...
	        <div property="columns">
	        	...
	        	<div type="expandcolumn" >操作记录</div>
	    ...
	    <div id="detailGrid_Form" style="display:none;">
	        ...
	        style="width:100%;height:260px;" url="jxjs/selectFlowForScar.json">
	            <div property="columns">
	                ...
	                <div field="opname" width="20" align="center" headerAlign="center" allowSort="true">操作用户</div>
	                <div field="bumen" width="20" align="center" headerAlign="center" allowSort="true">所在部门</div>
	                <div field="IP" width="20" align="center" headerAlign="center" allowSort="true">操作IP</div>
	                <div field="opinion" width="20" align="center" headerAlign="center" allowSort="true">意见</div>                                    
	            </div>
	        </div>    
	    </div>
	</div>
    ...
    <script type="text/javascript">
	    ...
	    //var dataResult = null
	    //$.ajax({
	    //    url: "<%=path%>/getCaseLookList.json?1=1",
	    //    dataType: 'text',
	    //    async: false,
	    ...
	    //    }
	    // });
	    //function casefilter(key,nodeid){
	    //	 $.ajax({
		//        url: "<%=path%>/getCaseLookList.json?1=1",
		//        dataType: 'text',
		//        data:{key : encodeURI(key),nodeid:nodeid},
		//        async: false,
		//        success: function (text) {
		//            dataResult = mini.decode(text);
		//        }
        ...
        function checkaip(id){
            ...
            if (row) {
            	...
            	+row.flowdefid+"&menuid=10096"+"&docid=003001"+"&tempid=JXJS_JXJSSHB"+"&jysdocid=004001"+"&jxstempid=jailcommutereport";
                mini.open({
                    url: url,
                    showMaxButton: true,
                    allowResize: false, 
