...
<body>
    ...
    <input id="flowdefid" type="hidden" value="${flowdefid}"/>
    ...
    <div id="datagrid1" class="mini-datagrid" style="width:100%;height:100%;" allowResize="false" sizeList="[10,20,50,100]" pageSize="20" 
        url="getMeetingList.action?meetcontent=${meetcontent}&flowdefid=${flowdefid}"  idField="" multiSelect="true"  allowAlternating="true">
