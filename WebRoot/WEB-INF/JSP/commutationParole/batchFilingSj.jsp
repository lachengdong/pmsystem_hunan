...
<body >
       <div class="mini-toolbar"  style="padding:2px;border-bottom: 0px;">
            <table >
               <tr>
                <td style="width:100%;">
                	<a class="mini-button" id="16007" iconCls="" plain="true"  onclick="allcaozuoguidang('16007');">案件归档</a>
                	
                </td>
                <td style="white-space:nowrap;">
                    <a class="mini-button" plain="true" iconCls="icon-help" onclick="chakanshuoming('16006')"></a>	
                </td>
               </tr>
		</table>
    ...
    <div class="mini-fit">
	    <div id="datagrid"  class="mini-datagrid"  style="width:100%;height:100%;"   url="<%=path %>/case/ajaxguidangcrimebasesjinfo.json?1=1"  idField="" multiSelect="true" allowResize="false" allowCellEdit="true"  showFilterRow="true" allowCellSelect="true" sizeList="[10,20,50,100]" pageSize="20" >
...
<script type="text/javascript"> 
    ...
    function onActionRenderer(e) {
        ...
        var s ="";
   			s = '<a class="New_Button" href="javascript:allcaozuoguidang(\'16007\');">案件归档</a>';
        ...
        if (rows.length > 0) {
             if (confirm("确定批量操作选中记录？")) {
                 ...
                 for (var i = 0, l = rows.length; i < l; i++) {
                     var r = rows[i];
                     var url = "<%=path%>/case/ajaxmakearchivesj.action?1=1";
			       	 $.ajax({
			                url: url,
			                type: 'POST',
			                cache:false,
