...
<div  id="form1" class="mini-splitter"  vertical="true" style="width:100%;height:100%;border:0px;">
	<div size="38px;" showCollapseButton="false">
		...
		<td style="width:100%;">
			...
			<input id="mytempid" name="mytempid"  type="hidden" value="SH_TUIANHAN"/>
			<a class="mini-button"  id="12321" plain="true" iconCls="icon-save"  onclick="saveBigData(12321)">保存</a>
			<a class="mini-button"  id="12322" plain="true" iconCls="icon-downgrade"  onclick="saveBigData(12322)">提交</a>
    ...
    <script type="text/javascript">
        ...
        function saveBigData(id) {
             ...
             $.ajax({
					...
					data:{bigdata:bigdata,tempid:tempid, crimid:crimid,id:id}, 
					cache:false,
