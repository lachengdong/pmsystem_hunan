  ...
  <!-- 隐藏四字段，已经存在的不写 创建人和更新人 更新时间 -->
    ...
    <div class="mini-fit">
        <ul id="tree1" class="mini-tree" style="width:100%;height:100%;"
            showTreeIcon="true" textField="name" idField="roleid" parentField="departid" resultAsTree="false"
...
<script type="text/javascript">
    ...
    function SetData(data) {
         if (data.action == "edit") {
             ...
             var url = "ajax/getRoleTreeByUser.json?1=1&userid="+data.id;
             tree.setUrl(url);
             //tree.load();
         }else{
    ...
    function onOk() {
    	var userid = mini.get("id").value; //获取选中的用户id
        //var values = tree.getValue (false);//选中的权限id拼接的字符串  1,2,3 ...
        var values = GetData();
       	 $.ajax({
                url: "ajax/saveRoleForUser.json?1=1",
                data: {userid: userid, roleids :values },
                type: "post",
