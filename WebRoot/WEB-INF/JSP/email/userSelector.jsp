...
<body style="padding:0px;overflow: hidden;">
	<div class="mini-layout"
		...
		<div showCollapseButton="false" region="west" style="height:100%;"
		...
		<div showCollapseButton="false"
			...
			borderStyle="border:0px;overflow:hide;" region="center">
			<div class="mini-toolbar" style="padding:2px;border:0; height:30px;">
				<span>姓名/帐号：</span> <input class="mini-textbox" id="key"
					...
					style="padding:2px 10px; width:60px;float:right;margin-right:10px;margin-top:0px;"
					onclick="onOk();">确定</a>
			</div>
	...
	<script type="text/javascript">
		...
		function SetData(data) {
			...
			mini.get("selectedUser").setValue(data.userids);
			selectedUsers = mini.clone(data);
