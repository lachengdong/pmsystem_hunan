...
<form action="">
	...
	<table width="60%"  border=0 cellspacing=0 cellpadding=0  style='border-collapse:collapse;'>
		...
		<tr>
			<td colspan="18"><span style="font-size:24px;font-weight:bold;">${departname}入监监区值班日志</span></td>
		</tr>
		...
		<tr>
			<td class="trd" colspan="2" style="border-left:solid black 1.5pt;">新收押情况</td>
			<td class="trd"  colspan="3">实有新收押人数</td>
			<td class="trd" colspan="3"><textarea id="newdetainnum" name="newdetainnum" onchange="validateNum(this);" style="width:95%;height:40px;overflow-x:hidden;overflow-y:hidden;">${newdetainnum}</textarea></td>
			<td class="trd"  colspan="3">当日新收押人数</td>
			<td class="trd" colspan="3"><textarea id="currdetainnum" name="currdetainnum" onchange="validateNum(this);" style="width:95%;height:40px;overflow-x:hidden;overflow-y:hidden;">${currdetainnum}</textarea></td>
			<td class="trd" colspan="2">下队人数</td>
			<td class="trd" colspan="3" style="border-right:solid black 1.5pt;">
				<textarea id="tooutnum" name="tooutnum" onchange="validateNum(this);" style="width:95%;height:40px;overflow-x:hidden;overflow-y:hidden;">${tooutnum}</textarea>
			</td>
		</tr>
			...
			<td class="trd" colspan="18" style="border-right:solid black 1.5pt;" align="left">
				<table >
					...
					<tr>
						<td align="left">
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							入监教育<input id="educatenum" name="educatenum" value="${educatenum}" type="text" style="width:40px" onchange="validateNum(this);"/>人，
							现场管理巡查情况：
						</td>
					</tr>
					<tr>
