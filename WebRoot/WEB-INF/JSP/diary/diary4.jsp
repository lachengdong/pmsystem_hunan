...
<form action="">
	...
	<table width="60%"  border=0 cellspacing=0 cellpadding=0  style='border-collapse:collapse;'>
		...
		<tr>
			<td colspan="18"><span style="font-size:24px;font-weight:bold;">${departname}禁闭严管隔离审查监区值班日志</span></td>
		</tr>
		...
		<tr>
			<td class="trd" rowspan="2" colspan="3" style="border-left:solid black 1.5pt;">禁闭严管<br/>隔离人数</td>
			<td class="trd" rowspan="2">禁闭<br/>人数</td>
			<td class="trd" rowspan="2" colspan="2"><textarea id="jinbinum1" name="jinbinum1" onchange="validateNum(this);" style="width:92%;height:85px;overflow-x:hidden;overflow-y:hidden;">${jinbinum1}</textarea></td>
			<td class="trd">当日<br/>禁闭</td>
			<td class="trd"><textarea id="currjinbinum" name="currjinbinum" onchange="validateNum(this);" style="width:86%;height:40px;overflow-x:hidden;overflow-y:hidden;">${currjinbinum}</textarea></td>
			<td class="trd" rowspan="2">严管<br/>人数</td>
			<td class="trd" rowspan="2" colspan="2"><textarea id="yanguannum1" name="yanguannum1" onchange="validateNum(this);" style="width:92%;height:85px;overflow-x:hidden;overflow-y:hidden;">${yanguannum1}</textarea></td>
			<td class="trd">当日<br/>严管</td>
			<td class="trd"><textarea id="curryanguannum" name="curryanguannum" onchange="validateNum(this);" style="width:86%;height:40px;overflow-x:hidden;overflow-y:hidden;">${curryanguannum}</textarea></td>
			<td class="trd" rowspan="2">隔离<br/>审查<br/>人数</td>
			<td class="trd" rowspan="2" colspan="2"><textarea id="gelinum1" name="gelinum1" onchange="validateNum(this);" style="width:92%;height:85px;overflow-x:hidden;overflow-y:hidden;">${gelinum1}</textarea></td>
			<td class="trd">当日<br/>隔离</td>
			<td class="trd"  style="border-right:solid black 1.5pt;">
				<textarea id="currgelinum" name="currgelinum" onchange="validateNum(this);" style="width:86%;height:40px;overflow-x:hidden;overflow-y:hidden;">${currgelinum}</textarea>
			</td>
		</tr>	
		
		<tr>
			<td class="trd">当日<br/>解除</td>
			<td class="trd"><textarea id="currjiechujinbi" name="currjiechujinbi" onchange="validateNum(this);" style="width:86%;height:40px;overflow-x:hidden;overflow-y:hidden;">${currjiechujinbi}</textarea></td>
			<td class="trd">当日<br/>解除</td>
			<td class="trd"><textarea id="currjiechuyanguan" name="currjiechuyanguan" onchange="validateNum(this);" style="width:86%;height:40px;overflow-x:hidden;overflow-y:hidden;">${currjiechuyanguan}</textarea></td>
			<td class="trd">当日<br/>解除</td>
			<td class="trd"  style="border-right:solid black 1.5pt;">
				<textarea id="currjiechugeli" name="currjiechugeli" onchange="validateNum(this);" style="width:86%;height:40px;overflow-x:hidden;overflow-y:hidden;">${currjiechugeli}</textarea>
			</td>
		</tr>		
		...
		<tr height="150px">
			<td class="trd" style="border-left:solid black 1.5pt;">禁闭<br/>罪犯<br/>管控<br/>情况</td>
				...
				<div class="mini-fit" height="60px"  id="trid1" style="overflow:hidden;">
				     <div id="datagrid1" class="mini-datagrid" style="height:100%;" idField="id" multiSelect="true"
				         ...
				         <div property="columns">
				           ...
				           <div field="reason" width="22%" headerAlign="center"   align="center"  >禁闭原因
		...
		<tr height="150px">
			<td class="trd" style="border-left:solid black 1.5pt;">严管<br/>罪犯<br/>管控<br/>情况</td>
				...
				<div class="mini-fit" height="60px"  id="trid2" style="overflow:hidden;">
				     <div id="datagrid2" class="mini-datagrid" style="height:100%;" idField="id" multiSelect="true"
				         ...
				         <div property="columns">
				           ...
				           <div field="reason" width="22%" headerAlign="center"   align="center"  >严管原因
				                <input property="editor" class="mini-textbox"  allowInput="true"  style="width:100%;"/> 
				            </div>   
				           <div field="info" width="33%" headerAlign="center"  align="center"  >管控情况
				                <input property="editor" class="mini-textbox"  allowInput="true"  style="width:100%;"/>
		...
		<tr height="150px">
			<td class="trd" style="border-left:solid black 1.5pt;">隔离<br/>审查<br/>罪犯<br/>管控<br/>情况</td>
			<td class="trd" colspan="17" style="border-right:solid black 1.5pt;">
				<div class="mini-fit" height="60px"  id="trid3" style="overflow:hidden;">
				     <div id="datagrid3" class="mini-datagrid" style="height:100%;" idField="id" multiSelect="true"
				         ...
				         <div property="columns">
				            ...
				            <div field="reason" width="22%" headerAlign="center"   align="center"  >隔离审查原因
				                <input property="editor" class="mini-textbox"  allowInput="true"  style="width:100%;"/> 
				            </div>        
				           <div field="info" width="33%" headerAlign="center"  align="center"  >管控情况
				                <input property="editor" class="mini-textbox"  allowInput="true"  style="width:100%;"/>
...
<script type="text/javascript">
    ...
    //var diarydate = '${diarydate}';				//日期
    //
   function reLoadGrid(flowdraftid, operatetype){
	    grid1.load({flowdraftid:flowdraftid, type:"40", operatetype:operatetype});
   		grid2.load({flowdraftid:flowdraftid, type:"41", operatetype:operatetype});
   		grid3.load({flowdraftid:flowdraftid, type:"42", operatetype:operatetype});
    }
    ...
    function newRow1(){
    	newRow(grid1, "trid1", "datagrid1", "40");
    }
    ...
    function newRow2(){
    	newRow(grid2, "trid2", "datagrid2", "41");
    }
    ...
    function newRow3(){
    	newRow(grid3, "trid3", "datagrid3", "42");
    }
