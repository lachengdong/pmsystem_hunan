...
<form action="">
	...
	<table width="60%"  border=0 cellspacing=0 cellpadding=0  style='border-collapse:collapse;'>
		...
		<tr>
			<td colspan="18"><span style="font-size:24px;font-weight:bold;">${departname}总值班日志</span></td>
		</tr>
		...
		<tr>
			<td class="trd" style="border-left:solid black 1.5pt;border-top:solid black 1.5pt;">值班<br/>科长</td>
			<td class="trd" colspan="6" style="border-top:solid black 1.5pt;">
				<textarea id="policemenkezhang" name="policemenkezhang" style="width:97%;height:60px;overflow-x:hidden;overflow-y:hidden;">${policemenkezhang}</textarea>
			</td>
			...
			<td class="trd" colspan="10" align="left" style="border-top:solid black 1.5pt;border-right:solid black 1.5pt;">
				<table width="100%">
					<tr align="center">
						<td style="width:40px">&nbsp;</td>
						<td><input id="skezhangday" name="skezhangday" value="${skezhangday}" type="text" style="width:30px" onchange="validateNum(this);" />日</td>
						<td><input id="skezhanghour" name="skezhanghour" value="${skezhanghour}" type="text" style="width:30px" onchange="validateNum(this);" />时</td>
						<td><input id="skezhangminute" name="skezhangminute" value="${skezhangminute}" type="text" style="width:30px" onchange="validateNum(this);" />分</td>
						<td>至</td>
						<td><input id="ekezhangday" name="ekezhangday" value="${ekezhangday}" type="text" style="width:30px" onchange="validateNum(this);" />日</td>
						<td><input id="ekezhanghour" name="ekezhanghour" value="${ekezhanghour}" type="text" style="width:30px" onchange="validateNum(this);" />时</td>
						<td><input id="ekezhangminute" name="ekezhangminute" value="${ekezhangminute}" type="text" style="width:30px" onchange="validateNum(this);" />分</td>
						<td style="width:40px">&nbsp;</td>
					</tr>
				</table>
			</td>
		...
		<tr>
			<td class="trd" style="border-left:solid black 1.5pt;border-top:solid black 1.5pt;">巡查<br/>人员</td>
			<td class="trd" colspan="6" style="border-top:solid black 1.5pt;">
				<textarea id="patrol" name="patrol" style="width:97%;height:60px;overflow-x:hidden;overflow-y:hidden;">${patrol}</textarea>
			</td>
			<td class="trd" style="border-top:solid black 1.5pt;">巡查<br/>时间</td>
			<td class="trd" colspan="10" align="left" style="border-top:solid black 1.5pt;border-right:solid black 1.5pt;">
				<table width="100%">
					<tr align="center">
						<td style="width:40px">&nbsp;</td>
						<td><input id="spatrolday" name="spatrolday" value="${spatrolday}" type="text" style="width:30px" onchange="validateNum(this);" />日</td>
						<td><input id="spatrolhour" name="spatrolhour" value="${spatrolhour}" type="text" style="width:30px" onchange="validateNum(this);" />时</td>
						<td><input id="spatrolminute" name="spatrolminute" value="${spatrolminute}" type="text" style="width:30px" onchange="validateNum(this);" />分</td>
						<td>至</td>
						<td><input id="epatrolday" name="epatrolday" value="${epatrolday}" type="text" style="width:30px" onchange="validateNum(this);" />日</td>
						<td><input id="epatrolhour" name="epatrolhour" value="${epatrolhour}" type="text" style="width:30px" onchange="validateNum(this);" />时</td>
						<td><input id="epatrolminute" name="epatrolminute" value="${epatrolminute}" type="text" style="width:30px" onchange="validateNum(this);" />分</td>
						<td style="width:40px">&nbsp;</td>
					</tr>
				</table>
			</td>
		...
		<tr height="150px">
			<td class="trd" style="border-left:solid black 1.5pt;">情况<br/>处理</td>
			<td class="trd" colspan="17" style="border-right:solid black 1.5pt;" align="left">
				<table style="width:100%;height:100%;">
					<tr>
						<td>
