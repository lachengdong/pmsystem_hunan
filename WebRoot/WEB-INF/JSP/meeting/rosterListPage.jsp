    ...
    <div class="mini-fit" id="div_two">
	    ...
	    <div id="datagrid1" allowMoveColumn="false" allowCellEdit="true" style="width:100%;height:100%;" class="mini-datagrid"   
	        ...
	        <div property="columns">
	        	...
	        	<div type="expandcolumn" >减刑假释会议报表记录明细</div>
	        	<%
			    	 //
	    ...
	    <div id="detailGrid_Form" style="display:none;">
	        ...
	        style="width:100%;height:260px;" url="meeting/selectPublicityDetail.json?1=1&tempid=hyreport">
	            <div property="columns">
	                <div type="indexcolumn" width="15">序号</div>
	                <div field="flowdraftid" width="20" align="center" headerAlign="center" allowSort="true" visible="false">报表名称</div>
	                <div field="name" width="30" align="left" headerAlign="center" allowSort="true">报表表名称</div>  
