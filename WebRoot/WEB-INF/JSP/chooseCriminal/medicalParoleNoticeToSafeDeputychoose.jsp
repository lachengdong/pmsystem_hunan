...
<body onload="init('10286')">
    <div class="mini-toolbar"  style="padding:0px;border-bottom: 0px;">
    <!-- 隐藏字段，判断选择罪犯后跳转到哪个主页面 -->     
    <input id="tempid" name="tempid" class="mini-hidden" value="SZ_BWJY_TZSABB"/>
    <jsp:include page="/WEB-INF/JSP/form/buttoncontrol.jsp"></jsp:include>
        <table >
             <tr>
                <td style="width:100%;">
                	<a class="mini-button" style="display:none;" id="12801" plain="true" onclick="chooseAll('10286_01');">批量处理</a>
                </td>
    ...
    <div class="mini-fit" id="div_two">
       <div id="datagrid1" class="mini-datagrid" style="width:100%;height:100%;" allowResize="false" sizeList="[10,20,50,100]" pageSize="20"
        	 url="getMedicalParoleNoticeToSafeDeputyBasicInfoList.action?1=1" idField="spid" multiSelect="true" allowAlternating="true" virtualScroll="false" 
    ...
    <script type="text/javascript">
        ...
        grid.load();
         ...
         function onActionRenderer(e) {
	        ...
	        var s = '';
	        if(record.duty=='0'){
        		s += ' <a class="Edit_Button"  href="javascript:chooseOne(\'10286_01\');" >处理</a>';
        	}else if(record.duty=='1'){
        		s += ' <a class="Edit_Button"  href="javascript:chooseOne(\'10286_01\');" >修改</a>';
        		s += ' <a class="Edit_Button"  href="javascript:chooseOne(12802);" >查看</a>';
        	}
            return s;
        }
        //新增或修改
        function chooseOne(menuid) {
        	...
        	if(row){
        	var url = "toAnBangBanAddpage.action?1=1&tempid="+tempid+"&crimid="+row.crimid+"&menuid="+menuid+"&systempid=${systempid}";
         ...
         function chooseAll(menuid){
            ...
            if (rows.length > 0) {
                if (confirm(allProcessing)) {
                    ...
                    var id = ids.join(',');
                    var url = "toAnBangBanAddpage.action?1=1&id="+id+"&menuid="+menuid+"&systempid=${systempid}";
                    self.location.href=url;
                }
            } else {
        ...
        //快速查询
        function search() {
        	grid.setUrl("getMedicalParoleNoticeToSafeDeputyBasicInfoList.action?1=1");
