...
<body>
    ...
    <div class="mini-fit" id="div_two">
        <div id="datagrid1" class="mini-datagrid" style="width:100%;height:100%;" allowResize="false" sizeList="[10,20,50,100]" pageSize="20"
        	 url="DoGaoZhiChuLI.action?1=1" idField="spid" multiSelect="true" allowAlternating="true" virtualScroll="false" 
    ...
    <script type="text/javascript">
       ...
       function onActionRenderer() {
        ...
        function chooseOne(menuid) {
        	var row = grid.getSelected();
        	var url = "DoParoleNotice.action?1=1&crimid="+row.crimid+"&menuid="+menuid;
