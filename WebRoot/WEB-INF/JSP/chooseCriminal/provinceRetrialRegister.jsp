...
<body onload="init('${menuid}');">
    <div class="mini-toolbar"  style="padding:0px;border-bottom: 0px;">
        ...
        <table >
             <tr>
                <td style="width:100%;">
                    <a class="mini-button" style="display:none;" id="505080" iconCls="" plain="true" onclick="chooseAll('505081');">批量处理</a>
                </td>
      ...
      <div class="mini-fit" id="div_two">
        <div id="datagrid1" class="mini-datagrid" style="width:100%;height:100%;" allowResize="false" sizeList="[10,20,50,100]" pageSize="20" showLoading="false"
        	 url="getProvinceRetrialRegisterBasicInfoList.action?1=1" idField="spid" multiSelect="true" allowAlternating="true" virtualScroll="false">
         <div property="columns">
              ...
              <div field="jailname" width="80" headerAlign="center" align="center"  allowSort="true">所在监狱</div>
    ...
    <script type="text/javascript">
        ...
        grid.load();
         ...
         function onActionRenderer(e) {
            var record = e.record;
            var s =' <a class="Edit_Button"  href="javascript:chooseOne(\'505081\');" >处理</a>';
            return s;
        }
        ...
        function chooseOne(menuid) {
        	...
        	if(row){
        		var url = "toProvinceSingleRetrialRegister.action?1=1&tempid="+tempid+"&crimid="+row.crimid+"&name="+row.name+"&menuid="+menuid;
        ...
        function chooseAll(menuid){
            ...
            if (rows.length > 0) {
                if (confirm("确定操作 选中记录？")) {
                    ...
                    var url = "toProvinceSingleRetrialRegister.action?1=1&id="+id+"&menuid="+menuid+"&idname="+idname;
