...
<body onload="init('10277');">
    <div class="mini-toolbar"  style="padding:2px;border-bottom: 0px;">
    	<jsp:include page="/WEB-INF/JSP/form/buttoncontrol.jsp"></jsp:include>
    	<input id="tempid" name="tempid" class="mini-hidden" value="SJ_JXJS_SJH"/>
        <table >
           <tr>
            <td style="width:100%;">
            	 <a class="mini-button" style="display:none;" id="12681" onclick="chooseAll('12680');" plain="true" iconCls="" >批量处理</a>
            </td>
    ...
    <div class="mini-fit">
	    <div id="datagrid" allowMoveColumn="false" onrowdblclick="rowdblclickfunction" style="width:100%;height:100%;" class="mini-datagrid" sizeList="[10,20,50,100]" pageSize="20"
	    		url="<%=path%>/ProvincialBureauLetter/getProvincialBureauLetterChoose.action?1=1&tempid=SJ_JXJS_SJH"  idField="id"  multiSelect="true" allowAlternating="true" showLoading="true">
	...
	<script type="text/javascript"> 
		...
		//选择	
     	function chooseOne(menuid){
     		...
     		var url = "<%=path%>/ProvincialBureauLetter/provincialBureauLetter.page?1=1";
          	var row = grid.getSelected();
          	if (row) {
         	   	var crimid = row.crimid;
        	    url += "&crimid="+crimid+"&name="+row.name+"&menuid="+menuid+"&tempid="+tempid;
	   		...
	   		if (rows.length > 0) {
	                if (confirm("确定批量处理选中记录？")) {
	                    ...
	                    var idname = idnames.join(',');
	                   	url += "&id="+id+"&idname="+idname+"&menuid="+menuid+"&tempid="+tempid;
						window.location.href=url;
	                }
	            } else {
