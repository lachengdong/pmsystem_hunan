...
<body onload="init('10216')">
    <div class="mini-toolbar"  style="padding:0px;border-bottom: 0px;">
    	<jsp:include page="/WEB-INF/JSP/form/buttoncontrol.jsp"></jsp:include>
        <table >
             <tr>
                <td style="width:100%;">
                	 <a class="mini-button" style="display:none;" id="11342" iconCls="" plain="true" onclick="chooseAll('11343')">批量处理</a>
					 <a class="mini-button" style="display:none;" id="601923" iconCls="" plain="true" onclick="chooseReview('11343')">批量重审</a>
                </td>
    ...
    <div class="mini-fit" id="div_two">
        <div id="datagrid1" class="mini-datagrid" style="width:100%;height:100%;" allowResize="false" sizeList="[10,20,50,100]" pageSize="20"
        	 url="getExpirationReleaseNoticeList.action?1=1" idField="spid" multiSelect="true" allowAlternating="true" virtualScroll="false" 
    ...
    <script type="text/javascript">
       		...
       		if(record.idnumber ){
	       		if(nodeids==lastnodeid){
	       			if(record.orgcontact=='1')
	       				s += ' <a class="Edit_Button"  href="javascript:chooseOne(11343);" >修改</a>';
	       			else
	       				s += ' <a class="Edit_Button"  href="javascript:chooseOne(11343);" >处理</a>';
	       		}else {
	       			s += ' <a class="Edit_Button"  href="javascript:chooseOne(11034);" >查看</a>';
	       		}
	       	}else{
	       		if(nodeids && nodeids!='0') s+='未上报';
	       		else s += ' <a class="Edit_Button"  href="javascript:chooseOne(11343);" >处理</a>';
	       	} 
            return s;
        }
        ...
        function chooseOne(menuid) {
        	...
        	if(row){
        		var url = "disposeExpirationReleaseNotice.action?1=1&crimid="+row.crimid+"&menuid="+menuid+"&flowdefid=${flowdefid}"+"&lastnodeid="+row.duty;;
