...
<body  onload="init('${menuid}');">
        ...
        <table>
             <tr>
                ...
                <td style="white-space:nowrap;">
                   <input id="key" class="mini-textbox" vtype="maxLength:50;" emptyText="请输入罪犯编号、姓名、拼音" style="width:165px;" onenter="onKeyEnter"/>   
    ...
    <div class="mini-fit" id="div_two">
        <div id="datagrid1" class="mini-datagrid" style="width:100%;height:100%;" allowResize="false" sizeList="[10,20,50,100]" pageSize="20"
        	 url="getRewardPunishPointsChoose.action?1=1&flowdefid=${flowdefid}" idField="spid" multiSelect="true" allowAlternating="true" virtualScroll="false" showLoading="false" >
          <div property="columns">
              ...
              <div field="identity" headerAlign="center"  align="center" allowSort=true width="30">审批状态</div>
    ...
    <script type="text/javascript">
        ...
        function chooseOne(menuid) {
        	...
        	if(row){
        		var url = "rewardPunishsPoints.action?1=1&crimid="+row.crimid+"&menuid="+menuid+"&name="+row.name
        			+"&fathermenuid=${menuid}&tempid=${tempid}&flowdefid=${flowdefid}&codetype=${codetype}&pcodeid=${pcodeid}";
        ...
        function chooseAll(menuid){
            ...
            if (rows.length > 0) {
                if (confirm("确定操作选中记录？")) {
                    ...
                    var url = "rewardPunishsPoints.action?1=1&id="+id+"&menuid="+menuid+"&idname="+idname
                    	+"&fathermenuid=${menuid}&tempid=${tempid}&flowdefid=${flowdefid}&codetype=${codetype}&pcodeid=${pcodeid}";
                    self.location.href=url;
                }
            } else {
