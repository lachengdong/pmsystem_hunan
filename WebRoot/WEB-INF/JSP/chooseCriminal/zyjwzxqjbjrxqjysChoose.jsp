...
<body onload="init('10147');">
    <div class="mini-toolbar"  style="padding:0px;border-bottom: 0px;">
    <jsp:include page="/WEB-INF/JSP/form/buttoncontrol.jsp"></jsp:include>
        <table >
             <tr>
                <td style="width:100%;">
                 <a class="mini-button" style="display:none;" id="11554" iconCls="" plain="true" onclick="chooseAll(11553)">批量处理</a> 
                ...
                <td style="white-space:nowrap;"> 
                 ...
                 <a class="mini-button" plain="true" iconCls="icon-help" onclick="chakanshuoming('10147')"></a>  
                 </td>
             </tr>
        </table>
    </div>
    <div class="mini-fit" id="div_two">
        <div id="datagrid1" class="mini-datagrid" style="width:100%;height:100%;" allowResize="false" sizeList="[10,20,50,100]" pageSize="20"
        	 url="getZyjwzxqjbjrxqjys.action?1=1" idField="spid" multiSelect="true" allowAlternating="true" virtualScroll="false" 
    ...
    <script type="text/javascript">
        ...
        function chooseOne(menuid) {
        	...
        	if(row){
	        	var url = "zyjwzxqjbjrxqjys.action?1=1&crimid="+row.crimid+"&menuid="+menuid+"&name="+row.name;
