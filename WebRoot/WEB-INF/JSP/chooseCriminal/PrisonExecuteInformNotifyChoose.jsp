...
<body onload="init('10288');">
    ...
    <input id="docid" name="docid" class="mini-hidden" value="${docid}"/>
        <table >
             <tr>
                 <td style="width:100%;">
				    <a class="mini-button" style="display:none;" id="11832" iconCls="" plain="true" onclick="chooseAll(11812)">批量处理</a>  
                 ...
                 <td style="white-space:nowrap;"> 
                   ...
                   <a class="mini-button" plain="true" iconCls="icon-help" onclick="chakanshuoming('10288')"></a>
                 </td>
             </tr>
        </table>
    </div>
    <div class="mini-fit" id="div_two">
        <div id="datagrid1" class="mini-datagrid" style="width:100%;height:100%;" allowResize="false" sizeList="[10,20,50,100]" pageSize="20"
        	 url="getPrisonExecuteInformNotifyChoose.action?1=1" idField="spid" multiSelect="true" allowAlternating="true" virtualScroll="false" 
    ...
    <script type="text/javascript">
      ...
      function chooseOne(menuid) {
        	...
        	var url = "prisonExecuteInformNotify.action?1=1&crimid="+row.crimid+"&name="+row.name+"&menuid="+menuid+"&docid="+docid;
