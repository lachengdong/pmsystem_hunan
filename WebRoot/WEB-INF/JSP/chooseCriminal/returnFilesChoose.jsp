...
<body onload="init('10160');">
    <div class="mini-toolbar"  style="padding:0px;border-bottom: 0px;">
    <jsp:include page="/WEB-INF/JSP/form/buttoncontrol.jsp"></jsp:include>
        <table >
             <tr>
                <td style="width:100%;">
				    <a class="mini-button" style="display:none;" id="12698" iconCls="" plain="true" onclick="chooseAll(12030)">批量处理</a>
                </td>
    ...
    <div class="mini-fit" id="div_two">
       <div id="datagrid1" class="mini-datagrid" style="width:100%;height:100%;" allowResize="false" sizeList="[10,20,50,100]" pageSize="20"
        	 url="getreturnFilesList.action?1=1&tempid=GDSJ_JWZX_SJTBDA" idField="spid" multiSelect="true" allowAlternating="true" virtualScroll="false" 
    ...
    <script type="text/javascript">
         ...
         function onActionRenderer(e) {
        	...
        	if(record.idnumber && record.duty != '-1' ){
        		if(record.duty=='0' || record.accent=='1'){
        			s += ' <a class="Edit_Button"  href="javascript:chooseOne(12030);" >修改</a>';
        		}else {
        			s += ' <a class="Edit_Button"  href="javascript:chooseOne(12699);" >查看</a>';
        		}
        	}else{
        		s += ' <a class="Edit_Button"  href="javascript:chooseOne(12030);" >处理</a>';
        	} 
            return s;
        }
        ...
        function chooseOne(menuid) {
        	...
        	if(row){
        		var url = "returnFiles.action?1=1&tempid=GDSJ_JWZX_SJTBDA&crimid="+row.crimid+"&menuid="+menuid;
        	...
        	var rows = grid.getSelecteds();
           	if(rows.length > 0){
				   ...
				   if(ids.length == '0'){//所选中的数据都是审批中的
						   ...
						   var id = ids.join(',');
		                   var url = "returnFiles.action?1=1&tempid=GDSJ_JWZX_SJTBDA&id="+id+"&menuid="+menuid;
		                   self.location.href=url;
				   		}
				   }
           	}else {
