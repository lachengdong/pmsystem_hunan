...
<body onload="init('10156');">
    <div class="mini-toolbar"  style="padding:0px;border-bottom: 0px;">
    	<jsp:include page="/WEB-INF/JSP/form/buttoncontrol.jsp"></jsp:include>
        <table >
             <tr>
                <td style="width:100%;">
                	<a class="mini-button" style="display:none;" id="12704" iconCls="" plain="true" onclick="chooseAll(12032)">批量处理</a>
                </td>
    ...
    <div class="mini-fit" id="div_two">
        <div id="datagrid1" class="mini-datagrid" style="width:100%;height:100%;" allowResize="false" sizeList="[10,20,50,100]" pageSize="20"
        	 url="getRegistrationOfMedicalParoleChoose.action?1=1&tempid=GDSJ_JWZX_HYDJ" idField="spid" multiSelect="true" allowAlternating="true" virtualScroll="false" 
    ...
    <script type="text/javascript">
       ...
       function onActionRenderer(e) {
	        ...
	        var s = '';
	        if(record.duty=='0'){
        		s += ' <a class="Edit_Button"  href="javascript:chooseOne(12032);" >处理</a>';
        	}else if(record.duty=='1'){
        		s += ' <a class="Edit_Button"  href="javascript:chooseOne(12032);" >修改</a>';
        		s += ' <a class="Edit_Button"  href="javascript:chooseOne(12033);" >查看</a>';
        	}
            return s;
        }
        //根据罪犯编号跳转到表单页面
        function chooseOne(menuid) {
        	...
        	var tempid="";
        	var url = "showRegistrationOfMedicalParole.action?1=1&crimid="+row.crimid+"&menuid="+menuid;
        ...
        function chooseAll(menuid){
            ...
            if (rows.length > 0) {
                if (confirm("确定操作 选中记录？")) {
                    ...
                    var id = ids.join(',');
                    var url = "showRegistrationOfMedicalParole.action?1=1&id="+id+"&menuid="+menuid;
