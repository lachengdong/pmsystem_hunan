...
<body onload="init('1000150');">
	  <div class="mini-toolbar"  style="padding:2px;border-bottom: 0px;">
	      <jsp:include page="/WEB-INF/JSP/form/buttoncontrol.jsp"></jsp:include>
	      <input name="tempid" id="tempid" class="mini-hidden" value="JQRY"/>
           <table >
              <tr>
               	 <td style="width:100%;">
              		  <a class="mini-button" iconCls="icon-add" plain="true" style="display:none;" id="1000152" onclick="add('1000152')">新增</a>
...
<!--        			  <span style="padding-left:40px;">罪犯姓名：${name}</span>-->
     ...
     <div class="mini-fit">
	    <div id="datagrid" allowMoveColumn="false" onrowdblclick="rowdblclickfunction" style="width:100%;height:100%;" class="mini-datagrid" sizeList="[10,20,50,100]" pageSize="20"
	     	 allowAlternating="true" showLoading="true" allowResize="false" url="getJQRYList.action?1=1" multiSelect="true" >
	...
	<script type="text/javascript">
		...
		function onActionRenderer(e) {
	        ...
	        var s = '';
        	if(record.flowid){
        		s += ' <a class="Edit_Button"  href="javascript:xiugai(1000154);" >查看</a>';
        	}else {
        		s += ' <a class="Edit_Button"  href="javascript:xiugai(1000153);" >修改</a>';
        	}
            return s;
        }
	    //新增
	    function add(menuid){
	    	...
	    	mini.open({
                url: "addJQRY.action?1=1&tempid="+tempid+"&menuid="+menuid,
                showMaxButton: true,
             	allowResize: false, 
		 ...
		 function xiugai(menuid) {
			...
			if(row){
				mini.open({
	                url: "addJQRY.action?1=1&flowdraftid="+row.flowdraftid+"&menuid="+menuid+"&crimid="+row.applyid,
	                showMaxButton: true,
	             	allowResize: false, 
	                title: "监区办案人员名单", width: 900, height: 500,
	                onload: function () {
		 ...
		 function saveNext (){
	        ...
	        var url= "JQRY.action?1=1&id="+id+"&menuid=${menuid}&idname="+idname;
	        if(index>0){
        ...
        function onCancel(){
        	var url = "JQRYChooseList.action?1=1";
			self.location.href=url;
        }
    </script>
</body>
