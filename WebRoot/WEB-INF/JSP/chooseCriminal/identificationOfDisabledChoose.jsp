...
<body onload="init('${menuid }')">
    <div class="mini-toolbar"  style="padding:0px;border-bottom: 0px;">
        ...
        <table >
             <tr>
                <td style="width:100%;">
                <a class="mini-button" style="display:none;" id="13870" plain="true" onclick="chooseAll(13869);">批量处理</a>
                </td>
    ...
    <div class="mini-fit" id="div_two">
        <div id="datagrid1" class="mini-datagrid" style="width:100%;height:100%;" allowResize="false" sizeList="[10,20,50,100]" pageSize="20"
        	 url="getidentificationOfDisabledChooseList.action?1=1&tempid=ZFBCJDB" idField="spid" multiSelect="true" allowAlternating="true" virtualScroll="false" 
    ...
    <script type="text/javascript">
       ...
       function onActionRenderer(e) {
	        ...
	        var s = '';
	        if(record.duty=='0'){
        		s += ' <a class="Edit_Button"  href="javascript:chooseOne(13869);" >处理</a>';
        	}else if(record.duty=='1'){
        		s += ' <a class="Edit_Button"  href="javascript:chooseOne(13869);" >修改</a>';
        		s += ' <a class="Edit_Button"  href="javascript:chooseOne(13871);" >查看</a>';
        	}
            return s;
        }
        //根据罪犯编号跳转到病残鉴定表表单页面
        function chooseOne(menuid) {
        	...
        	if(row){
        		var url = "showidentificationOfDisabled.action?1=1&crimid="+row.crimid+"&menuid="+menuid;
