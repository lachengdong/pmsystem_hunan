             ...
             <tr>
                ...
                <td style="white-space:nowrap;"> 
                   <input id="status" name="status" class="mini-combobox" data="Statusdata" showNullItem="true" onvaluechanged="search"   valueFromSelect="false"
						        textField="text" valueField="id" showNullItem="true" nullItemText="--全部--"
						    	 style="width:150px;" enabled="true" emptyText="羁押状态..."/>
...
<!--              <div type="checkcolumn" width="30"></div>-->
    ...
    var Statusdata = [{ id: 1, text: '在押' }, { id: 2, text: '释放'}];
        ...
        function chooseOne(menuid) {
        	...
        	var url = "<%=path%>/toSentenceChangeListPage.page?1=1&tempid="+tempid+"&crimid="+row.crimid+"&menuid="+menuid;
