...
<body onload="init('10230')">
    <div class="mini-toolbar"  style="padding:0px;border-bottom: 0px;">
    	<jsp:include page="/WEB-INF/JSP/form/buttoncontrol.jsp"></jsp:include>
        <table >
             <tr>
                <td style="width:100%;">
                	<a style="dispaly:none;" id="11390" class="mini-button" iconCls="" plain="true" onclick="chooseAll('10230_01');">批量处理</a>
                </td>
                <td style="white-space:nowrap;"> 
                   <input id="status" name="status" class="mini-combobox" data="Statusdata" showNullItem="true" onvaluechanged="search"   valueFromSelect="false"textField="text" 
                          valueField="id" showNullItem="true" nullItemText="--全部--" style="width:150px;" enabled="true" emptyText="羁押状态..."/>
                   <input id="key" class="mini-textbox" vtype="maxLength:50;" emptyText="请输入罪犯编号、姓名、拼音" style="width:180px;" onenter="onKeyEnter"/>   
    ...
    <div class="mini-fit" id="div_two">
    	<div id="datagrid1" class="mini-datagrid" style="width:100%;height:100%;" allowResize="false" sizeList="[10,20,50,100]" pageSize="20"
        	 url="getoldResidualInformationCollectionChoose.action?1=1" idField="spid" multiSelect="true" allowAlternating="true" virtualScroll="false" >
    ...
    var Statusdata = [{ id: 1, text: '在押' }, { id: 2, text: '释放'}];
        ...
        function chooseOne(menuid) {
        	...
        	if(row){
        		var url = "oldResidualInformationCollection.action?1=1&crimid="+row.crimid+"&name="+row.name+"&menuid="+menuid;
