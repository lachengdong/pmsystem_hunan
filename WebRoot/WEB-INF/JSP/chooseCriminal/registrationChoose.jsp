...
<body onload="init('10207');">
    <div class="mini-toolbar"  style="padding:0px;border-bottom: 0px;">
    	<jsp:include page="/WEB-INF/JSP/form/buttoncontrol.jsp"></jsp:include>
        <table >
             <tr>
                <td style="width:100%;">
				        <a class="mini-button" style="display:none;" id="11385" iconCls="" plain="true" onclick="chooseAll('11385');">批量处理</a>
                </td>
    ...
    <div class="mini-fit" id="div_two">
        <div id="datagrid1" class="mini-datagrid" style="width:100%;height:100%;" allowResize="false" sizeList="[10,20,50,100]" pageSize="20"
        	 url="getregistrationChoose.action?1=1&tempid=XFZX_ZFTBSSJJKG" idField="spid" multiSelect="true" allowAlternating="true" virtualScroll="false" 
    ...
    <script type="text/javascript">
        ...
        function chooseOne(menuid) {
        	...
        	if(row){
        		var url = "registration.action?1=1&crimid="+row.crimid+"&name="+row.name+"&menuid="+menuid;
