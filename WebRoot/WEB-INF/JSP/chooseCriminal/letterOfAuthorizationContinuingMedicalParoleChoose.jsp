...
<body onload="init('10294');">
    ...
    <jsp:include page="/WEB-INF/JSP/form/buttoncontrol.jsp"></jsp:include>
        <table >
             <tr>
                 <td style="width:100%;">
				    <a class="mini-button" style="display:none;" id="11874" iconCls="" plain="true" onclick="chooseAll('10294_01')">批量处理</a> 
                </td>
    ...
    <script type="text/javascript">
       ...
       function onActionRenderer() {
        ...
        function chooseOne(menuid) {
        	...
        	var url = "letterOfAuthorizationContinuingMedicalParoleList.action?1=1&crimid="+row.crimid+"&menuid="+menuid+"&name="+row.name;
