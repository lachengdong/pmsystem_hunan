...
<body onload="init('10120');">
    ...
    <input id="tempid" name="tempid" class="mini-hidden" value="SDXF_ZFSF_JSGZS"/>   
        <table >
             <tr>
                <td style="width:100%;">
				   <a class="mini-button" style="display:none;" id="11601" iconCls="" plain="true" onclick="chooseAll(11600)">批量处理</a>
                </td>
    ...
    <div class="mini-fit" id="div_two">
        <div id="datagrid1" class="mini-datagrid" style="width:100%;height:100%;" allowResize="false" sizeList="[10,20,50,100]" pageSize="20"
        	 url="getParoleInforList.action?1=1&tempid=SDXF_ZFSF_JSGZS" idField="spid" multiSelect="true" allowAlternating="true" virtualScroll="false" 
    ...
    <script type="text/javascript">
        ...
        function onActionRenderer(e) {
	        ...
	        var s = '';
	        if(record.duty=='0'){
        		s += ' <a class="Edit_Button"  href="javascript:chooseOne(11600);" >处理</a>';
        	}else if(record.duty=='1'){
        		s += ' <a class="Edit_Button"  href="javascript:chooseOne(11600);" >修改</a>';
        		s += ' <a class="Edit_Button"  href="javascript:chooseOne(12523);" >查看</a>';
        	}
            return s;
        }
        function chooseOne(menuid) {
        	...
        	if(row){
        		var url = "paroleInform.action?1=1&crimid="+row.crimid+"&menuid="+menuid+"&tempid="+tempid;
         ...
         function chooseAll(menuid){
            ...
            if (rows.length > 0) {
                if (confirm("确定操作 选中记录？")) {
                    ...
                    var id = ids.join(',');
                    var url = "<%=path%>/paroleInform.action?1=1&id="+id+"&menuid="+menuid+"&tempid="+tempid;
                    self.location.href=url;
                }
            } else {
