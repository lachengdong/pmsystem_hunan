...
<body onload="init('10290');">
    ...
    <div class="mini-toolbar"  style="padding:0px;border-bottom: 0px;">
        ...
        <table >
             <tr>
                <td style="width:100%;">
                 <a class="mini-button" style="display:none;" id="11850" iconCls="" plain="true" onclick="chooseAll('10290_01')">批量处理</a> 
                </td>
    ...
    <div class="mini-fit" id="div_two">
        <div id="datagrid1" class="mini-datagrid" style="width:100%;height:100%;" allowResize="false" sizeList="[10,20,50,100]" pageSize="20"
        	 url="getJailProvincialChoose.action?1=1" idField="spid" multiSelect="true" allowAlternating="true" virtualScroll="false" 
    ...
    <script type="text/javascript">
        ...
        function chooseOne(menuid) {
        	...
        	var url = "toJailProvincial.action?1=1&crimid="+row.crimid+"&menuid="+menuid+"&name="+row.name;
