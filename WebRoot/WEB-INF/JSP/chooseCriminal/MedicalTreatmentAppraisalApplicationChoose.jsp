...
<body onload="init('13792')">
    <div class="mini-toolbar"  style="padding:0px;border-bottom: 0px;">
    <jsp:include page="/WEB-INF/JSP/form/buttoncontrol.jsp"></jsp:include>
    <input id="menuid" name="menuid" type="hidden" value="13792"/>      
        <table >
             <tr>
                <td style="width:100%;">
                <a class="mini-button"  id="13793" plain="true" onclick="chooseAll('13793');">批量处理</a>
                </td>
    ...
    <div class="mini-fit" id="div_two">
        <div id="datagrid1" class="mini-datagrid" style="width:100%;height:100%;" allowResize="false" sizeList="[10,20,50,100]" pageSize="20"
        	 url="getMedicalTreatmentAppraisalApplicationChooseList.action?1=1" idField="spid" multiSelect="true" allowAlternating="true" virtualScroll="false" 
    ...
    <script type="text/javascript">
       ...
       //根据审批状态显示按钮
	        ...
	        var record = e.record;
	        var s = '';
        	if((record.accent=='0')||(record.duty=='-1'&&record.accent=='2')){
        		s += ' <a class="Edit_Button"  href="javascript:chooseOne(\'13793\');" >处理</a>';
        	}else if(record.accent=='1'){
        		s += ' <a class="Edit_Button"  href="javascript:chooseOne(\'13793\');" >修改</a>';
        	}else if(record.accent=='2'){
        		s += ' <a class="Edit_Button"  href="javascript:chooseOne(\'13804\');" >查看</a>';
        	}
            return s;
        }
        function chooseOne(menuid) {
        	...
        	if(row){
        		var url = "showMedicalTreatmentAppraisalApplication.action?1=1&crimid="+row.crimid+"&menuid="+menuid+"&name="+row.name+"&orgid="+row.orgid1;
