...
<body onload="init(12354);">
    <div class="mini-toolbar"  style="padding:0px;border-bottom: 0px;">
	<jsp:include page="/WEB-INF/JSP/form/buttoncontrol.jsp"></jsp:include>
    <input id="tempid" name="tempid" class="mini-hidden" value="SH_GZJJFZSPB"/>
        <table >
             <tr>
                <td style="width:100%;">
				       <a class="mini-button" id="12357" style="display:none;" iconCls="" plain="true" onclick="chooseAll(12357);">批量处理</a>
                </td>
    ...
    <div class="mini-fit" id="div_two">
        <div id="datagrid1" class="mini-datagrid" style="width:100%;height:100%;" allowResize="false" sizeList="[10,20,50,100]" pageSize="20"
        	 url="getGZJJFZSPBList.action?1=1" idField="spid" multiSelect="true" allowAlternating="true" virtualScroll="false" 
    ...
    <script type="text/javascript">
        ...
        function chooseOne(menuid) {
        	...
        	var url = "GZJJFZSPB.action?1=1&crimid="+row.crimid+"&menuid="+menuid+"&name="+row.name+"&tempid="+tempid;
        ...
        function chooseAll(menuid){
            ...
            if (rows.length > 0) {
                if (confirm("确定操作 选中记录？")) {
                    ...
                    var id = ids.join(',');
                    var url = "GZJJFZSPB.action?1=1&id="+id+"&menuid="+menuid;
                    self.location.href=url;
                }
            } else {
                alert( "请至少选中一条记录！");
