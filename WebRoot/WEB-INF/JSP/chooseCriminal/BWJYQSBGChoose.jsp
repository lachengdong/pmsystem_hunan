...
<body onload="init('1000132');">
	
    <div class="mini-toolbar"  style="padding:0px;border-bottom: 0px;">
    
    <jsp:include page="/WEB-INF/JSP/form/buttoncontrol.jsp"></jsp:include>
    <input id="menuid" name="menuid" type="hidden" value="${menuid}"/>
    <input id="tempid" name="tempid" class="mini-hidden" value="BWJYQSBG"/>
    
        <table >
             <tr>
                <td style="width:100%;">
                 <a class="mini-button" style="display:none;" id="1000133" iconCls="" plain="true" onclick="chooseAll('1000134')">批量处理</a> 
                </td>
    ...
    <div class="mini-fit" id="div_two">
        <div id="datagrid1" class="mini-datagrid" style="width:100%;height:100%;" allowResize="false" sizeList="[10,20,50,100]" pageSize="20"
        	 url="getBWJYQSBGCriminalList.action?1=1" idField="spid" multiSelect="true" allowAlternating="true" virtualScroll="false" 
    ...
    <script type="text/javascript">
        ...
        function chooseOne(menuid) {
        	...
        	var url = "toBWJYQSBGDocList.action?1=1&tempid="+tempid+"&crimid="+row.crimid+"&menuid="+menuid+"&name="+row.name;
        ...
        //快速查询
        function search() {
        	grid.setUrl("getBWJYQSBGCriminalList.action?1=1");
