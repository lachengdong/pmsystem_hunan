...
<body onload="init('10152')">
    <div class="mini-toolbar"  style="padding:0px;border-bottom: 0px;">
    	<jsp:include page="/WEB-INF/JSP/form/buttoncontrol.jsp"></jsp:include>
        <table >
             <tr>
                <td style="width:100%;">
                	<a class="mini-button" style="display:none;" id="11234" iconCls="" plain="true" onclick="chooseAll('11236')">批量处理</a>
                </td>
    ...
    <div class="mini-fit" id="div_two">
        <div id="datagrid1" class="mini-datagrid" style="width:100%;height:100%;" allowResize="false" sizeList="[10,20,50,100]" pageSize="20"
        	 url="getprimaryHealthPanelList.action?1=1" idField="spid" multiSelect="true" allowAlternating="true" virtualScroll="false" 
    ...
    <script type="text/javascript">
       ...
       //如果idnumber存在表示已经处理,duty=-1表示审批未通过,显示处理。
         ...
         function onActionRenderer(e) {
        	...
        	if(record.idnumber && record.duty != '-1' ){
        		if(record.duty=='0' || record.accent=='1'){
        			s += ' <a class="Edit_Button"  href="javascript:chooseOne(11236);" >修改</a>';
        		}else {
        			s += ' <a class="Edit_Button"  href="javascript:chooseOne(11242);" >查看</a>';
        		}
        	}else{
        		s += ' <a class="Edit_Button"  href="javascript:chooseOne(11236);" >处理</a>';
        	} 
            return s;
        }
        ...
        function chooseOne(menuid) {
        	...
        	if(row){
        		var url = "disposePrimaryHealthPanel.action?1=1&crimid="+row.crimid+"&menuid="+menuid;
