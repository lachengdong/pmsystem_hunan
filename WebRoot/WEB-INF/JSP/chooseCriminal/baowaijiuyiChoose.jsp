...
<body onload="init('${menuid }')">
    ...
    <input id="menuid" name="menuid" type="hidden" value="12187"/>
        <table >
             <tr>
                <td style="width:100%;">
                <a class="mini-button"  id="10933" plain="true" onclick="chooseAll(12188);">批量处理</a>
                </td>
    ...
    <div class="mini-fit" id="div_two">
        <div id="datagrid1" class="mini-datagrid" style="width:100%;height:100%;" allowResize="false" sizeList="[10,20,50,100]" pageSize="20"
        	 url="getBaowaijiuyiChooseList.action?1=1" idField="spid" multiSelect="true" allowAlternating="true" virtualScroll="false" 
    ...
    <script type="text/javascript">
       ...
       function onActionRenderer(e) {
	        ...
	        var s = '';
        	if(record.accent=='0'){
        		s += ' <a class="Edit_Button"  href="javascript:chooseOne(\'12188\');" >处理</a>';
        	}else if(record.accent=='1'){
        		s += ' <a class="Edit_Button"  href="javascript:chooseOne(\'12188\');" >修改</a>';
        	}else if(record.accent=='2'){
        		s += ' <a class="Edit_Button"  href="javascript:chooseOne(\'12199\');" >查看</a>';
        	}
            return s;
        }
        ...
        function chooseOne(menuid) {
        	...
        	if(row){
        		var url = "showBaowaijiuyi.action?1=1&crimid="+row.crimid+"&menuid="+menuid+"&name="+row.name+"&orgid="+row.orgid1;
