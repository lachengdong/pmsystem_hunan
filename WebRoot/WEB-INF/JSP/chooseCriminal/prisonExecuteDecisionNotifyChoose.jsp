...
<body onload="init('10158');">
    <div class="mini-toolbar"  style="padding:0px;border-bottom: 0px;">
    	<jsp:include page="/WEB-INF/JSP/form/buttoncontrol.jsp"></jsp:include>
        <table >
             <tr>
                 <td style="width:100%;">
				    <a class="mini-button" style="display:none;" id="12702" iconCls="" plain="true" onclick="chooseAll('12045')">批量处理</a>
                 </td>
                 <td style="white-space:nowrap;"> 
                   ...
                   <a class="mini-button" plain="true" iconCls="icon-help" onclick="chakanshuoming('10158')"></a>
                 </td>
             </tr>
        </table>
    </div>
    <div class="mini-fit" id="div_two">
        <div id="datagrid1" class="mini-datagrid" style="width:100%;height:100%;" allowResize="false" sizeList="[10,20,50,100]" pageSize="20"
        	 url="getprisonExecuteDecisionNotifyChoose.action?1=1" idField="spid" multiSelect="true" allowAlternating="true" virtualScroll="false" 
    ...
    <script type="text/javascript">
        ...
        function onActionRenderer(e) {
	        ...
	        var s = '';
	        if(record.duty=='0'){
        		s += ' <a class="Edit_Button"  href="javascript:chooseOne(12045);" >处理</a>';
        	}else if(record.duty=='1'){
        		s += ' <a class="Edit_Button"  href="javascript:chooseOne(12045);" >修改</a>';
        		s += ' <a class="Edit_Button"  href="javascript:chooseOne(12701);" >查看</a>';
        	}
            return s;
        }
      function chooseOne(menuid) {
        	...
        	if(row){
        		...
        		var url = "prisonExecuteDecisionNotify.action?1=1&crimid="+row.crimid+"&menuid="+menuid;
	    	...
	    	var rows = grid.getSelecteds();
	   		if (rows.length > 0) {
	                if (confirm("确定批量处理选中记录？")) {
	                    ...
	                    var id = ids.join(',');
	                   	var url = "prisonExecuteDecisionNotify.action?1=1&id="+id+"&menuid="+menuid;
