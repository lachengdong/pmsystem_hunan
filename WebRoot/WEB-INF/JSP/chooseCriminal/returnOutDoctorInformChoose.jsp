...
<body onload="init('10287')">
    <div class="mini-toolbar"  style="padding:0px;border-bottom: 0px;">
     	<jsp:include page="/WEB-INF/JSP/form/buttoncontrol.jsp"></jsp:include>
        <table >
             <tr>
                <td style="width:100%;">
                	<a class="mini-button" style="display:none;" id="12804" onclick="chooseAll('10287_01');" plain="true" iconCls="" >批量处理</a>
                </td>
    ...
    <div class="mini-fit" id="div_two">
        <div id="datagrid1" class="mini-datagrid" style="width:100%;height:100%;" allowResize="false" sizeList="[10,20,50,100]" pageSize="20"
        	 url="getReturnOutDoctorList.action?1=1&tempid=SZ_BWJY_TZSHZ" idField="spid" multiSelect="true" allowAlternating="true" virtualScroll="false" 
    ...
    <script type="text/javascript">
       ...
       function onActionRenderer(e) {
	        ...
	        var s = '';
	        if(record.duty=='0'){
        		s += ' <a class="Edit_Button"  href="javascript:chooseOne(\'10287_01\');" >处理</a>';
        	}else if(record.duty=='1'){
        		s += ' <a class="Edit_Button"  href="javascript:chooseOne(\'10287_01\');" >修改</a>';
        		s += ' <a class="Edit_Button"  href="javascript:chooseOne(12805);" >查看</a>';
        	}
            return s;
        }
        function chooseOne(menuid){
          	...
          	if (row) {
         	   	...
         	   	var url = "returnOutDoctorInform.action?1=1&crimid="+row.crimid+"&menuid="+menuid;
	   		...
	   		if (rows.length > 0) {
                if (confirm("确定批量处理选中记录？")) {
                    ...
                    grid.loading("操作中，请稍后......");
                   	var url = "returnOutDoctorInform.action?1=1&id="+id+"&menuid="+menuid;
					window.location.href=url;
                }
            } else {
