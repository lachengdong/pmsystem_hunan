...
<body onload="init('10284');">
   <div class="mini-toolbar"  style="padding:0px;border-bottom: 0px;">
     <jsp:include page="/WEB-INF/JSP/form/buttoncontrol.jsp"></jsp:include>
        <table >
             <tr>
                 <td style="width:100%;">
				       <a class="mini-button" style="display:none;" id="12797" iconCls="" plain="true" onclick="chooseAll('10284_01')">批量处理</a>
				  </td>
    ...
    <script type="text/javascript">
        ...
        grid.setUrl("getMedicalParoleNoticeToCourtBasicInfoList.action?1=1");
	 ...
	 function onActionRenderer(e) {
	        ...
	        var s = '';
	        if(record.duty=='0'){
        		s += ' <a class="Edit_Button"  href="javascript:chooseOne(\'10284_01\');" >处理</a>';
        	}else if(record.duty=='1'){
        		s += ' <a class="Edit_Button"  href="javascript:chooseOne(\'10284_01\');" >修改</a>';
        		s += ' <a class="Edit_Button"  href="javascript:chooseOne(12799);" >查看</a>';
        	}
            return s;
        }
        ...
        function chooseOne(menuid) {
        	var tempid="SZ_BWJY_TZSBJCS";
        	var row = grid.getSelected();
        	var url = "medicalParoleNoticeToCourtAdd.action?1=1&tempid="+tempid+"&crimid="+row.crimid+"&menuid="+menuid+"&systempid=${systempid}";
