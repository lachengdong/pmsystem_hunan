...
<body onload="init('10221')">
    <div class="mini-toolbar"  style="padding:0px;border-bottom: 0px;">
    	<jsp:include page="/WEB-INF/JSP/form/buttoncontrol.jsp"></jsp:include>
        <table >
             <tr>
                <td style="width:100%;">
                <a class="mini-button" style="display:none;" id="11520" plain="true" onclick="chooseAll(11521);">批量处理</a>
                </td>
    ...
    <div class="mini-fit" id="div_two">
        <div id="datagrid1" class="mini-datagrid" style="width:100%;height:100%;" allowResize="false" sizeList="[10,20,50,100]" pageSize="20"
        	 url="getLeaveAoticeChooseList.action?1=1" idField="spid" multiSelect="true" allowAlternating="true" virtualScroll="false" 
    ...
    <script type="text/javascript">
         ...
         function onActionRenderer(e) {
        	...
        	if(record.idnumber && record.duty != '-1' ){
        		if(record.duty=='0' || record.accent=='1'){
        			s += ' <a class="Edit_Button"  href="javascript:chooseOne(11521);" >修改</a>';
        		}else {
        			s += ' <a class="Edit_Button"  href="javascript:chooseOne(11522);" >查看</a>';
        		}
        	}else{
        		s += ' <a class="Edit_Button"  href="javascript:chooseOne(11521);" >处理</a>';
        	} 
            return s;
        }	
        ...
        function chooseOne(menuid) {
        	...
        	if(row){
        		var url = "showLeaveAotice.action?1=1&crimid="+row.crimid+"&menuid="+menuid;
