...
<body onload="init('10175');">
    <div class="mini-toolbar"  style="padding:0px;border-bottom: 0px;">
     <jsp:include page="/WEB-INF/JSP/form/buttoncontrol.jsp"></jsp:include>
        <table >
             <tr>
                <td style="width:100%;">
                	<a class="mini-button" iconCls=""  plain="true" onclick="chooseAll('10175_03_01');">批量处理</a>
                </td>
                <td style="white-space:nowrap;"> 
                   ...
                   <a class="mini-button" plain="true" iconCls="icon-help" onclick="chakanshuoming('10175')"></a>
                 </td>
             </tr>
        </table>
    </div>
    ...
    <script type="text/javascript">
        ...
        function chooseOne(menuid) {
        	...
        	if(row){
        		var url = "notLifeDiagnoseBook.action?1=1&crimid="+row.crimid+"&menuid="+menuid+"&name="+row.name;
