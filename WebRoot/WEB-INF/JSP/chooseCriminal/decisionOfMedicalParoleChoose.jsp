...
<body onload="init('12284')">
    <div class="mini-toolbar"  style="padding:0px;border-bottom: 0px;">
    	<jsp:include page="/WEB-INF/JSP/form/buttoncontrol.jsp"></jsp:include>
        <table >
             <tr>
                <td style="width:100%;">
                	<a class="mini-button" style="display:none;" id="12882" plain="true" onclick="chooseAll(12285);">批量处理</a>
                </td>
    ...
    <div class="mini-fit" id="div_two">
        <div id="datagrid1" class="mini-datagrid" style="width:100%;height:100%;" allowResize="false" sizeList="[10,20,50,100]" pageSize="20"
        	 url="getdecisionOfMedicalParoleChooseList.action?1=1&tempid=TJBWJYJDS" idField="spid" multiSelect="true" allowAlternating="true" virtualScroll="false" 
    ...
    <script type="text/javascript">
       ...
       //按钮显示
        function onActionRenderer(e) {
	        ...
	        var s = '';
	        if(record.duty=='0'){
        		s += ' <a class="Edit_Button"  href="javascript:chooseOne(12285);" >处理</a>';
        	}else if(record.duty=='1'){
        		s += ' <a class="Edit_Button"  href="javascript:chooseOne(12285);" >修改</a>';
        		s += ' <a class="Edit_Button"  href="javascript:chooseOne(12883);" >查看</a>';
        	}
            return s;
        }
        //根据罪犯编号跳转到保外就医决定书（天津）表单页面
        function chooseOne(menuid) {
        	var row = grid.getSelected();
        	var url = "showdecisionOfMedicalParole.action?1=1&crimid="+row.crimid+"&menuid="+menuid+"&name="+row.name;
        ...
        function chooseAll(menuid){
            ...
            if (rows.length > 0) {
                if (confirm("确定操作 选中记录？")) {
                    ...
                    var id = ids.join(',');
                    var url = "showdecisionOfMedicalParole.action?1=1&id="+id+"&menuid="+menuid;
                    self.location.href=url;
                }
            } else {
                alert( "请至少选中一条记录！");
