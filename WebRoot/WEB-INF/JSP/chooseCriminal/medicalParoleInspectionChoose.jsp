...
<body onload="init('${menuid}')">
    ...
    <input id="tempid" name="tempid" class="mini-hidden" value="BWJY_JYTQZYJWZXKC"/>
    <jsp:include page="/WEB-INF/JSP/form/buttoncontrol.jsp"></jsp:include>
        <table >
             <tr>
                <td style="width:100%;">
                	<!--  <a class="mini-button" style="display:none;" id="11508" iconCls="icon-user" plain="true" onclick="">批量处理</a>-->
                </td>
    ...
    <script type="text/javascript">
        ...
        grid.setUrl("getMedicalParoleInspectionBasicInfoList.action?1=1&tempid=BWJY_JYTQZYJWZXKC");
        ...
        function chooseOne(menuid) {
        	...
        	var url = "medicalParoleInspectionList.action?1=1&tempid="+tempid+"&crimid="+row.crimid+"&name="+row.name+"&menuid="+menuid;
        ...
        //快速查询
        function search() {
        	grid.setUrl("getMedicalParoleInspectionBasicInfoList.action?1=1");
