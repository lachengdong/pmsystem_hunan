...
<body onload="init('10293');">
    <div class="mini-toolbar"  style="padding:0px;border-bottom: 0px;">
    	<jsp:include page="/WEB-INF/JSP/form/buttoncontrol.jsp"></jsp:include>
        <table >
             <tr>
                 <td style="width:100%;">
				       <a class="mini-button" style="display:none;" id="11861" iconCls="" plain="true" onclick="chooseAll('10293_01')">批量处理</a>
                </td>
    ...
    <div class="mini-fit" id="div_two">
        <div id="datagrid1" class="mini-datagrid" style="width:100%;height:100%;" allowResize="false" sizeList="[10,20,50,100]" pageSize="20"
        	 url="getLetterOfAuthorizationFirstMedicalParoleBasicInfoList.action?1=1" idField="spid" multiSelect="true" allowAlternating="true" virtualScroll="false" 
    ...
    <script type="text/javascript">
        ...
        //根据罪犯编号跳转到首次保外就医委托函表单页面
        function chooseOne(menuid) {
        	var row = grid.getSelected();
        	var docid = mini.get("docid").getValue();
        	var url = "letterOfAuthorizationFirstMedicalParoleList.action?1=1&crimid="+row.crimid+"&menuid="+menuid+"&name="+row.name;
