...
<body onload="init('${menuid}');">
	...
	<div size="38px;" showCollapseButton="false">
		<div class="mini-toolbar" style="height:30px;">
			...
			<td style="width:100%;">
	    		...
	    		<a class="mini-button"  style="display:none;" id="12034" style="display:none;" iconCls="icon-save" plain="true" onclick="savedata();">存盘</a>
	    		<a class="mini-button"  style="display:none;" id="12703" iconCls="icon-download" plain="true" onclick="saveNext();">下一个</a>
    ...
    <script type="text/javascript">
        ...
        function savedata() {
       		...
       		var url="saveRegistrationOfMedicalParole.action?1=1";
        	if(!docid){//新增
	            $.ajax({
     ...
     //手动关闭
     function onCancel(){  
         url = "toRegistrationOfMedicalParoleChoosePage.action?1=1";
         self.location.href=url;          
     }
    </script>
</body>
