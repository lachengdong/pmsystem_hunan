...
<body onload="init('${menuid}');">
	...
	<div size="38px;" showCollapseButton="false">
		...
		<td style="width:100%;">
	    	...
	    	<a class="mini-button" style="display:none;" id="12037" iconCls="icon-save" plain="true" onclick="savedate();">存盘</a>
	    	 <a class="mini-button" style="display:none;" id="12764" iconCls="icon-download" plain="true" onclick="saveNext();">下一个</a> 
    ...
    <script type="text/javascript">
      ...
      //保存或更新
        function savedate() {
       		...
       		var url="saveOtherProvincesForTransfer.action?1=1";
        	if(!docid){//新增
	            $.ajax({
	                url:encodeURI(encodeURI(url)),
	                data: {content:content,id:id,crimid:crimid,tempid:tempid},
	                type: "post",
	            ...
	            $.ajax({
	                url: encodeURI(encodeURI(url)),
	                data: {content:content,id:id,crimid:crimid,docid:docid},
	                type: "post",
	                success: function (text) {
	                	alert("操作成功!");
	                  	close();
        ...
        //关闭
        function close(){
        	url = "toOtherProvincesForTransfer.action?1=1";
        	self.location.href=url;
        }
    </script>
</body>
