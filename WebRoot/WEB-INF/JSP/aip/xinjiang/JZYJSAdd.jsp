...
<head>
    <title>罪犯暂予监外执行社区矫正意见书表单页面</title>
...
<body onload="init('${menuid}');">
	...
	<div size="38px;" showCollapseButton="false">
		...
		<td style="width:100%;">
			...
			<a class="mini-button"  iconCls="icon-save" plain="true" style="display:none;" id="1000103" onclick="savedata();">存盘</a>
	    	<a class="mini-button"  iconCls="icon-save" plain="true" style="display:none;" id="1000104" onclick="savedata();">存盘</a>		
