...
<body onload="init('${menuid}');">
	...
	<div size="38px;" showCollapseButton="false">
		...
		<td style="width:100%;">
			...
			<a class="mini-button"  iconCls="icon-save" plain="true" style="display:none;" id="1000093" onclick="savedata();">存盘</a>
	    	<a class="mini-button"  iconCls="icon-save" plain="true" style="display:none;" id="1000094" onclick="savedata();">存盘</a>		
    ...
    <script type="text/javascript">
      ...
      //保存或更新
        function savedata() {
       		...
       		var url="saveJWZXZMS.action?1=1";
       		var temp;
        	if(docid){
        	temp = "edit";
        	}else{
