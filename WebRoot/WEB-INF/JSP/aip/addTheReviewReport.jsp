...
<body onload="init('${menuid}');">
	...
	<div size="38px;" showCollapseButton="false">
		...
		<td style="width:100%;">
	    	...
	    	<a class="mini-button"  iconCls="icon-save" plain="true" style="display:none;"  id="12655" onclick="savedata();">存盘</a>
	    	<a class="mini-button"  iconCls="icon-save" plain="true" style="display:none;"  id="12659" onclick="savedata();">存盘</a>		
    ...
    function savedata() {
   		...
   		var url="saveTheReviewReport.action?1=1";
      	if(!docid){//新增
           $.ajax({
