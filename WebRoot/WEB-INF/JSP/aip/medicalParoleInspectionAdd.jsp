...
<body onload="init('${menuid}')">
	...
	<div size="38px;" showCollapseButton="false">
		...
		<td style="width:100%;">
	    	...
	    	<a class="mini-button" style="display:none;" id="11339" iconCls="icon-save" plain="true" onclick="savedata()">存盘</a>
	    	<a class="mini-button" style="display:none;" id="11509" iconCls="icon-save" plain="true" onclick="savedata()">存盘</a>
    ...
    <script type="text/javascript">
        ...
        function savedata() {
       		...
       		var url="saveMedicalParoleInspection.action?1=1";
        	if(operator == "new"){//新增
	            $.ajax({
