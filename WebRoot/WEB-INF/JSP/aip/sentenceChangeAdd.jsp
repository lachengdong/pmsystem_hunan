...
<body onload="init('${menuid}');">
	...
	<div size="38px;" showCollapseButton="false">
		...
		<td style="width:100%;">
	    	...
	    	<a class="mini-button"  iconCls="icon-save" style="display:none;" id="12074" plain="true" onclick="savedata();">存盘</a>
	    	<span class="separator"></span> 
    ...
    <script type="text/javascript">
        ...
        function savedata() {
       		...
       		var url="saveSentenceChange.action?1=1";
        	if(operator == "new"){//新增
	            $.ajax({
	                url:encodeURI(encodeURI(url)),
	                data: {content:content,noteinfo:mini.encode(noteinfo),tempid:tempid,operator:operator,crimid:crimid,menuid:menuid},
	                type: "post",
            ...
            if(operator == "edit"){//更新
	            $.ajax({
	                url: "saveSentenceChange.action?1=1",
