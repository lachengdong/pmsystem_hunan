...
<body onload="init('${menuid}');">
	...
	<div size="38px;" showCollapseButton="false">
		...
		<td style="width:100%;">
			...
			<a class="mini-button" style="display:none;" id="1000166" iconCls="icon-save" plain="true" onclick="doSubmitFlow('1000166','save','other_jqzbanry','JQZRY');">存盘</a>
	    	<a class="mini-button" style="display:none;" id="1000167" iconCls="icon-downgrade" plain="true" onclick="doSubmitFlow('1000167','yes','other_jqzbanry','JQZRY');">提交</a>
			<a class="mini-button" style="display:none;" id="1000168" iconCls="icon-save" plain="true" onclick="doSubmitFlow('1000168','save','other_jqzbanry','JQZRY');">存盘</a>
	    	<a class="mini-button" style="display:none;" id="1000169" iconCls="icon-downgrade" plain="true" onclick="doSubmitFlow('1000169','yes','other_jqzbanry','JQZRY');">提交</a>
			<a class="mini-button" style="display:none;" id="1000170" iconCls="icon-downgrade" plain="true" onclick="operationOpprove('1000170','yes');">同意</a>
	    	<a class="mini-button" style="display:none;" id="1000171" iconCls="icon-upgrade" plain="true" onclick="submit();">拒绝</a>
