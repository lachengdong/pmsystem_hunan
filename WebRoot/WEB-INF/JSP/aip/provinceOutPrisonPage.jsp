...
<div  id="form1" class="mini-splitter"  vertical="true" style="width:100%;height:100%;border:0px;">
	<div size="38px;" showCollapseButton="false">
		...
		<td style="width:100%;">
			...
			<!-- 处室经办  -->
			<a class="mini-button" style="display:none;" id="11468"  iconCls="icon-save" plain="true" onclick="doSubmitFlow('11468','save','other_sjbwjysp','${tempid}');">存盘</a>
			<a class="mini-button" style="display:none;" id="11469"  iconCls="icon-downgrade" plain="true" onclick="doSubmitFlow('11469','yes','other_sjbwjysp','${tempid}');">提交</a>
			
			<a class="mini-button" style="display:none;" id="11479"  iconCls="icon-save" plain="true" onclick="doSubmitFlow('11479','save','other_sjbwjysp','${tempid}');">存盘</a>
	
			<!-- 处室审核 -->
			<a class="mini-button" style="display:none;" id="11475"  iconCls="icon-upgrade" plain="true" onclick="doApproveFlow('11475','no','other_sjbwjysp','${tempid}');">拒绝</a>
			<a class="mini-button" style="display:none;" id="11476"  iconCls="icon-undo" plain="true" onclick="doApproveFlow('11476','back','other_sjbwjysp','${tempid}');">退回</a>
			<a class="mini-button" style="display:none;" id="11474"  iconCls="icon-downgrade" plain="true" onclick="doApproveFlow('11474','yes','other_sjbwjysp','${tempid}');">同意</a>
			
			<!-- 省局评审（广东） -->
			<a class="mini-button" style="display:none;" id="15880"  iconCls="icon-upgrade" plain="true" onclick="doApproveFlow('15880','no','other_sjbwjysp','${tempid}');">拒绝</a>
			<a class="mini-button" style="display:none;" id="15881"  iconCls="icon-undo" plain="true" onclick="doApproveFlow('15881','back','other_sjbwjysp','${tempid}');">退回</a>
			<a class="mini-button" style="display:none;" id="15879"  iconCls="icon-downgrade" plain="true" onclick="doApproveFlow('15879','yes','other_sjbwjysp','${tempid}');">同意</a>
			<!-- 局长审批 -->
			<a class="mini-button" style="display:none;" id="11481"  iconCls="icon-upgrade" plain="true" onclick="doApproveFlow('11481','no','other_sjbwjysp','${tempid}');">拒绝</a>
			<a class="mini-button" style="display:none;" id="11482"  iconCls="icon-undo" plain="true" onclick="doApproveFlow('11482','back','other_sjbwjysp','${tempid}');">退回</a>
			<a class="mini-button" style="display:none;" id="11480"  iconCls="icon-downgrade" plain="true" onclick="doApproveFlow('11480','yes','other_sjbwjysp','${tempid}');">同意</a>
			
			<a class="mini-button" id="xyg" iconCls="icon-download" plain="true" onclick="saveNext();">下一个</a>
			<a class="mini-button"  id="gb" iconCls="icon-close" plain="true" onclick="Close(${closetype});">关闭</a>
