...
<body  onload="init('${menuid}');">
	...
	<div size="38px;" showCollapseButton="false">
		...
		<td style="width:100%;">
	    	...
	    	<a class="mini-button"  style="display:none;" id="11231" style="display:none;" iconCls="icon-save" plain="true" onclick="savedata();">存盘</a>
	    	<a class="mini-button"  style="display:none;" id="11233" iconCls="icon-download" plain="true" onclick="saveNext();">下一个</a>
    ...
    <script type="text/javascript">
        ...
        function savedata() {
       		...
       		var url="savePrisonExecuteDecisionNotify.action?1=1";
        	if(!docid){//新增
	            $.ajax({
            ...
            if(docid){//更新
	            $.ajax({
	                url: "savePrisonExecuteDecisionNotify.action?1=1",
	                data: {content:content,docid:docid,noteinfo:noteinfo},
	                type: "post",
	                success: function (text) {
	                	alert("操作成功!");
	                  	saveNext();
     ...
     //手动关闭
     function onCancel(){  
         url = "prisonExecuteDecisionNotifyChoose.action?1=1";
         self.location.href=url;          
     }
    </script>
</body>
