...
<body onload="init('${menuid}');">
	...
	<div size="38px;" showCollapseButton="false">
		...
		<td style="width:100%;">
	    	...
	    	<a class="mini-button" style="display:none;" id="11660" iconCls="icon-save" plain="true" onclick="savedata();">存盘</a>
	    	<a class="mini-button" style="display:none;" id="11664" iconCls="icon-save" plain="true" onclick="savedata();">存盘</a>
    ...
    <script type="text/javascript">
      ...
      //保存或更新
        function savedata() {
       		...
       		var url = "<%=path%>/ProvincialBureauLetter/saveprovincialBureauLetter.json?1=1";
        	if(!docid){//新增
	            $.ajax({
	            ...
	            $.ajax({
	                url: encodeURI(encodeURI(url)),
	                data: {content:content,docid:docid,noteinfo:noteinfo,crimid:crimid},
	                type: "post",
	                success: function (text) {
	                	alert("操作成功!");
	                	back();
