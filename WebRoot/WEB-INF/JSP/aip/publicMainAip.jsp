...
<div  id="form1" class="mini-splitter"  vertical="true" style="width:100%;height:100%;border:0px;">
	<div size="38px;" showCollapseButton="false">
		...
		<td style="width:100%;">
	    	...
	    	<a class="mini-button" id="savedate" iconCls="icon-save" plain="true" onclick="save();">存盘</a>
	    	<a class="mini-button"  id="204" iconCls="icon-downgrade" plain="true" onclick="submit();">提交</a>	    	
	    	<a class="mini-button"  id="202" iconCls="icon-undo" plain="true" onclick="submit();">退回</a>
	    	<a class="mini-button"  id="203" iconCls="icon-upgrade" plain="true" onclick="submit();">拒绝</a>
	    	<span class="separator"></span> 
	    	<a class="mini-button" style="display:none;" id="11277" iconCls="icon-download" plain="true" onclick="saveNext();">下一个</a>
	    	<a class="mini-button"  id="206" iconCls="icon-close" plain="true" onclick="close();">关闭</a>
	    	<span class="separator"></span> 
	...
	<script LANGUAGE="javascript" FOR="HWPostil1" EVENT="NotifyDocOpened"></script>
