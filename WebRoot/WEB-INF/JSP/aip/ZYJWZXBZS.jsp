...
<body  onload="init('${menuid}');">
	...
	<div size="38px;" showCollapseButton="false">
		...
		<td style="width:100%;">
	    	...
	    	<a class="mini-button" style="display:none;" id="11803" iconCls="icon-save" plain="true" onclick="savedata();">存盘</a>
	    	<a class="mini-button" style="display:none;" id="11804" iconCls="icon-save" plain="true" onclick="savedata();">存盘</a>
    ...
    <script type="text/javascript">
        ...
        function savedata() {
       		...
       		var url="saveTemporaryExecutionOutsidePrisonGuarantee.action?1=1";
        	if(operator == "new"){//新增
	            $.ajax({
            ...
            if(operator == "edit"){//更新
	            $.ajax({
	                url: "saveTemporaryExecutionOutsidePrisonGuarantee.action?1=1",
