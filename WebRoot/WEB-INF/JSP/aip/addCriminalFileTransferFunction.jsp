...
<body onload="init('${menuid }')">
	...
	<div size="38px;" showCollapseButton="false">
		...
		<td style="width:100%;">
	    	...
	    	<a class="mini-button" id="12720"  style="display:none;" iconCls="icon-save" plain="true" onclick="savedata();">存盘</a>
	    	<a class="mini-button" id="12721"   style="display:none;" iconCls="icon-save" plain="true" onclick="savedata();">存盘</a>
    ...
    <script type="text/javascript">
        ...
        function savedata() {
       		...
       		var url="saveCriminalFileTransferFunction.action?1=1";
        	if(operator == "new"){//新增
	            $.ajax({
            ...
            if(operator == "edit"){//更新
	            $.ajax({
	                url: "saveCriminalFileTransferFunction.action?1=1",
