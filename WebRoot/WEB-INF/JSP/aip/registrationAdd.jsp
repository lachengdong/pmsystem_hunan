...
<body  onload="init('${menuid}');">
	...
	<div size="38px;" showCollapseButton="false">
		...
		<td style="width:100%;">
	    	...
	    	<a class="mini-button" style="display:none;" id="10207_04" iconCls="icon-save" plain="true" onclick="doSubmitFlow('10207_04','save','doc_zfskjtsp','XFZX_ZFTBSSJJKG');">存盘</a>
	    	<a class="mini-button" style="display:none;" id="11400" iconCls="icon-save" plain="true" onclick="doSubmitFlow('11400','save','doc_zfskjtsp','XFZX_ZFTBSSJJKG');">存盘</a>
	    	<a class="mini-button" style="display:none;" id="12543" iconCls="icon-downgrade" plain="true" onclick="doSubmitFlow('11228','yes','doc_zfskjtsp','XFZX_ZFTBSSJJKG');">提交</a>
	    	<a class="mini-button" style="display:none;" id="11228" iconCls="icon-downgrade" plain="true" onclick="doSubmitFlow('11228','yes','doc_zfskjtsp','XFZX_ZFTBSSJJKG');">提交</a>
	    	...
	    	<a class="mini-button" style="display:none;" id="1000181" iconCls="icon-downgrade" plain="true" onclick="operationOpprove('1000181','yes');">同意</a>
	    	<a class="mini-button" style="display:none;" id="1000182" iconCls="icon-upgrade" plain="true" onclick="operationOpprove('1000182','no');">拒绝</a>
