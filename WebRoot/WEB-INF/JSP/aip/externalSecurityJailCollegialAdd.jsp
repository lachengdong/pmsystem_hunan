...
<body onload="init('${menuid}')" >
	...
	<div size="38px;" showCollapseButton="false">
		...
		<td style="width:100%;">
	    	...
	    	<a class="mini-button"  style="display:none;" id="11272" iconCls="icon-save" plain="true" onclick="doSubmitFlow('11272','save','doc_bwsjhysp','SJ_BWJY_CJHYDJB');;">存盘</a>
	    	<a class="mini-button"  style="display:none;" id="11273" iconCls="icon-downgrade" plain="true" onclick="doSubmitFlow('11273','yes','doc_bwsjhysp','SJ_BWJY_CJHYDJB');">提交</a>
	    	<a class="mini-button"  style="display:none;" id="12038" iconCls="icon-downgrade" plain="true" onclick="operationOpprove('12038','yes');">同意</a>
	    	<a class="mini-button"  style="display:none;" id="12039" iconCls="icon-upgrade" plain="true" onclick="operationOpprove('12039','no');">拒绝</a>
	    	<a class="mini-button"  style="display:none;" id="12791" iconCls="icon-download" plain="true" onclick="saveNext();">下一个</a>
    ...
    <script type="text/javascript">
       ...
       function saveNext(){
            ...
            var url = "externalSecurityJailCollegialAdd.action?1=1&id="+id+"&menuid="+menuid;
            if(index>0){
        ...
        //跳转到选择罪犯页面
        function onCanle(){
        	var url = "externalSecurityJailCollegial.action?1=1";
			self.location.href=url;
        }
    </script>
</body>
