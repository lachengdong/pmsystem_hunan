...
<body onload="init('${menuid}');">
	...
	<div size="38px;" showCollapseButton="false">
		...
		<td style="width:100%;">
	    	...
	    	<a class="mini-button" style="display:none;" id="13859" iconCls="icon-save" plain="true" onclick="savedata();">存盘</a>
			<a class="mini-button" style="display:none;" id="13860" iconCls="icon-download" plain="true" onclick="saveNext();">下一个</a>
  ...
  <script type="text/javascript">
      ...
      function savedata() {
   		...
   		var url = "<%=path%>/letterDcpg/saveLetterOfAuthorizationDcpg.json?1=1";
      	if(!docid){//新增
           $.ajax({
     ...
     //返回到罪犯处理页面
     function onCancel(){  
       url = "<%=path%>/letterDcpg/letterOfAuthorizationDcpg.page?1=1";
       self.location.href=url;          
     }
    </script>
</body>
