...
<body onload="init('${menuid}')">
	...
	<div size="38px;" showCollapseButton="false">
		...
		<a class="mini-button" style="display:none;" id="11361" iconCls="icon-save" plain="true" onclick="doSubmitFlow('11361','save','doc_zfsfzmsp','XFZX_SFZMS');">存盘</a>
		<a class="mini-button" style="display:none;" id="11362" iconCls="icon-downgrade" plain="true" onclick="doSubmitFlow('11362','yes','doc_zfsfzmsp','XFZX_SFZMS');">提交</a>
		<a class="mini-button" style="display:none;" id="11363" iconCls="icon-downgrade" plain="true" onclick="operationOpprove('11363','yes','');">同意</a>
		<a class="mini-button" style="display:none;" id="11364" iconCls="icon-upgrade" plain="true" onclick="operationOpprove('11364','no','');">拒绝</a>
		<a class="mini-button" style="display:none;" id="11525" iconCls="icon-download" plain="true" onclick="saveNext();">下一个</a>
    ...
    <script type="text/javascript">
       ...
       function saveNext (){
            ...
            if(index>0){
            	...
            	var url= "disposeReleaseCertificate.action?1=1&id="+id+"&menuid=${menuid}&flowdefid="+flowdefid;
        ...
        //手动关闭
        function close(){
        	var url = "releaseCertificate.action?1=1&flowdefid="+flowdefid;
			self.location.href=url;
        }
    </script>
</body>
