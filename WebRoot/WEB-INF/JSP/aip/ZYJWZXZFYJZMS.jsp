...
<body onload="init('${menuid}');">
	...
	<div size="38px;" showCollapseButton="false">
		...
		<td style="width:100%;">
	    	...
	    	<a class="mini-button" style="display:none;" id="11823" plain="true" iconCls="icon-save" onclick="savedata();">存盘</a>
	    	<a class="mini-button" style="display:none;" id="11827" plain="true" iconCls="icon-save"onclick="savedata();">存盘</a>
    ...
    <script type="text/javascript">
        ...
        function CloseWindow(action) {            
         ...
         function savedata() {
       		...
       		var url="saveZyjwzxzfyjzms.action?1=1";
        	if(operator == "new"){//新增
	            $.ajax({
