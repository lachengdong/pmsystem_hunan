			            ...
			            <table style="table-layout:fixed;">
							...
							<tr>
					        	<td colspan="5" rowspan="5">    
					            	<input  id="reason" name="reason" class="mini-textarea" emptyText="请填写意见" style="width:100%; height: 150px"/>
					            </td>
			            	</tr>  
			            </table>
			        </div>
            ...
            if(s1value){
            	...
            	if(s1value == '0'){
            		...
            		//从宽
           			//从严
            		//家庭困难
            		//alert(((s11text&&s7text)||(s12text&&s9text))+"|||");
            		if((s11text&&s7text)||(s12text&&s9text)){
                		//alert(((s11text&&s7text)||(s12text&&s9text))+"----");
            			//if(provincecode == '4300'){
     	           		//	if(parseInt(s2value) <=10) flag = false;
     		           	//	result += "";
     	           		//}else{
