...
<body onload="init('${menuid}')">
	...
	<div size="38px;" showCollapseButton="false">
		...
		<td style="width:100%;">
	    	...
	    	<a class="mini-button" id="11246" iconCls="icon-save" plain="true" onclick="doSubmitFlow('11246','save','doc_bwcbhysp','SJ_BWJY_CBHYDJB');">存盘</a>
	    	<a class="mini-button" id="11248" iconCls="icon-downgrade" plain="true" onclick="doSubmitFlow('11248','yes','doc_bwcbhysp','SJ_BWJY_CBHYDJB');">提交</a>
	    	<a class="mini-button" style="display:none;" id="11250" iconCls="icon-downgrade" plain="true" onclick="operationOpprove('11250','yes');">同意</a>
	    	<a class="mini-button" style="display:none;" id="11252" iconCls="icon-upgrade" plain="true" onclick="operationOpprove('11252','no');">拒绝</a>
	    	<a class="mini-button" style="display:none;" id="12064" iconCls="icon-downgrade" plain="true" onclick="operationOpprove('12064','yes');">同意</a>
	    	<a class="mini-button" style="display:none;" id="12066" iconCls="icon-upgrade" plain="true" onclick="operationOpprove('12066','no');">拒绝</a>
	    	<a class="mini-button" style="display:none;" id="12068" iconCls="icon-upgrade" plain="true" onclick="operationOpprove('12068','back');">退回</a>
	    	<a class="mini-button" style="display:none;" id="12070" iconCls="icon-downgrade" plain="true" onclick="operationOpprove('12070','yes');">同意</a>
	    	<a class="mini-button" style="display:none;" id="12071" iconCls="icon-upgrade" plain="true" onclick="operationOpprove('12071','no');">拒绝</a>
	    	<a class="mini-button" style="display:none;" id="12072" iconCls="icon-upgrade" plain="true" onclick="operationOpprove('12072','back');">退回</a>
	    	<a class="mini-button" style="display:none;" id="11244" iconCls="icon-download" plain="true" onclick="saveNext();">下一个</a>
    ...
    <script type="text/javascript">
        ...
        function saveNext(){
            ...
            var url = "disposePrimaryHealthPanel.action?1=1&id="+id+"&menuid="+menuid;
            if(index>0){
        ...
        //跳转到选择罪犯页面
        function onCanle(){
        	var url = "primaryHealthPanel.action?1=1";
			self.location.href=url;
        }
    </script>
</body>
