...
<body onload="init('${menuid}');">
	...
	<div size="38px;" showCollapseButton="false">
		...
		<td style="width:100%;">
			...
			<a class="mini-button"  iconCls="icon-save" plain="true" style="display: none;" id="11629" onclick="savedata();">存盘</a>
			<a class="mini-button"  iconCls="icon-download" plain="true" style="display: none;" id="12525" onclick="saveNext();">下一个</a>
    ...
    <script type="text/javascript">
        ...
        function savedata(){
       		...
       		var url="saveGaoZhiShu.action?1=1";
        	if(!docid){//新增
	            $.ajax({
	                url:encodeURI(encodeURI(url)),
	                data: {content:content,tempid:tempid,operator:"new",crimid:crimid},
	                type: "post",
	            ...
	            $.ajax({
	                url:encodeURI(encodeURI(url)),
	                data: {content:content,docid:docid,operator:"edit",crimid:crimid},
	                type: "post",
	                success: function (text) {
	                	alert("操作成功!");
	                	saveNext();
        ...
        function close(){
        	url = "<%=path%>/jianXingJiaShiGaozhi.action?1=1";
        	self.location.href=url;
        }
    </script>
</body>
