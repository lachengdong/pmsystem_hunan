...
<body onload="init('${menuid}');">
	...
	<div size="38px;" showCollapseButton="false">
	    ...
	    <a class="mini-button" style="display:none;" id="11867" iconCls="icon-save" plain="true" onclick="savedata();">存盘</a>
	    	<a class="mini-button" style="display:none;" id="11868" iconCls="icon-save" plain="true" onclick="savedata();">存盘</a>
    ...
    <script type="text/javascript">
        ...
        function savedata() {
       		...
       		var url="saveLetterOfAuthorizationFirstMedicalParole.action?1=1";
        	if(operator == "new"){//新增
	            $.ajax({
