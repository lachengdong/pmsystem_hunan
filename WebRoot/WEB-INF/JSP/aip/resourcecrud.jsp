...
<body>
			...
			<table>
				<tr>
					<td style="width:100%;">
				    	...
				    	<a class="mini-button" id="12021" iconCls="icon-save" plain="true" onclick="save();">存盘</a>
    ...
    <script type="text/javascript">
      ...
      function save(){
       		...
       		var tempid = "SZJY_ZFJXJSSBB";
       		var docid = mini.get("docid").getValue();
       		var crimid = mini.get("crimid").getValue();
       		var url="saveResourcecruds.action?1=1";
