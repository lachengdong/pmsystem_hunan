...
<body onload="init('${menuid}')">
	...
	<div size="38px;" showCollapseButton="false">
		...
		<td style="width:100%;">
			...
			<a class="mini-button" style="display:none;" id="11523" iconCls="icon-save" plain="true" onclick="doSubmitFlow('11523','save','other_zfljtzsp','SDXF_XFZX_ZFLJTZS');">存盘</a>
			<a class="mini-button" style="display:none;" id="10930" iconCls="icon-downgrade" plain="true" onclick="doSubmitFlow('10930','yes','other_zfljtzsp','SDXF_XFZX_ZFLJTZS');">提交</a>
			<a class="mini-button" style="display:none;" id="10931" iconCls="icon-downgrade" plain="true" onclick="operationOpprove('10931','yes','keshiyijian_data0');">同意</a>
			<a class="mini-button" style="display:none;" id="10932" iconCls="icon-upgrade" plain="true" onclick="operationOpprove('10932','no','keshiyijian_data1');">拒绝</a>
			<a class="mini-button" style="display:none;" id="11524" iconCls="icon-download" plain="true" onclick="saveNext();">下一个</a>
    ...
    <script type="text/javascript">
        ...
        function saveNext (){
            ...
            var url= "showLeaveAotice.action?1=1&id="+id+"&menuid="+${menuid};
            if(index>0){
        ...
        //手动关闭
        function close(){
        	var url = "leaveAoticeChoose.action?1=1";
			self.location.href=url;
        }
