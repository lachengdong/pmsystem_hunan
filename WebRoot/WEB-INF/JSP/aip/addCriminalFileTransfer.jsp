...
<body onload="init('${menuid }')">
	...
	<div size="38px;" showCollapseButton="false">
		...
		<td style="width:100%;">
	    	...
	    	<a class="mini-button" id="14090"  style="display:none;" iconCls="icon-save" plain="true" onclick="savedata();">存盘</a>
	    	<a class="mini-button" id="14093"   style="display:none;" iconCls="icon-save" plain="true" onclick="savedata();">存盘</a>
