...
<body onload="init('${menuid}');">
	...
	<div size="38px;" showCollapseButton="false">
		...
		<td style="width:100%;">
			...
			<a class="mini-button"  style="display:none;" id="11133" iconCls="icon-save" plain="true" onclick="savedata();">存盘</a>
			<a class="mini-button"  style="display:none;" id="11134" iconCls="icon-save" plain="true" onclick="savedata();">存盘</a>
    ...
    <script type="text/javascript">
        ...
        function savedata() {
       		...
       		var url="saveCorrectIllegalNotice.action?1=1";
        	if(!docid){//新增
	            $.ajax({
	                url:encodeURI(encodeURI(url)),
	                data: {content:content,noteinfo:noteinfo,tempid:tempid},
	                type: "post",
	            ...
	            $.ajax({
	                url: encodeURI(encodeURI(url)),
	                data: {content:content,noteinfo:noteinfo,docid:docid,tempid:tempid},
	                type: "post",
	                success: function (text) {
	                	alert("操作成功!");
	                  	back();
