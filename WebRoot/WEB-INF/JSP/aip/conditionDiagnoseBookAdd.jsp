...
<body onload="init('${menuid}');">
	...
	<div size="38px;" showCollapseButton="false">
		...
		<td style="width:100%;">
			...
			<a class="mini-button" style="display:none;" id="10962" iconCls="icon-save" plain="true" onclick="doSubmitFlow('10962','save','doc_bwbqzdsp','JWZX_ZFBQZDS');">存盘</a>
	    	<a class="mini-button" style="display:none;" id="11283" iconCls="icon-save" plain="true" onclick="doSubmitFlow('11283','save','doc_bwbqzdsp','JWZX_ZFBQZDS');">存盘</a>
	    	<a class="mini-button" style="display:none;" id="11265" iconCls="icon-downgrade" plain="true" onclick="doSubmitFlow('11265','yes','doc_bwbqzdsp','JWZX_ZFBQZDS');">提交</a>
	    	<a class="mini-button" style="display:none;" id="11526" iconCls="icon-downgrade" plain="true" onclick="doSubmitFlow('11265','yes','doc_bwbqzdsp','JWZX_ZFBQZDS');">提交</a>
	    	<a class="mini-button" style="display:none;" id="10963" iconCls="icon-downgrade" plain="true" onclick="operationOpprove('10963','yes','');">同意</a>
	    	<a class="mini-button" style="display:none;" id="10964" iconCls="icon-upgrade" plain="true" onclick="operationOpprove('10964','no','');">拒绝</a>
