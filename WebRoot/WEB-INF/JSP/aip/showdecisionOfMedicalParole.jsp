...
<head>
    <title>暂予监外执行（保外就医）公示情况记录</title>
...
<body onload="init('12285')">
	...
	<div size="38px;" showCollapseButton="false">
		...
		<td style="width:100%;">
			...
			<a class="mini-button"  style="display:none;" id="12286" iconCls="icon-save" plain="true" onclick="save();">存盘</a>
			<a class="mini-button"  style="display:none;" id="12881" iconCls="icon-download" plain="true" onclick="saveNext();">下一个</a>
			<a class="mini-button" id="12251" iconCls="icon-close" plain="true" onclick="onCancel();">关闭</a>
	    	<span class="separator"></span> 
    ...
    <script type="text/javascript">
        ...
        function save(){
       		...
       		var url="savedecisionOfMedicalParole.action?1=1";
        	if(!docid){//新增
	            $.ajax({
	            ...
	            $.ajax({
	                url: "savedecisionOfMedicalParole.action?1=1",
        ...
        //手动关闭
        function onCancel(){
          	var url = "decisionOfMedicalParoleChoose.action?1=1";
			self.location.href=url;
        }
