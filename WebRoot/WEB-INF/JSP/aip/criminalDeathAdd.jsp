...
<body onload="init('${menuid}')">
	...
	<div size="38px;" showCollapseButton="false">
		...
		<td style="width:100%;">
			...
			<a class="mini-button" style="display:none;" id="11651" iconCls="icon-save" plain="true" onclick="doSubmitFlow('11651','save','other_zfswsp','YZH_ZFSW');">存盘</a>
	    	<a class="mini-button" style="display:none;" id="11652" iconCls="icon-downgrade" plain="true" onclick="doSubmitFlow('11652','yes','other_zfswsp','YZH_ZFSW');">提交</a>
	    	<a class="mini-button" style="display:none;" id="12041" iconCls="icon-download" plain="true" onclick="saveNext();">下一个</a>
	    	<a class="mini-button"  iconCls="icon-close" plain="true" onclick="onCanle();">关闭</a>
			<a class="mini-button" style="display:none;" id="11654" iconCls="icon-downgrade" plain="true" onclick="operationOpprove('11654','yes','cdmmedicalopinion_t');">同意</a>
	    	<a class="mini-button" style="display:none;" id="11653" iconCls="icon-upgrade" plain="true" onclick="operationOpprove('11653','no','cdmmedicalopinion_t');">拒绝</a>
	    	<a class="mini-button" style="display:none;" id="11655" iconCls="icon-downgrade" plain="true" onclick="operationOpprove('11655','yes','cdmprisonopinion_t');">同意</a>
	    	<a class="mini-button" style="display:none;" id="11656" iconCls="icon-upgrade" plain="true" onclick="operationOpprove('11656','no','cdmprisonopinion_t');">拒绝</a>
	    	<a class="mini-button" style="display:none;" id="12049" iconCls="icon-upgrade" plain="true" onclick="operationOpprove('12049','back','cdmprocuratorateopinion_t');">退回</a>
	    	<a class="mini-button" style="display:none;" id="11657" iconCls="icon-downgrade" plain="true" onclick="operationOpprove('11657','yes','cdmprocuratorateopinion_t');">同意</a>
	    	<a class="mini-button" style="display:none;" id="11658" iconCls="icon-upgrade" plain="true" onclick="operationOpprove('11658','no','cdmprocuratorateopinion_t');">拒绝</a>
	    	<a class="mini-button" style="display:none;" id="12050" iconCls="icon-upgrade" plain="true" onclick="operationOpprove('12050','back','cdmprocuratorateopinion_t');">退回</a>
	    	<span class="separator"></span> 
  ...
  <script type="text/javascript">
     ...
     function saveNext(){           
         ...
         var url= "<%=path%>/criminalDeath/criminalDeathAdd.page?1=1&id="+id+"&menuid=${menuid}";
         if(index>0){
     ...
     //手动关闭
     function onCanle(){
     	url = "<%=path%>/criminalDeath/criminalDeath.page?1=1";
     	self.location.href=url;
     }
    </script>
</body>
