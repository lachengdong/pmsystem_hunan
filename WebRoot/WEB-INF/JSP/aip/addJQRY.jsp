...
<body onload="init('${menuid}');">
	...
	<div size="38px;" showCollapseButton="false">
		...
		<td style="width:100%;">
			...
			<a class="mini-button" style="display:none;" id="1000156" iconCls="icon-save" plain="true" onclick="doSubmitFlow('1000156','save','other_jqbanry','JQRY');">存盘</a>
	    	<a class="mini-button" style="display:none;" id="1000157" iconCls="icon-downgrade" plain="true" onclick="doSubmitFlow('1000157','yes','other_jqbanry','JQRY');">提交</a>
			<a class="mini-button" style="display:none;" id="1000158" iconCls="icon-save" plain="true" onclick="doSubmitFlow('1000158','save','other_jqbanry','JQRY');">存盘</a>
	    	<a class="mini-button" style="display:none;" id="1000161" iconCls="icon-downgrade" plain="true" onclick="doSubmitFlow('1000161','yes','other_jqbanry','JQRY');">提交</a>
			<a class="mini-button" style="display:none;" id="1000159" iconCls="icon-downgrade" plain="true" onclick="operationOpprove('1000159','yes');">同意</a>
	    	<a class="mini-button" style="display:none;" id="1000160" iconCls="icon-upgrade" plain="true" onclick="submit();">拒绝</a>
