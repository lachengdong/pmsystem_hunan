...
<body onload="init('${menuid}');">
	...
	<div size="38px;" showCollapseButton="false">
		...
		<td style="width:100%;">
	    	...
	    	<a class="mini-button" style="display:none;" iconCls="icon-save" id="12242" plain="true" onclick="savedata();">存盘</a>
	    	<a class="mini-button" style="display:none;" iconCls="icon-save" id="12245" plain="true" onclick="savedata();">存盘</a>
    ...
    <script type="text/javascript">
        mini.parse();
         ...
         function savedata() {
       		...
       		var url="saveQualificationReview.action?1=1";
        	if(operator == "new"){//新增
	            $.ajax({
