...
<body onload="init('${menuid}')">
	...
	<div size="38px;" showCollapseButton="false">
		...
		<td style="width:100%;">
			...
			<input name="operator" id="operator" class="mini-hidden" value="${operator}"/>
	    	 <a id="11184" class="mini-button" style="display:none;" iconCls="icon-save" plain="true" onclick="save();">存盘</a>
	    	 <a class="mini-button" id="12803" style="display:none;" iconCls="icon-download" plain="true" onclick="saveNext();">下一个</a>
    ...
    <script type="text/javascript">
        function save(){
       		...
       		var url="saveMedicalParoleNoticeToSafeDeputy.action?1=1";
		...
		function close() {
			var url = "medicalParoleNoticeToSafeDeputy.action?1=1&systempid=${systempid}";
			self.location.href=url;
		}
