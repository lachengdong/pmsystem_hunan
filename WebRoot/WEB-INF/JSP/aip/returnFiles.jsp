...
<body onload="init('${menuid}');">
	...
	<div size="38px;" showCollapseButton="false">
		...
		<td style="width:100%;">
			...
			<a class="mini-button"  style="display:none;" id="12031" iconCls="icon-save" plain="true" onclick="doSubmitFlow('12031','save','doc_sjtbdasp','GDSJ_JWZX_SJTBDA');">存盘</a>
			<a class="mini-button"  style="display:none;" id="11373" iconCls="icon-downgrade" plain="true" onclick="doSubmitFlow('11373','yes','doc_sjtbdasp','GDSJ_JWZX_SJTBDA');">提交</a>
			<a class="mini-button"  style="display:none;" id="12700" iconCls="icon-download" plain="true" onclick="saveNext();">下一个</a>
			<a class="mini-button"  style="display:none;" id="11374" iconCls="icon-downgrade" plain="true" onclick="operationOpprove('11374','yes');">同意</a>
	    	<a class="mini-button" style="display:none;" id="12035"  iconCls="icon-upgrade" plain="true" onclick="operationOpprove('12035','no');">拒绝</a>
    ...
    <script type="text/javascript">
        ...
        function saveNext(){
            ...
            var url= "returnFiles.action?1=1&id="+id+"&menuid="+menuid;
            if(index>0){
        ...
        //关闭
       function onCanle() {
    	    url = "returnFilesChoose.action?1=1";
        	self.location.href=url;
       }
    </script>
</body>
