...
<body onload="init('12355');">
	...
	<div size="38px;" showCollapseButton="false">
		...
		<td style="width:100%;">
    		...
    		<a class="mini-button" id="12356" style="display:none;" iconCls="icon-save" plain="true" onclick="savedata()">存盘</a>
	   	  	<a class="mini-button" id="12367" style="display:none;" iconCls="icon-download" plain="true" onclick="saveNext();">下一个</a>
    ...
    <script type="text/javascript">
        ...
        function savedata(){
       		...
       		var url="saveGZJJFZSPB.action?1=1";
        	if(!docid){//新增
	            $.ajax({
        ...
        function Close(){
        	var url = "GZJJFZSPBChoose.action?1=1";
    		self.location.href=url;
        }  
		//跳转到选择罪犯页面
        function close(){
