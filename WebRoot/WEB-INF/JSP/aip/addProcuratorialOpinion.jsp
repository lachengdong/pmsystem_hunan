...
<body onload="init('${menuid}');">
	...
	<div size="38px;" showCollapseButton="false">
		...
		<td style="width:100%;">
			...
			<a class="mini-button"  style="display:none;" id="12334" iconCls="icon-save" plain="true" onclick="savedata();">存盘</a>
			<a class="mini-button"  style="display:none;" id="12334" iconCls="icon-save" plain="true" onclick="savedata();">存盘</a>
        ...
        function savedata() {
        	...
        	if(!docid){//新增
	            $.ajax({
	                ...
	                data: {content:content,tempid:tempid,noteinfo:noteinfo,crimid:crimid},
	                type: "post",
	            ...
	            $.ajax({
	                url: encodeURI(encodeURI(url)),
	                data: {content:content,docid:docid,tempid:tempid,noteinfo:noteinfo,crimid:crimid},
	                type: "post",
	                success: function (text) {
	                	alert("操作成功!");
	                	back();
