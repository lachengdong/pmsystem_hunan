...
<body  onload="init('${menuid}');">
	...
	<div size="38px;" showCollapseButton="false">
		...
		<td style="width:100%;">
	    	...
	    	<a id="11180"  class="mini-button" iconCls="icon-save"  style="display:none;"  plain="true" onclick="save();">存盘</a>
	    	<a class="mini-button" id="12796" iconCls="icon-download" plain="true" onclick="saveNext();">下一个</a>
    ...
    <script type="text/javascript">
        function save(){
       		...
       		var url="saveMedicalParoleNoticeToMonitoringRoom.action?1=1";
		...
		function close() {
			var url = "medicalParoleNoticeToMonitoringRoom.action?1=1&systempid=${systempid}";
