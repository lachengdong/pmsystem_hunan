...
<body >
	...
	<div size="38px;" showCollapseButton="false">
		...
		<td style="width:100%;">
	    	...
	    	<a class="mini-button" id="back" plain="true" onclick="backChoose();">返回</a>
    ...
    <script type="text/javascript">
        ...
        function savedata() {
        	...
        	if(!docid){//新增
	            ...
	            $.ajax({
	                url: "saveHanding.action?1=1",
	                data: {content:content,docid:docid,tempid:tempid},
	                type: "post",
	                success: function (text) {
	                	alert("操作成功!");
	                	backChoose();
