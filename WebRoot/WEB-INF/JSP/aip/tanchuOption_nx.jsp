...
<body  onload="myload()">     
    <form id="form1" method="post">
    	...
    	<input id="casedate"  class="mini-hidden" value="${yjmap.datetime}"/>
        ...
        <div style="padding-left:11px;padding-bottom:5px;padding-right:11px;">
            <table style="table-layout:fixed;">
                <tr>
                    <td width="90px;">办案日期：</td>
                    <td width="80px;">
                         <input id="caseacceptdate" name="caseacceptdate" style="width:100px;" class="mini-datepicker" />
                    </td>
                </tr>
                <tr> 
                ...
                <td colspan=2>   
                   ...
                   <td width="80px;" colspan=2> 
					...
					<tr>
					 <td colspan=5> 
                    <input id="select13" style="display: none;" class="mini-checkbox" text="有家庭困难证明" trueValue="1" falseValue="0" onvaluechanged=""/>
               		 </td>
					</tr>
					<tr>
						<td colspan="5">
							<span id="doc"style="color:red;display: none;"></span>
						</td>
					</tr>
					<tr>
						<td colspan="5">                        
...
<!--					</tr>-->
    ...
    <script type="text/javascript">
        ...
        function myload(){
	        ...
	        var casedate = mini.get("casedate").getValue();
	        //alert(new Date(casedate.replace('年','-').replace('月','-').replace('日','')));
	        ...
	        if(jxjs1){
	        	...
	        	//alert();
	        	if(casedate == '' || casedate == null){
	                //获取当前日期
	                var caseacceptdate = new Date();
	                mini.get("caseacceptdate").setValue(caseacceptdate);
		        }else{
			        var date1 = casedate.replace('年','-').replace('月','-').replace('日','');
			        var date2 = "";
			        var objects = date1.split("-");
				    ...
				    //alert(date2.substring(1,date2.length));
			        mini.get("caseacceptdate").setValue(new Date(date2.substring(1,date2.length)));
			    }
	        }
	      ...
	      function hideTJ(){
	       ...
	       function myload1(){
	        ...
	        if(jxjs1){
	        	...
	        	mini.get("select13").setValue(jxjs13);
	        	mini.get("jxjs14").setValue(jxjs14);
	        	mini.get("caseacceptdate").setValue(new Date(casedate.replace('年','-').replace('月','-').replace('日','')));
	        }
        ...
        function onOk2(e) {
        	...
        	var casedate = mini.get("caseacceptdate").getValue();
        	//日期为空 则显示当前时间 ，否者 则显示选择时间 
        	if(casedate != ''){
        		casedate = (casedate.getYear()+1900)+"年"+(casedate.getMonth()+1)+"月"+casedate.getDate()+"日";
            }else{
                var datetime = new Date();
                casedate = (datetime.getYear()+1900)+"年"+(datetime.getMonth()+1)+"月"+datetime.getDate()+"日";
            }
