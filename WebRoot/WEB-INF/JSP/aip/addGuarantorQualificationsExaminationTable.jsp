...
<body onload="init('${menuid}');">
	...
	<div size="38px;" showCollapseButton="false">
		...
		<td style="width:100%;">
			...
			<a class="mini-button" style="display:none;" id="11791" iconCls="icon-save" plain="true" onclick="doSubmitFlow('11791','save','other_bzrzgsp','JWZX_BZRZGSCB');">存盘</a>
	    	<a class="mini-button" style="display:none;" id="11805" iconCls="icon-downgrade" plain="true" onclick="doSubmitFlow('11805','yes','other_bzrzgsp','JWZX_BZRZGSCB');">提交</a>
			<a class="mini-button" style="display:none;" id="11797" iconCls="icon-save" plain="true" onclick="doSubmitFlow('11797','save','other_bzrzgsp','JWZX_BZRZGSCB');">存盘</a>
	    	<a class="mini-button" style="display:none;" id="11806" iconCls="icon-downgrade" plain="true" onclick="doSubmitFlow('11806','yes','other_bzrzgsp','JWZX_BZRZGSCB');">提交</a>
			<a class="mini-button" style="display:none;" id="11807" iconCls="icon-downgrade" plain="true" onclick="operationOpprove('11807','yes');">同意</a>
	    	<a class="mini-button" style="display:none;" id="11808" iconCls="icon-upgrade" plain="true" onclick="operationOpprove('11808','no');">拒绝</a>
