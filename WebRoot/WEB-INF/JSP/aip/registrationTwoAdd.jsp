...
<body onload="init('${menuid}');">
	...
	<div size="38px;" showCollapseButton="false">
		...
		<td style="width:100%;">
	    	...
	    	<a class="mini-button" style="display:none;" id="11158" iconCls="icon-save" plain="true" onclick="doSubmitFlow('11158','save','other_zfjhzssp','XFZX_JHZSSPB')">存盘</a>
	    	<a class="mini-button" style="display:none;" id="11159" iconCls="icon-downgrade" plain="true" onclick="doSubmitFlow('10936','yes','other_zfjhzssp','XFZX_JHZSSPB');;">提交</a>
	    	<a class="mini-button" style="display:none;" id="11164" iconCls="icon-save" plain="true" onclick="doSubmitFlow('11164','save','other_zfjhzssp','XFZX_JHZSSPB')">存盘</a>
	    	<a class="mini-button" style="display:none;" id="10936" iconCls="icon-downgrade" plain="true" onclick="doSubmitFlow('10936','yes','other_zfjhzssp','XFZX_JHZSSPB');;">提交</a>
	    	<a class="mini-button" style="display:none;" id="10938" iconCls="icon-downgrade" plain="true" onclick="operationOpprove('10938','yes','text4_text5');">同意</a>
	    	<a class="mini-button" style="display:none;" id="10937" iconCls="icon-upgrade" plain="true" onclick="operationOpprove('10937','no','text4_text5');">拒绝</a>
