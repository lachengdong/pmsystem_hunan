...
<body onload="init('${menuid}');">
	...
	<div size="38px;" showCollapseButton="false">
		...
		<td style="width:100%;">
			...
			<a class="mini-button"  style="display:none;" id="11348" style="display:none;" iconCls="icon-save" plain="true" onclick="savedata();">存盘</a>
	    	<a class="mini-button"  style="display:none;" id="11349" iconCls="icon-download" plain="true" onclick="saveNext();">下一个</a>
    ...
    <script type="text/javascript">
        ...
        function savedata(menuid) {
        	...
        	if(!docid){//新增
	            $.ajax({
	                url: "saveNotPrisonRegister.action?1=1",
     ...
     //手动关闭
     function onCancel(){  
         url = "notPrisonRegisterchoose.action?1=1&menuid="+menuid;
         self.location.href=url;          
     }
    </script>
</body>
