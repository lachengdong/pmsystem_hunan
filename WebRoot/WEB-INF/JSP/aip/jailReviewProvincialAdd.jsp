...
<body onload="init('${menuid}');">
	...
	<div size="38px;" showCollapseButton="false">
		...
		<td style="width:100%;">
	    	...
	    	<a class="mini-button"  iconCls="icon-save" plain="true" style="display:none;"  id="11852" onclick="savedata();">存盘</a>
	    	<a class="mini-button"  iconCls="icon-save" plain="true" style="display:none;"  id="11855" onclick="savedata();">存盘</a>		
    ...
    <script type="text/javascript">
      ...
      function savedata() {
   		...
   		var url = "saveJailReviewProvincia.action?1=1";
      	if(!docid){//新增
           $.ajax({
               url: url,
               data: {content:content,tempid:tempid,crimid:crimid,operator:"new"},
               type: "post",
