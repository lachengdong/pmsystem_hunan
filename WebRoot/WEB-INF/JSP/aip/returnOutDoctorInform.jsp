...
<body onload="init('${menuid}')">
	...
	<div size="38px;" showCollapseButton="false">
		...
		<td style="width:100%;">
	    	...
	    	<a class="mini-button" style="display:none;" id="11303" iconCls="icon-save" plain="true" onclick="savedata();">存盘</a>
	    	<a class="mini-button" style="display:none;" id="12806" iconCls="icon-download" plain="true" onclick="saveNext();">下一个</a>
    ...
    <script type="text/javascript">
        ...
        function savedata() {
        	...
        	if(!docid){//新增
	            $.ajax({
	                url: "saveOutDoctorInform.action?1=1",
	                data: {content:content,tempid:tempid,crimid:crimid,tempid:tempid},
	                type: "post",
	            ...
	            $.ajax({
	                url: "saveOutDoctorInform.action?1=1",
	                data: {content:content,docid:docid,crimid:crimid,tempid:tempid},
	                type: "post",
	                success: function (text) {
	                	alert("操作成功!");
	                	saveNext();
     ...
     //返回到罪犯处理页面
     function onCancel(){  
       var url = "returnOutDoctorInformChoose.action?1=1";
       self.location.href=url;          
     }
    </script>
</body>
