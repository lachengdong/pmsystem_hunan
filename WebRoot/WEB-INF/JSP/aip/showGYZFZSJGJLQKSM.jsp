...
<body onload="init('${menuid}')">
	...
	<div size="38px;" showCollapseButton="false">
		...
		<td style="width:100%;">
			...
			<a class="mini-button" style="display:none;" id="12429" iconCls="icon-save" plain="true" onclick="doSubmitFlow('12429','save','doc_zfzsjgjlsp','SH_GYZFZSJGJLSM');">存盘</a>
			<a class="mini-button" style="display:none;" id="12431" iconCls="icon-downgrade" plain="true" onclick="doSubmitFlow('12431','yes','doc_zfzsjgjlsp','SH_GYZFZSJGJLSM');">提交</a>
			<a class="mini-button" style="display:none;" id="12432" iconCls="icon-downgrade" plain="true" onclick="operationOpprove('12432','yes','');">同意</a>
			<a class="mini-button" style="display:none;" id="12433" iconCls="icon-upgrade" plain="true" onclick="operationOpprove('12433','no','');">拒绝</a>
			<a class="mini-button" style="display:none;" id="12443" iconCls="icon-download" plain="true" onclick="saveNext();">下一个</a>
    ...
    <script type="text/javascript">
        ...
        function saveNext (){
            ...
            var url= "showGYZFZSJGJLQKSM.action?1=1&id="+id+"&menuid="+${menuid};
            if(index>0){
        ...
        //手动关闭
        function Close(){
        	var url = "GYZFZSJGJLQKSMChoose.action?1=1";
			self.location.href=url;
        }
