...
<head>
    <title>保外就医审批携带的病情鉴定表tabs</title>
...
<body>
	...
	<div size="38px;" showCollapseButton="false">
		...
		<td style="width:100%;">
	    	...
	    	<!-- <a class="mini-button" id="" iconCls="icon-close" plain="true" onclick="javascript:history.go(-1);">关闭</a>
	    	<span class="separator"></span>  -->
	...
	<div showCollapseButton="false">
	  	<div style="height: 20px;width: 100%;color: red;text-align: center;">${nocontent }</div>
