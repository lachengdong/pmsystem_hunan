...
<body onload="init('${menuid }')">
	...
	<div size="38px;" showCollapseButton="false">
		...
		<td style="width:100%;">
			...
			<a class="mini-button" style="display:none;" id="11301" iconCls="icon-save" plain="true" onclick="doSubmitFlow('11301','save','doc_bwshbnzlsp','JWZX_ZFSHBNZLJBS');">存盘</a>
	    	<a class="mini-button" style="display:none;" id="10968" iconCls="icon-downgrade" plain="true" onclick="doSubmitFlow('10968','yes','doc_bwshbnzlsp','JWZX_ZFSHBNZLJBS');">提交</a>
	    	<a class="mini-button" style="display:none;" id="11528" iconCls="icon-save" plain="true" onclick="doSubmitFlow('11528','save','doc_bwshbnzlsp','JWZX_ZFSHBNZLJBS');">存盘</a>
	    	<a class="mini-button" style="display:none;" id="11529" iconCls="icon-downgrade" plain="true" onclick="doSubmitFlow('10968','yes','doc_bwshbnzlsp','JWZX_ZFSHBNZLJBS');">提交</a>
	    	<a class="mini-button" style="display:none;" id="10969" iconCls="icon-downgrade" plain="true" onclick="operationOpprove('10969','yes','');">同意</a>
	    	<a class="mini-button" style="display:none;" id="10970" iconCls="icon-upgrade" plain="true" onclick="operationOpprove('10970','no','');">拒绝</a>
