...
<body onload="init('${menuid}');">
	...
	<div size="38px;" showCollapseButton="false">
		...
		<td style="width:100%;">
			...
			<a class="mini-button" style="display:none;" id="12686" iconCls="icon-save" plain="true" onclick="doSubmitFlow('12688','save','other_bjrxqspb','SDXF_BWJYBJRXQSPB');">存盘</a>
	    	<a class="mini-button" style="display:none;" id="12687" iconCls="icon-downgrade" plain="true" onclick="doSubmitFlow('12689','yes','other_bjrxqspb','SDXF_BWJYBJRXQSPB');">提交</a>
	    	<a class="mini-button" style="display:none;" id="12688" iconCls="icon-save" plain="true" onclick="doSubmitFlow('12688','save','other_bjrxqspb','SDXF_BWJYBJRXQSPB');">存盘</a>
	    	<a class="mini-button" style="display:none;" id="12689" iconCls="icon-downgrade" plain="true" onclick="doSubmitFlow('12689','yes','other_bjrxqspb','SDXF_BWJYBJRXQSPB');">提交</a>
	    	<a class="mini-button" style="display:none;" id="12690" iconCls="icon-downgrade" plain="true" onclick="operationOpprove('12690','yes','');">同意</a>
	    	<a class="mini-button" style="display:none;" id="12691" iconCls="icon-upgrade" plain="true" onclick="operationOpprove('12691','no','');">拒绝</a>
