...
<body onload="init('${menuid}')">
	...
	<div size="38px;" showCollapseButton="false">
		...
		<td style="width:100%;">
			...
			<a class="mini-button"  style="display:none;" id="13872" iconCls="icon-save" plain="true" onclick="save();">存盘</a>
			<a class="mini-button"  style="display:none;" id="13873" iconCls="icon-download" plain="true" onclick="saveNext();">下一个</a>			
	    	<a class="mini-button" style="display:black;" id="gb" iconCls="icon-close" plain="true" onclick="onCancel();">关闭</a>
    ...
    <script type="text/javascript">
        ...
        function save(){
       		...
       		var url="saveidentificationOfDisabled.action?1=1";
        	if(docid==null||docid==""){//新增
        	   var operator="new";
	            $.ajax({
	                url:encodeURI(encodeURI(url)),
	                data: {content:content,tempid:tempid,operator:operator,noteinfo:noteinfo,crimid:crimid},
	                type: "post",
            ...
            if(docid!=null&&docid!=""){//更新
               var operator="edit";
	            $.ajax({
	                url: "saveidentificationOfDisabled.action?1=1",
	                data: {content:content,operator:operator,noteinfo:noteinfo,docid:docid},
	                type: "post",
	                success: function (text) {
	                	alert("操作成功!");
	                	saveNext();
        ...
        function saveNext(){
            ...
            var url= "showidentificationOfDisabled.action?1=1&id="+id+"&menuid="+${menuid};
            if(index>0){
        ...
        //手动关闭
        function onCancel(){
          	var url = "identificationOfDisabledChoose.action?1=1&menuid=13868";
			self.location.href=url;
        }
    </script>
</body>
