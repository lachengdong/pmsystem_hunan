...
<body onload="init('${menuid}');">
	...
	<div size="38px;" showCollapseButton="false">
		...
		<td style="width:100%;">
			...
			<a class="mini-button"  style="display:none;" id="11137" iconCls="icon-save" plain="true" onclick="savedata();">存盘</a>
			<a class="mini-button"  style="display:none;" id="11138" iconCls="icon-save" plain="true" onclick="savedata();">存盘</a>
	    	<a class="mini-button"  iconCls="icon-close" plain="true" onclick="back();">关闭</a>
	    	<!-- <a class="mini-button"  id="11366" iconCls="icon-downgrade" plain="true"  onclick="submit();">同意</a>
	    	<a class="mini-button"  id="11367" iconCls="icon-upgrade" plain="true" onclick="submit();">拒绝</a>
	    	<a class="mini-button"  id="11368" iconCls="icon-undo" plain="true" onclick="submit();">退回</a> -->
	    	<span class="separator"></span> 
    ...
    <script type="text/javascript">
        ...
        function savedata() {
       		...
       		var url = "saveProcuratorialSuggest.action?1=1";
        	if(!docid){//新增
	            $.ajax({
	                url: encodeURI(encodeURI(url)),
	                data: {content:content,tempid:tempid,noteinfo:noteinfo},
	                type: "post",
	            ...
	            $.ajax({
	                url: encodeURI(encodeURI(url)),
	                data: {content:content,docid:docid,tempid:tempid,noteinfo:noteinfo},
	                type: "post",
	                success: function (text) {
	                	alert("操作成功!");
	                	back();
