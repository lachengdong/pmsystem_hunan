...
<body onload="init('${menuid}');">
	...
	<div size="38px;" showCollapseButton="false">
		...
		<td style="width:100%;">
			...
			<input class="mini-hidden" id="docid" value="${docid}"/>
			<input class="mini-hidden" id="crimid" value="${crimid}"/>
			<input class="mini-hidden" id="tempid" value="${tempid}"/>
			<input class="mini-hidden" id="operator" value="${operator}"/>
	    	<a class="mini-button"  iconCls="icon-save" plain="true" style="display:none;" id="11767" onclick="savedata();">存盘</a>
	    	<a class="mini-button"  iconCls="icon-save" plain="true" style="display:none;" id="11763" onclick="savedata();">存盘</a>		
