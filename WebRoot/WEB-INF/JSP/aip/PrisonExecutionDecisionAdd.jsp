...
<body onload="init('${menuid}');">
	...
	<div size="38px;" showCollapseButton="false">
		...
		<td style="width:100%;">
			...
			<a class="mini-button"  style="display:none;" id="13865" iconCls="icon-save" plain="true"  onclick="savedata();">存盘</a>
			<a class="mini-button"  style="display:none;" id="13866" iconCls="icon-download" plain="true"  onclick="saveNext();">下一个</a>
    ...
    <script type="text/javascript">
        ...
        function savedata(){
       		...
       		var url="savePrisonExecutionDecision.action?1=1";
        	if(!docid){//新增
	            $.ajax({
        ...
        function saveNext(){
            ...
            var url = "PrisonExecutionDecision.action?1=1&id="+id+"&menuid="+menuid+"&tempid="+tempid;
            if(index>0){
        ...
        //关闭表单返回到罪犯处理页面
        function close(){
        	url = "<%=path%>/PrisonExecutionDecisionchoose.action?1=1";
        	self.location.href=url;
        }
    </script>
</body>
