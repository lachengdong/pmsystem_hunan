...
<body onload="init('${menuid}');">
	...
	<div size="38px;" showCollapseButton="false">
		...
		<td style="width:100%;">
			...
			<a class="mini-button"  iconCls="icon-save" plain="true" style="display:none;" id="11076" onclick="doSubmitFlow('11076','save','doc_zfrzhzpglbsp','SZ_RZHZPGH');">存盘</a>
			<a class="mini-button"  iconCls="icon-downgrade" plain="true" style="display:none;" id="11077" onclick="doSubmitFlow('11077','yes','doc_zfrzhzpglbsp','SZ_RZHZPGH');">提交</a>
	    	<a class="mini-button"  iconCls="icon-downgrade" plain="true" style="display:none;" id="11078"  onclick="operationOpprove('11078','yes','');">同意</a>
	    	<a class="mini-button"  iconCls="icon-upgrade" plain="true" style="display:none;" id="11079" onclick="operationOpprove('11079','no','');">拒绝</a>
    ...
    <script type="text/javascript">
        ...
        function onCanle(){
        	url = "<%=path%>/contritionAppraiseTable.action?1=1";
        	self.location.href=url;
        }
