...
<body >
    ...
    <script type="text/javascript">
        ...
        function savedata() {
        	...
        	if(!docid){//新增
	            $.ajax({
	                url: "savePrisonExecuteDecision.action?1=1",
	                data: {content:content,crimid:crimid,tempid:tempid},
	                type: "post",
        ...
        //跳转到选择罪犯页面
        function sendMenuid(){
        	var url = "toChooseCriminalPage.action?1=1&action=prisonExecuteDecision&resid=10158";
