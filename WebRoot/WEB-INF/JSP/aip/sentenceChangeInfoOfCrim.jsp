...
<body onload="init('${menuid}');">
	...
	<div size="38px;" showCollapseButton="false">
		...
		<td style="width:100%;">
			...
			<a class="mini-button" id="900351" style="display:none;" iconCls="icon-downgrade" plain="true" onclick="batchReview();">提交</a>
	...
	<script type="text/javascript">
        ...
        function savedata(){
			...
			data["tempid"] = "XFZX_XQBD";
			data["operator"] = operator;
			data["crimid"] = crimid;
			data["xfbduuid"] = xfbduuid;
