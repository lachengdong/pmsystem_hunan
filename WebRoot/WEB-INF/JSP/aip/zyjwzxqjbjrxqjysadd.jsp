...
<body id="form"  onload="init('${menuid}');" >
	...
	<div size="38px;" showCollapseButton="false">
		...
		<td style="width:100%;">
	    	...
	    	<a class="mini-button"  iconCls="icon-save" plain="true"  style="display:none;" id="11557" onclick="savedata();">存盘</a>
	    	<a class="mini-button"  iconCls="icon-save" plain="true"  style="display:none;" id="11560" onclick="savedata();">存盘</a>
    ...
    <script type="text/javascript">
        ...
        function savedata() {
        	...
        	if(!docid){//新增
	            $.ajax({
	                url: "savezyjwzxqjbjrxqjys.action?1=1",
            ...
            if(operator == "edit"){//更新
	            $.ajax({
	                url: "savezyjwzxqjbjrxqjys.action?1=1",
	                data: {content:content,docid:docid,operator:"edit"},
	                type: "post",
	                success: function (text) {
	                	alert("操作成功!");
	                	onCancel();
