...
<head>
    <title>法定不准出入境人员通报备案通知书 表单页面</title>
...
<body onload="init('${menuid }')">
	...
	<div size="38px;" showCollapseButton="false">
		...
		<td style="width:100%;">
	    	...
	    	<a class="mini-button" id="900083"  style="display:none;" iconCls="icon-save" plain="true" onclick="doSubmitFlow('900083','save','doc_bzcjtbbasp','SH_BZCJRYTBBATZS');">存盘</a>
	    	<a class="mini-button"  iconCls="icon-downgrade" plain="true" style="display:none;" id="900084" onclick="doSubmitFlow('900084','yes','doc_bzcjtbbasp','SH_BZCJRYTBBATZS');">提交</a>
	    	<a class="mini-button"  iconCls="icon-downgrade" plain="true" style="display:none;" id="900085"  onclick="operationOpprove('900085','yes','');">同意</a>
	    	<a class="mini-button"  iconCls="icon-upgrade" plain="true" style="display:none;" id="900086" onclick="operationOpprove('900086','no','');">拒绝</a>
	    	<a class="mini-button" id="900087"   style="display:none;" iconCls="icon-download"   plain="true" onclick="saveNext();">下一个</a>
    ...
    <script type="text/javascript">
        ...
        function saveNext(){
            ...
            var url = "addlegalNoExitPersonnelNotice.action?1=1&id="+id+"&menuid="+menuid+"&tempid= SH_BZCJRYTBBATZS ";
            if(index>0){
         ...
         //跳转到选择罪犯页面
 	   function onCancel(){
	    	var url = "legalNoExitPersonnelNotice.action?1=1&id="+id+"&menuid=14067";
			self.location.href=url;
       }
    </script>
</body>
