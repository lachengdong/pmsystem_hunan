...
<div  id="form1" class="mini-splitter"  vertical="true" style="width:100%;height:100%;border:0px;">
	<div size="38px;" showCollapseButton="false">
		...
		<td style="width:100%;">
			...
			<a class="mini-button" style="display:none;" id="12190" iconCls="icon-save" plain="true" onclick="doSubmitFlow('12310','save','','TJBWJY');">存盘</a>
			<a class="mini-button" style="display:none;" id="12191" iconCls="icon-downgrade" plain="true" onclick="doSubmitFlow('12311','yes','','TJBWJY');">提交</a>
			<a class="mini-button" style="display:none;" id="12193" iconCls="icon-downgrade" plain="true" onclick="operationOpprove('12312','yes','');">同意</a>
			<a class="mini-button" style="display:none;" id="12194" iconCls="icon-upgrade" plain="true" onclick="operationOpprove('12313','no','');">拒绝</a>
