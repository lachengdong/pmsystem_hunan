...
public class FormSolutionDetail implements Cloneable{
    ...
    @Override
    public FormSolutionDetail clone() throws CloneNotSupportedException {
    	return (FormSolutionDetail)super.clone();
    }
}