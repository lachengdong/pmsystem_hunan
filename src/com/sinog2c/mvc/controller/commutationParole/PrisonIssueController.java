 ...
 */
@Controller
public class PrisonIssueController extends ControllerBase {
	@Autowired
	 ...
	 * @return ModelAndView
	 */
	@RequestMapping(value = "/toPrisonIssuePage")
	public ModelAndView toTabsPage() {
		ModelAndView mav = null;
		View view = new InternalResourceView(
		"WEB-INF/JSP/commutationParole/prisonIssueListPage.jsp");
	 ...
	 * @return ModelAndView
	 */
	@RequestMapping(value = "/toPrisonIssueMeetingPage")
	public ModelAndView toTabsPages() {
		ModelAndView mav = null;
		View view = new InternalResourceView(
	 ...
	 * @return resultmap
	 */
	@RequestMapping(value = "/getPrisonIssueList")
	@ResponseBody
	...
	@RequestMapping(value = "/toPrisonIssueTabs")
	...
	//办案
	@RequestMapping(value = "/prisonIssue")
	public ModelAndView showAddFrom(HttpServletRequest request){
		...
		if("show".equals(action)){
			...
			"WEB-INF/JSP/aip/checkPrisonIssue.jsp");
		}else{
			view = new InternalResourceView(
			"WEB-INF/JSP/aip/addPrisonIssue.jsp");
		}
		mav = new ModelAndView(view);
		return mav;
