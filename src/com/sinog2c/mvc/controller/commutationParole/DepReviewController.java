 ...
 */
@Controller
public class DepReviewController extends ControllerBase {
	@Autowired
	 ...
	 * @return ModelAndView
	 */
	@RequestMapping(value = "/toDepReviewPage")
	public ModelAndView toTabsPage() {
		ModelAndView mav = null;
		View view = new InternalResourceView(
		"WEB-INF/JSP/commutationParole/depReviewListPage.jsp");
	 ...
	 * @return resultmap
	 */
	@RequestMapping(value = "/getDepReviewList")
	@ResponseBody
	...
	@RequestMapping(value = "/toDepReviewTabs")
	public ModelAndView toAgentCaseTabs(HttpServletRequest request) {
		...
		View view = new InternalResourceView(
		"WEB-INF/JSP/aip/depReviewTabs.jsp");
		mav = new ModelAndView(view);
		return mav;
	}
	
	//办案
	@RequestMapping(value="/depReview")
	public ModelAndView showAddFrom(HttpServletRequest request){
		...
		if("show".equals(action)){
			...
			"WEB-INF/JSP/aip/checkDepReview.jsp");
		}else{
			view = new InternalResourceView(
			"WEB-INF/JSP/aip/addDepReview.jsp");
		}
		mav = new ModelAndView(view);
		return mav;
